...
describe "Wiki Pages" do
  ...
  context "Navigation" do
    ...
    it "navigates to the wiki pages edit page from the show page" 
  ...
  context "Accessibility" do
    ...
    it "returns focus to the header item clicked while sorting" 
    ...
    describe "Add Page Button" do
      ...
      it "navigates to the add page view when enter is pressed" 


      it "navigates to the add page view when spacebar is pressed" 

    end

    context "Publish Cloud" do

      it "should set focus back to the publish cloud after unpublish" 


      it "should set focus back to the publish cloud after publish" 
    ...
    context "Delete Page" do
      ...
      it "returns focus back to the item cog if the item was not deleted" 


      it "returns focus back to the item cog if escape was pressed" 


      it "returns focus back to the item cog if the dialog close was pressed" 


      it "returns focus to the previous item title if it was deleted" 


      it "returns focus to the + Page button if there are no previous item cogs" 
    ...
    context "Use as Front Page Link" do
      ...
      it "should set focus back to the cog after setting" 


      it "should set focus to the next focusable item if you press Tab" 
    ...
    context "Cog menu" do
      ...
      it "should set focus back to the cog menu if you cancel the dialog" 


      it "sets focus back to the cog if you press escape" 


      it "sets focus back to the cog if you click the dialog close button" 


      it "should return focus to the dialog if you cancel, then reopen the dialog" 


      it "should set focus back to the cog menu if you edit the title and save" 
    ...
    context "Revisions Page" do
      ...
      it "should focus the revision buttons" 
      ...
      it "keeps focus on clicked revision button" 
  ...
  context "Show Page" do
    ...
    it "should not show the show all pages link if the pages tab is disabled" 
  ...
  context "menu tools" do
    ...
    it "should show tool launch links in the gear for items on the index" 


    it "should show tool launch links in the gear for items on the show page" 
  ...
  context "MathML" do
    ...
    it "should load mathjax in a page with <math>" 


    it "should not load mathjax without <math>" 
