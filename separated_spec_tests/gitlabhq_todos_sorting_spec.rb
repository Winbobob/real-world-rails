...
feature 'Dashboard > User sorts todos' do
  ...
  context 'sort options' do
    ...
    it 'sorts with oldest created todos first' 


    it 'sorts with newest created todos first' 


    it 'sorts by label priority' 
  ...
  context 'issues and merge requests' do
    ...
    it "doesn't mix issues and merge requests label priorities" 
