...
describe PersonDecorator, :draper_with_helpers do
  ...
  context 'participations' do
    ...
    it 'pending_applications returns events that are not active' 


    it 'upcoming_events returns events that are active' 
  ...
  context 'layer group' do
    ...
    it 'creates link for group layer' 


    it 'empty string if no group layer' 
