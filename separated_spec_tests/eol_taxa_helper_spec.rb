...
describe TaxaHelper do
  ...
  describe "#common_names_by_language" do
    ...
    it "should sort names by language" 


    it "should put the preferred language first" 


    it 'should put unknown language last' 


    it 'should remove names duplicated by curator entries' 
  ...
  it 'keeps the format of the verbatim known uris' 


  it 'should have superscript if the known uri has karat' 
