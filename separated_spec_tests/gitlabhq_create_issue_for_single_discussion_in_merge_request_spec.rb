...
feature 'Resolve an open discussion in a merge request by creating an issue' do
  ...
  describe 'As a user with access to the project' do
    ...
    context 'resolving the discussion', :js do
      ...
      it 'shows the link for creating a new issue when unresolving a discussion' 

    end

    it 'has a link to create a new issue for a discussion' 
    ...
    context 'creating the issue' do
      ...
      it 'has a hidden field for the discussion' 
