  ...
  module Mocks
    RSpec.describe "Serialization of mocked objects" do
      ...
      shared_examples 'normal YAML serialization' do
        it 'serializes to yaml the same with and without stubbing, using #to_yaml' 


        it 'serializes to yaml the same with and without stubbing, using YAML.dump' 
      ...
      without_yaml_loaded do
        it 'does not add #to_yaml to the stubbed object' 

      end

      it 'marshals the same with and without stubbing' 
