...
describe 'Rack Attack global throttles' do
  ...
  shared_examples_for 'rate-limited token-authenticated requests' do
    ...
    context 'when the throttle is enabled' do
      ...
      it 'rejects requests over the rate limit' 


      it 'allows requests after throttling and then waiting for the next period' 


      it 'counts requests from different users separately, even from the same IP' 


      it 'counts all requests from the same user, even via different IPs' 
    ...
    context 'when the throttle is disabled' do
      ...
      it 'allows requests over the rate limit' 
  ...
  describe 'unauthenticated requests' do
    ...
    context 'when the throttle is enabled' do
      ...
      it 'counts requests from different IPs separately' 
