...
describe 'DataPointUris' do
  ...
  shared_examples_for 'activity_logs check with permission' do
    ...
    it 'should show activity on the homepage' 

    it 'should show activity on the taxon overview page' 

    it 'should show activity on the taxon ancestors overview page' 

    it 'should show activity on the taxon updates page' 

    it 'should show activity on the users activity page' 

    it 'should show activity in the newfeed of a containing collection' 
  ...
  shared_examples_for 'activity_logs check without permission' do
    it 'should not show activity on the homepage' 

    it 'should not show activity on the taxon overview page' 

    it 'should not show activity on the taxon ancestors overview page' 

    it 'should not show activity on the taxon updates page' 

    it 'should not show activity on the users activity page' 

    it 'should not show activity in the newfeed of a containing collection' 
