...
describe "Global Survey questionnaire tests for instructor interface" do
  ...
  it "is able to create a Global survey" 


  it "is able to deploy a global survey with valid dates" 


  it "is not able to deploy a global survey with invalid dates" 


  it "is able to add and edit questions to a course survey" 


  it "is able to delete question from a global survey" 
