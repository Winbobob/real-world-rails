...
describe Redmine::MenuManager::MenuHelper, type: :helper do
  ...
  it 'should menu items for should yield all items if passed a block' 


  it 'should menu items for should return all items' 


  it 'should menu items for should skip unallowed items on a project' 


  it 'should menu items for should skip items that fail the conditions' 
