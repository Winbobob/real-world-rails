...
describe AppointmentGroupsController do
  ...
  context "old scheduler" do
    describe "GET 'index'" do
      it 'redirects to the scheduler tab index' 

    end

    describe "GET 'show'" do
      it 'redirects to a specific appointment group in the scheduler' 
  ...
  context "new scheduler" do
    ...
    describe "GET 'index'" do
      it "redirects to the agenda, starting at the first appointment group's start_at" 

    end

    describe "GET 'show'" do
      it "without appointment - redirects to the agenda on date of appt. in find_appointment mode" 


      it "redirects to a specific event on the month view" 


      it "with appt it redirects to the agenda, starting at the date of appt. group" 

      it "with appt it redirects to a specific event in month view" 

      it "with appt it redirects to a specific parent event in month view if requester did not create the event." 

      it "with group appt it redirects to the agenda, starting at the date of appt. group, no find appt. mode." 
