...
describe NotificationPreferencesController, type: :request do
  ...
  describe "index" do
    ...
    it "should list preferences by id" 


    it "should list preference by address" 
  ...
  describe "show" do
    ...
    it "should list a single preference by id" 


    it "should list a single preference by address" 
  ...
  describe "update" do
    ...
    it "should update a single preference by id" 


    it "should update a single preference by address" 


    it "should update a single preference JSON API style" 
  ...
  describe "update_preferences_by_category" do
    ...
    it "should update preferences by id and category" 


    it "should update preferences by category JSON API style" 
  ...
  describe "update_all" do
    ...
    it "should update multiple preferences by id" 


    it "should update multiple preferences by address" 


    it "should update multiple preferences JSON API style" 
