...
describe "Customer Details", type: :feature, js: true do
  ...
  context "brand new order" do
    ...
    it "does not reset guest checkout to true when returning to customer tab" 
  ...
  context "editing an order" do
    ...
    it "should be able to update customer details for an existing order" 
    ...
    context "country associated was removed" do
      ...
      it "sets default country when displaying form" 
