...
describe "conversations new" do
  ...
  describe "replying" do
    ...
    it "should not let a student reply to a student conversation if they lose messaging permissions" 


    it "should let a student reply to a conversation including a teacher even if they lose messaging permissions" 
