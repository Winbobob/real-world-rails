  ...
  describe WebhookHandler do
    ...
    describe "handle" do
      context "when the event is known" do
        ...
        it "calls the handler method, and returns the result" 
      ...
      context "when the event is unknown" do
        ...
        it "does not call the handler method, and returns :unknown" 
    ...
    describe "deauthorize" do
      context "when the event has no 'account' attribute" do
        it "does destroy stripe accounts, returns :ignored" 
