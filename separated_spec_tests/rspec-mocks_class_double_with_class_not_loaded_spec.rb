...
module RSpec
  module Mocks
    RSpec.describe 'A class double with the doubled class not loaded' do
      ...
      it 'includes the double name in errors for unexpected messages' 


      it 'allows any method to be stubbed' 
      ...
      context "when stubbing a private module method" do
        ...
        it 'can mock private module methods' 
      ...
      context "when the class const has been previously stubbed" do
        ...
        it "treats the class as being unloaded for `class_double('NonLoadedClass')`" 


        it "treats the class as being unloaded for `instance_double(NonLoadedClass)`" 
