...
describe "review mapping" do
  ...
  it "show error when assign both 2" 


  it "show error when assign both 0" 


  it "calculate review mapping from given review number per student" 


  it "calculate reviewmapping from given review number per submission" 
