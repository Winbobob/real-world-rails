...
describe 'GoogleIntegration::Classroom::Parsers::Courses' do
  ...
  describe 'when the user is a teacher' do
    ...
    describe 'classrooms that were archived on Google' do
      ...
      it "don't show up if they have not been imported" 
  ...
  describe 'when the user is a student' do
    ...
    it 'only returns google classroom ids where the student is not the class owner' 


    it 'will not return google classroom ids where the student is the class owner' 
