...
describe Column do
  ...
  describe '#type' do
    it 'returns the type of the column as returned by the database' 

  end #type

  describe '#geometrify' do
    it "parses and updates the passed geometry column if it's in WKT" 


    it 'raises if empty geometry column' 


    it "guarantees the geometry column ends up with a geometry type" 

  end #parse

  describe '#convert_from_wkt' do
    it 'populates an existing geometry column parsing its values in WKT' 


    it "raises if column contents aren't in WKT" 

  end #convert_from_wkt

  describe '#convert_from_geojson' do
    it 'populates an existing geometry column parsing its values in GeoJSON' 


    it "raises if column contents aren't in GeoJSON" 

  end

  describe '#convert_from_kml_point' do
    it 'populates an existing geometry column parsing its values in KML Point' 


    it "raises if column contents aren't in KML Point" 

  end

  describe '#convert_from_kml_multi' do
    it 'populates an existing geometry column parsing its values in KML Multi' 
  ...
  describe '#wkb?' do
    it 'returns true if the passed column contains geometries in WKB' 
  ...
  describe '#kml_point?' do
    it 'returns true if the passed column contains geometries in KML Point' 
  ...
  describe '#kml_multi?' do
    it 'returns true if the passed column contains geometries in KML Multi' 
  ...
  describe '#cast_to' do
    it 'casts the passed column to a geometry type' 


    it "raises if column contents aren't geometries" 
  ...
  describe '#sample' do
    ...
    it 'returns nil if no records with data in the column' 

  end # sample

  describe '#records_with_data' do
    it 'returns a dataset with those records with  data in this column' 

  end #records_with_data

  describe '#empty?' do
    it 'returns true if no records with data in this column' 
  ...
  describe '#rename_to' do
    ...
    it 'does nothing if the new name is the same as the current one' 

  end #rename_to

  describe '#sanitized_name' do
    it 'returns a sanitized version of the column name' 


    it 'returns the same name if no sanitization needed' 

  end #sanitized_name

  describe '#reserved?' do
    it 'returns true if name is a reserved keyword' 

  end #reserved?

  describe '#unsupported?' do
    it 'returns true if name is not supported by Postgres' 
