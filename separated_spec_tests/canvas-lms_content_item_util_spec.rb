...
describe Lti::ContentItemUtil do
  ...
  context "with callback url" do
    ...
    it 'makes a POST to confirm creation' 


    it 'makes a DELETE to signify Cancelation' 
  ...
  context "without callback url" do
    ...
    it "will not call back for success if no confirmUrl is present" 


    it "will not call back for failure if no confirmUrl is present" 
