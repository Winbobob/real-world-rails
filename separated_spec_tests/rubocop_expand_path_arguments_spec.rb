...
RSpec.describe RuboCop::Cop::Style::ExpandPathArguments, :config do
  ...
  it "registers an offense when using `File.expand_path('..', __FILE__)`" 
  ...
  it 'does not register an offense when using `File.expand_path(__dir__)`' 
  ...
  it 'does not register an offense when using `File.expand_path(__FILE__)`' 
  ...
  it 'autocorrects `File.expand_path(__dir__)`' 


  it 'autocorrects `File.expand_path('..', __dir__)`' 


  it 'autocorrects `File.expand_path(__FILE__)`' 


  it 'autocorrects `Pathname(__dir__).expand_path`' 


  it 'autocorrects `Pathname.new(__dir__).expand_path`' 
