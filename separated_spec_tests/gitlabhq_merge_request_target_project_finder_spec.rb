...
describe MergeRequestTargetProjectFinder do
  ...
  shared_examples 'finding related projects' do
    ...
    it 'does not include projects that have merge requests turned off' 


    it 'does not contain archived projects' 
  ...
  context 'private projects' do
    ...
    it 'only finds the projects the user is a member of' 
