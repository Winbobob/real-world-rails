...
feature 'Resolving all open discussions in a merge request from an issue', :js do
  ...
  describe 'as a user with access to the project' do
    ...
    it 'shows a button to resolve all discussions by creating a new issue' 
    ...
    context 'resolving the discussion' do
      ...
      it 'hides the link for creating a new issue' 
    ...
    context 'for a project where all discussions need to be resolved before merging' do
      ...
      context 'with the internal tracker disabled' do
        ...
        it 'does not show a link to create a new issue' 
      ...
      context 'merge request has discussions that need to be resolved' do
        ...
        it 'shows a warning that the merge request contains unresolved discussions' 


        it 'has a link to resolve all discussions by creating an issue' 
  ...
  describe 'as a reporter' do
    ...
    it 'Shows a notice to ask someone else to resolve the discussions' 
