...
RSpec.describe Listener do
  ...
  describe 'initialize' do
    ...
    context 'with a block' do
      ...
      it 'passes the block to the event processor' 
    ...
    context 'with directories' do
      ...
      it 'passes directories to backend' 
  ...
  describe '#ignore' do
    context 'with existing ignore options' do
      ...
      it 'adds up to existing ignore options' 
  ...
  describe '#ignore!' do
    ...
    context 'with existing ignore! options' do
      ...
      it 'overwrites existing ignore options' 
