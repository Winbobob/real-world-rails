...
RSpec.describe RuboCop::Cop::Rails::RedundantReceiverInWithOptions, :config do
  ...
  context 'rails >= 4.2' do
    ...
    it 'registers an offense when using explicit receiver in `with_options`' 
    ...
    it 'autocorrects to implicit receiver in `with_options`' 


    it 'autocorrects to implicit receiver when including multiple receivers' 
