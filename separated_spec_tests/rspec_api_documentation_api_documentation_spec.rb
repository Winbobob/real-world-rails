...
describe RspecApiDocumentation::ApiDocumentation do
  ...
  describe "#clear_docs" do
    ...
    it "should rebuild the docs directory" 
  ...
  describe "#document_example" do
    ...
    it "should create a new wrapped example" 
    ...
    context "when the given example should be documented" do
      ...
      it "should add the wrapped example to the index" 
    ...
    context "when the given example should not be documented" do
      ...
      it "should not add the wrapped example to the index" 
  ...
  describe "#writers" do
    ...
    context "multiple" do
      ...
      it "should return the classes from format" 
  ...
  describe "#write" do
    ...
    it "should write the docs in each format" 
