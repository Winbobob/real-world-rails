...
describe EventInstancesController do
  ...
  describe '#update' do
    ...
    context 'twitter notification' do
      it 'calls the TwitterService to tweet yt_link if yt_video_id is changed' 


      it 'calls the TwitterService to tweet notification if event has started and hangout url changed' 


      it 'does not call the TwitterService to tweet notification if event has not started' 


      it 'does not call the TwitterService to tweet notification if event hangout url has not changed' 
