...
feature 'Pipeline Schedules', :js do
  ...
  context 'logged in as master' do
    ...
    describe 'GET /projects/pipeline_schedules' do
      ...
      describe 'The view' do
        it 'displays the required information description' 


        it 'creates a new scheduled pipeline' 


        it 'changes ownership of the pipeline' 


        it 'edits the pipeline' 
      ...
      context 'when ref is nil' do
        ...
        it 'shows a list of the pipeline schedules with empty ref column' 
    ...
    describe 'POST /projects/pipeline_schedules/new' do
      ...
      it 'sets defaults for timezone and target branch' 


      it 'it creates a new scheduled pipeline' 


      it 'it prevents an invalid form from being submitted' 
    ...
    describe 'PATCH /projects/pipelines_schedules/:id/edit' do
      ...
      it 'it displays existing properties' 


      it 'edits the scheduled pipeline' 
      ...
      context 'when ref is nil' do
        ...
        it 'shows the pipeline schedule with default ref' 
  ...
  context 'logged in as non-member' do
    ...
    describe 'GET /projects/pipeline_schedules' do
      ...
      describe 'The view' do
        it 'does not show create schedule button' 
