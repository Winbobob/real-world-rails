...
describe 'OAuth' do
  ...
  describe 'Authorizations' do
    ...
    it 'displays the authorizations' 


    it 'displayes scopes for authorization' 
  ...
  describe 'applications' do
    ...
    context 'no applications exist' do
      ...
      it 'does not display applications' 
    ...
    context 'creating an application' do
      ...
      it 'can create an application' 


      it "displays app and get secret" 
    ...
    context 'application listing' do
      ...
      it "allows user to generate new api key" 


      it 'displays private status' 


      it 'allows a user to request public access' 


      context 'app is public' do
        let!(:app) { FactoryGirl.create(:application, public: true, name: 'testApp', owner: user) }

        it 'displays public status' 

      end

      it 'can navigate to the edit page' 
