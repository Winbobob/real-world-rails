...
describe Guardian do
  ...
  describe '#post_can_act?' do
    ...
    it "doesn't allow flagging of staff posts when allow_flagging_staff is false" 


    it "allows liking of staff when allow_flagging_staff is false" 
  ...
  describe 'post_can_act?' do
    ...
    describe 'a Post' do
      ...
      it "doesn't allow voting if the user has an action from voting already" 


      it "allows voting if the user has performed a different action" 
  ...
  context 'can_delete?' do
    ...
    context 'a Post' do
      ...
      context 'post is older than post_edit_time_limit' do
        ...
        it 'returns false for another regular user trying to delete your post' 
