...
RSpec.describe ProjectDecorator do
  ...
  describe '#status_flag' do
    ...
    context 'When the project is successful' do
      it 'should return a successful image flag when the project is successful' 

    end

    context 'When the project was not successful' do
      it 'should return a not successful image flag when the project is not successful' 

    end

    context 'When the project is in waiting funds' do
      it 'should return a waiting funds image flag when the project is waiting funds' 
