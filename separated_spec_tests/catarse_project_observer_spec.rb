...
RSpec.describe ProjectObserver do
  ...
  describe '#before_save' do
    context 'when video_url changed' do
      ...
      it 'should clean embed_url when video_is null' 
    ...
    context 'when project is new' do
      ...
      it 'should call update_expires_at' 
    ...
    context 'when project is being updated and online_days does not change' do
      ...
      it 'should not call update_expires_at' 
  ...
  describe '#after_save' do
    ...
    context 'when we change the video_url' do
      ...
      it 'should call project downloader' 
  ...
  describe 'from_successful_to_rejected' do
    ...
    it 'should refund contributons' 


    it 'should remove project owner balance' 
  ...
  describe '#from_waiting_funds_to_successful' do
    ...
    it 'should create notification for admin' 


    it 'should create notification for project owner' 
