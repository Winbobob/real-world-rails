...
module Spree
  describe ProductsHelper, type: :helper do
    ...
    context '#variant_price_full' do
      ...
      context 'when currency is default' do
        it 'returns the variant price if the price is different than master' 
      ...
      it 'is nil when all variant prices are equal' 

    end

    context '#product_description' do
      # Regression test for #1607
      it 'renders a product description without excessive paragraph breaks' 


      it 'renders a product description with automatic paragraph breaks' 


      it 'renders a product description without any formatting based on configuration' 
    ...
    context '#cache_key_for_product' do
      ...
      context 'when there is a current tax zone' do
        ...
        it 'includes the current_tax_zone' 
      ...
      context 'when current_price_options includes nil values' do
        ...
        it 'does not include nil values' 
      ...
      context 'when current_price_options includes values that do not implement cache_key' do
        ...
        it 'includes string representations of these values' 
      ...
      context 'when keys in the options hash are inserted in non-alphabetical order' do
        ...
        it 'the values are nevertheless returned in alphabetical order of their keys' 
