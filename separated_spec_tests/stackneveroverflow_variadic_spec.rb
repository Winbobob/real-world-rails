...
describe "Function with variadic arguments" do
  ...
  it "takes enum arguments" 


  it "returns symbols for enums" 


  it 'can wrap a blocking function with varargs' 


  [ 0, 127, -128, -1 ].each do |i|
    it "call variadic with (:char (#{i})) argument" 

  end

  [ 0, 0x7f, 0x80, 0xff ].each do |i|
    it "call variadic with (:uchar (#{i})) argument" 

  end

  [ 0, 1.234567, 9.87654321 ].each do |v|
    it "call variadic with (:float (#{v})) argument" 

  end

  [ 0, 1.234567, 9.87654321 ].each do |v|
    it "call variadic with (:double (#{v})) argument" 
