...
describe SubmissionsController do
  ...
  describe "PUT update" do
    ...
    it "should require the right student" 


    it "should allow updating homework to add comments" 


    it "should allow a non-enrolled admin to add comments" 


    it "should allow a non-enrolled admin to add comments on a submission to muted assignment" 


    it "should comment as the current user for all submissions in the group" 


    it "should allow attaching files to the comment" 
    ...
    describe 'allows a teacher to add draft comments to a submission' do
      ...
      it 'when draft_comment is true' 


      it 'except when draft_comment is nil' 


      it 'except when draft_comment is false' 
    ...
    it "should allow setting 'student_entered_grade'" 


    it "should round 'student_entered_grade'" 


    it 'changing student_entered_grade for a quiz does not change the workflow_state of a submission' 
    ...
    context "moderated grading" do
      ...
      it "should create a provisional comment" 


      it "should create a final provisional comment" 
