...
describe 'routing', type: :routing do
  ...
  context 'activities' do
    ...
    it 'should route /activities to activities#index' 

    it 'should route /activites.atom to activities#index' 
    ...
    it 'should route project/eCookbook/activities to activities#index' 

    it 'should route project/eCookbook/activites.atom to activities#index' 
  ...
  context 'attachments' do
    ...
    it 'should redirect /atttachments/download/1 to /attachments/1' 


    it 'should redirect /atttachments/download/1/filename.ext to /attachments/1/filename.ext' 
