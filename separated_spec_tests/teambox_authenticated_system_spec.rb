...
describe <%= controller_class_name %>Controller do
  ...
  describe "logout_killing_session!" do
    ...
    it 'kills :<%= file_name %>_id session' 
  ...
  describe "Logging in by cookie" do
    ...
    it 'logs in with cookie' 

    
    it 'fails cookie login with bad cookie' 

    
    it 'fails cookie login with no cookie' 

    
    it 'fails expired cookie login' 
