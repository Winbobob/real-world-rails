...
describe "Checkout", type: :feature, inaccessible: true do
  ...
  context "visitor makes checkout as guest without registration" do
    ...
    context "free shipping" do
      ...
      it "should not show 'Free Shipping' when there are no shipments" 
  ...
  context "Coupon promotions", js: true do
    ...
    it "applies them & refreshes the page on user clicking the Apply Code button" 


    context "with invalid coupon" do
      it "doesnt apply the promotion" 
  ...
  context "with attempted XSS", js: true do
    shared_examples "safe from XSS" do
      ...
      it "displays the entered state name without evaluating" 
