...
describe NotificationEmailer do
  ...
  shared_examples "enqueue" do
    ...
    it "enqueues a job for the email" 


    context "inactive user" do
      before { notification.user.active = false }

      it "doesn't enqueue a job" 


      it "enqueues a job if the user is staged" 


      it "enqueues a job if the user is staged even if site requires user approval" 
  ...
  shared_examples "enqueue_public" do
    ...
    it "doesn't enqueue a job if the user has mention emails disabled" 
  ...
  shared_examples "enqueue_private" do
    ...
    it "doesn't enqueue a job if the user has private message emails disabled" 
  ...
  context 'user_mentioned' do
    ...
    it "enqueue a delayed job for users that are online" 
  ...
  context 'user_private_message' do
    ...
    it "doesn't enqueue a job for a small action" 
