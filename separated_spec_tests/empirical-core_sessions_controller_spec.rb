...
describe SessionsController, type: :controller do
  ...
  describe '#login_through_ajax with' do
    ...
    describe 'an auditor flag' do
      ...
      it 'redirects to the standard redirect route if the user does not have a school subscription' 

      it 'redirects to the subscriptions page if the user does have a school subscription' 
    ...
    describe 'valid attributes' do
      ...
      it "returns the standard redirect route" 
