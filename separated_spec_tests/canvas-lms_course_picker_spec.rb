...
describe "master courses - course picker" do
  ...
  it "should show all courses by default", priority: "1", test_id: "3077485" 


  it "should filter the course list by name", priority: "1", test_id: "3265699" 


  it "should filter the course list by short name", priority: "1", test_id: "3265700" 


  it "should filter the course list by SIS ID", priority: "1", test_id: "3265701" 
  ...
  it "should filter the course list by term", priority: "1", test_id: "3075534" 


  it "should filter the course list by sub-account", priority: "1", test_id: "3279950" 
