...
feature 'Signing up for a new admin account' do
  ...
  context 'when signing up with existing email', email: true do
    ...
    it 'redirects back to admin portal sign in page' 


    it 'sends an email to the user informing them of sign up' 


    it 'mentions the admin portal' 


    it 'links to the admin sign in page' 


    it 'links to the admin sign up page' 


    it 'links to the admin reset password page' 


    it 'mentions the admin portal in the email subject' 
