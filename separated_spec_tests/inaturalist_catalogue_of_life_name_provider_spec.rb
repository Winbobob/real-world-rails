...
describe Ratatosk::NameProviders::ColNameProvider do
  ...
  it "should return a currently accepted taxon when queried for an invalid synonym" 


  it "should set the phylum for Periploca ceanothiella to Animalia" 
...
describe Ratatosk::NameProviders::ColTaxonNameAdapter do
  ...
  it "should set the lexicon correctly for iiwi" 
