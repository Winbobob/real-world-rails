...
describe "collaborations" do
  ...
  describe "Accessibility" do
    ...
    it 'should set focus to the previous delete icon when deleting an etherpad collaboration' 


    it 'should set focus to the add collaboration button if there are no previous collaborations' 
