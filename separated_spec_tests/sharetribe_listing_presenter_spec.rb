...
RSpec.describe ListingPresenter, type: :presenter do
  ...
  context '#shapes' do
    ...
    it 'contains ordered shapes without deleted' 
  ...
  context 'availability per hour' do
    ...
    it '#availability_per_hour_options_for_select_grouped_by_day' 


    it '#availability_per_hour_options_for_select_grouped_by_day is busy part day.' 


    it '#availability_per_hour_options_for_select_grouped_by_day rejected booking does not block.' 
