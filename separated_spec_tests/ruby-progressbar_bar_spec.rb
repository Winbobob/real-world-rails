...
module   Components
describe Bar do
  it 'has a default mark when a new bar is created and no parameters are passed' 
  ...
  it 'returns the overridden mark when a new bar is created and options are passed' 
  ...
  it 'displays the bar with no indication of progress when just begun' 
  ...
  it 'displays the bar as 100% complete when completed' 


  it 'displays the bar as 100% complete when completed and the bar is incremented' 


  it 'displays the bar as 98% complete when completed and the bar is decremented' 


  it 'is represented correctly when a bar has an unknown amount to completion' 
  ...
  it 'is represented correctly when a bar has a customized unknown animation' 


  it 'displays the bar with an integrated percentage properly when empty' 
  ...
  it 'displays the bar with an integrated percentage properly when finished' 
