...
describe AsciicastDecorator do
  ...
  describe '#os' do
    ...
    context 'when user_agent is present' do
      ...
      context 'and the OS is other (0.9.9+ client)' do
        ...
        it 'should return first token titleized' 
  ...
  describe '#terminal_type' do
    ...
    it "returns asciicast's terminal_type when non-blank" 


    it 'returns "?" for blank terminal_type' 
  ...
  describe '#shell' do
    ...
    it 'returns last segment of shell path' 
  ...
  describe '#title' do
    ...
    it "prefers model title to command and id" 


    it "prefers command to id when command is not equal to shell" 


    it "prefers id to command when command is equal to shell" 


    it "returns id when no model title nor command set" 
  ...
  describe '#description' do
    ...
    context 'when description present' do
      ...
      it 'should be processed with markdown processor' 
  ...
  describe '#thumbnail' do
    ...
    it "returns snapshot's thumbnail rendered by SnapshotPresenter" 
