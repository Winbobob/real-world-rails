...
describe 'API::Stateless Braintree PaymentMethods' do
  ...
  describe 'GET index' do
    it 'lists all payment methods that have been stored in vault for the member' 


    it 'does not list inactive methods or payment methods that have not been stored in vault' 
  ...
  describe 'DELETE destroy' do
    ...
    it 'marks local record as cancelled' 


    it 'destroys record from Braintree' 
