...
describe 'Signing in with a redirect parameter' do
  ...
  context 'when not logged in' do
    ...
    it 'redirects to an unprotected path' 


    it 'redirects to an embargoed request that you own' 


    it 'renders a 404 when redirecting to an embargoed request that is not yours' 
