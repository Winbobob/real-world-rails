  ...
  context "on the dashboard" do
    ...
    context "as a student" do
      context "in the base section" do
        it "shows the course due date in 'todo'" 


        it "shows the course due date in 'coming up'" 

      end

      context "in the overridden section" do
        it "shows the section due date in 'todo'" 


        it "shows the section due date in 'coming up" 

      end
    end

    context "as the teacher" do
      it "shows multiple due dates in 'coming up'" 


      it "shows multiple due dates in 'todo'" 
