...
describe ProjectPolicy do
  ...
  it 'does not include the read_issue permission when the issue author is not a member of the private project' 
  ...
  context 'when the feature is disabled' do
    ...
    it 'does not include the wiki permissions' 
  ...
  context 'issues feature' do
    ...
    context 'when the feature is disabled' do
      it 'does not include the issues permissions' 
  ...
  context 'merge requests feature' do
    ...
    it 'disallows all permissions when the feature is disabled' 
  ...
  shared_examples 'archived project policies' do
    ...
    context 'when the project is archived' do
      ...
      it 'disables write actions on all relevant project features' 


      it 'disables some other important write actions' 


      it 'does not disable other other abilities' 
  ...
  context 'when a public project has merge requests allowing access' do
    ...
    it 'does not allow pushing code' 


    it 'allows pushing if the user is a member with push access to the target project' 


    it 'dissallows abilities to a maintainer if the merge request was closed' 
