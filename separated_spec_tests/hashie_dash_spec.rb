...
describe DashTest do
  ...
  describe '#update_attributes!(params)' do
    ...
    context 'codependent attributes' do
      ...
      it 'does not raise an error when only the first property is set' 


      it 'does not raise an error when only the second property is set' 


      it 'does not raise an error when both properties are set' 


      it 'raises an error when neither property is set' 
