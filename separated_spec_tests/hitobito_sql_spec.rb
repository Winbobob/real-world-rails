...
describe SearchStrategies::Sql do
  ...
  describe '#list_people' do
    ...
    context 'as admin' do
      ...
      it 'finds accessible person' 


      it 'finds accessible person with two terms' 


      it 'does not find not accessible person' 


      it 'does not search for too short queries' 


      it 'finds people without any roles' 


      it 'does not find people not accessible person with deleted role' 


      it 'finds deleted people' 


      it 'finds deleted, not accessible people' 
    ...
    context 'as leader' do
      ...
      it 'finds local accessible person' 


      it 'does not find people without any roles' 


      it 'does not find deleted people' 
