...
RSpec.describe ChallengeCallResponsesController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      it "creates a new ChallengeCallResponse" 


      it "assigns a newly created ChallengeCallResponse as @challenge_call_response" 


      it "redirects to the created challenge_call_response" 
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved challenge_call_response as @challenge_call_response" 
