...
feature 'Top menu items', js: true, selenium: true do
  ...
  describe 'Modules' do
    ...
    context 'as an admin' do
      ...
      it 'visits the time sheet page' 


      it 'visits the news page' 

    end

    context 'as a regular user' do
      it 'displays news only' 
    ...
    context 'as a user without permissions', allowed_to: false do
      let(:open_menu) { false }
      it 'displays no options and hides the module menu' 
  ...
  describe 'Projects' do
    ...
    context 'as an admin' do
      ...
      it 'visits the work package page' 
    ...
    context 'as a user without project permission' do
      ...
      it 'does not display new_project' 
