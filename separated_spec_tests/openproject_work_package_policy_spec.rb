...
describe WorkPackagePolicy, type: :controller do
  ...
  describe '#allowed?' do
    ...
    context 'for edit' do
      ...
      it 'is true if the user has the add_work_package_notes permission in the project' 


      it 'is false if the user has the edit_work_package permission in the project' 


      it 'is false if the user has the permissions but the work package is unperisted' 
