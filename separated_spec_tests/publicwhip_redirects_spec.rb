...
describe "routing redirects", type: :request do
  ...
  it "/account/changepass.php -> /account/edit" 


  it "/account/changeemail.php -> /account/edit" 


  it "/policies.php -> /policies" 


  it "/policy.php?id=2 -> /policies/2" 


  it "/policy.php?id=3&display=motions -> /policies/3/detail" 


  it "/policy.php?display=editdefinition&id=1 -> /policies/1/edit" 


  it "/account/addpolicy.php -> /policies/new" 


  it "/mp.php?display=allvotes&dmp=1&house=senate&mpc=Tasmania&mpn=Eric_Abetz -> /mp.php?dmp=1&house=senate&mpc=Tasmania&mpn=Eric_Abetz" 
  ...
  it "/mp.php?mpid=1&dmp=1 -> /mp.php?house=representatives&mpc=Warringah&mpn=Tony_Abbott&dmp=1" 


  # showall=yes means the same thing as display=allvotes. allvotes has been removed in favour of everyvote
  it "/mp.php?house=representatives&mpc=Warringah&mpn=Tony_Abbott&showall=yes -> /mp.php?display=everyvote&house=representatives&mpc=Warringah&mpn=Tony_Abbott" 


  it "/mp.php?display=allvotes&id=uk.org.publicwhip/member/1 -> /mp.php?display=allvotes&house=representatives&mpc=Warringah&mpn=Tony_Abbott" 


  it "/mp.php?display=summary&house=representatives&mpc=Warringah&mpn=Tony_Abbott -> /mp.php?house=representatives&mpc=Warringah&mpn=Tony_Abbott" 
