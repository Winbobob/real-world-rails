...
feature 'Issues > Labels bulk assignment' do
  ...
  context 'as an allowed user', :js do
    ...
    context 'sidebar' do
      ...
      it 'is present when bulk edit is enabled' 


      it 'is not present when bulk edit is disabled' 
    ...
    context 'toggling a milestone' do
      ...
      context 'setting a milestone and adding another label' do
        ...
        it 'keeps existing label and new label is present' 
    ...
    context 'unmarking common label' do
      ...
      it 'applies label from filtered results' 
