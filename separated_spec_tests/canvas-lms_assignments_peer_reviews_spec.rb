...
describe "assignments" do
  ...
  context "peer reviews" do
    ...
    it "displays the intra-group review toggle for group assignments" 
    ...
    context "rubric assessments" do
      ...
      it "should not let a student submit a rubric review if the request is completed" 


      it "should let a student submit a rubric review even if already completed if a rubric is added afterwards" 
