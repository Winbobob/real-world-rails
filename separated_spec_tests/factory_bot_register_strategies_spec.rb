...
describe "register custom strategies" do
  ...
  it "allows overriding default strategies" 


  it "allows adding additional strategies" 


  it "allows using the *_list method to build a list using a custom strategy" 


  it "allows using the *_pair method to build a list using a custom strategy" 
...
describe "associations without overriding :strategy" do
  ...
  context "when the :use_parent_strategy config option has not been enabled" do
    ...
    it "uses the overridden strategy on the association" 
  ...
  context "when the :use_parent_strategy config option has been enabled" do
    ...
    it "uses the parent strategy on the association" 
...
describe "associations overriding :strategy" do
  ...
  it "uses the overridden create strategy to create the association" 
