...
describe "calendar2" do
  ...
  context "as a teacher" do
    ...
    context "agenda view" do
      ...
      it "should display agenda events" 
      ...
      it "should respect context filters" 


      it "should be navigable via the jump-to-date control" 


      it "should be navigable via the minical" 


      it "should persist the start date across reloads" 


      it "should transfer the start date when switching views" 


      it "should display the displayed date range in the header" 


      it "should not display a date range if no events are found" 
      ...
      it "should allow deleting a quiz", priority: "1" 


      it "should display midnight assignments at 11:59" 
  ...
  context "agenda view with BETTER_SCHEDULER enabled" do
    ...
    context "as a student" do
      ...
      it "shows all options when in find appointment mode" 


      it "shows only the reserved option when not in find appointment mode" 
    ...
    context "as a teacher" do
      ...
      it "shows all appointment groups" 
