...
describe "return codes" do
  context "inside fixtures/frameworks" do
    ...
    it "has return code 0 when running testunit_good.rb" 


    it "has return code 0 when running rspec_good.rb" 


    it "has non-0 return code when running testunit_bad.rb" 


    it "has return code 1 when running rspec_bad.rb" 
