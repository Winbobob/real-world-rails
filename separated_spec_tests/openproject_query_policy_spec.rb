  ...
  describe '#allowed?' do
    ...
    shared_examples 'viewing queries' do |global|
      context "#{ global ? 'in global context' : 'in project context' }" do
        ...
        it 'is true if the query is public and another user views it' 
        ...
        context 'query belongs to a different user' do
          ...
          it 'is true if the query is private and the owner views it' 


          it 'is false if the query is private and another user views it' 
