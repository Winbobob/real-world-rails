...
describe <%= controller_class_name %>Controller do
  describe "route generation" do
    ...
    it "should route the create <%= controller_controller_name %> correctly" 

    it "should route the destroy <%= controller_controller_name %> action correctly" 

  end
  
  describe "route recognition" do
    it "should generate params from GET /login correctly" 

    it "should generate params from POST /<%= controller_routing_path %> correctly" 

    it "should generate params from DELETE /<%= controller_routing_path %> correctly" 
  ...
  describe "named routing" do
    ...
    it "should route <%= controller_routing_name %>_path() correctly" 

    it "should route new_<%= controller_routing_name %>_path() correctly" 
