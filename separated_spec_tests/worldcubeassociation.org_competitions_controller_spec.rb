...
RSpec.describe CompetitionsController do
  ...
  describe 'POST #update' do
    context 'when signed in as an admin' do
      ...
      it "can change registration requirements field after competition is confirmed" 
    ...
    context "when signed in as delegate" do
      ...
      it "can change registration requirements field before competition is confirmed" 


      it "cannot change registration requirements field after competition is confirmed" 
  ...
  describe 'GET #post_announcement' do
    context 'when signed in as results team member' do
      ...
      it 'creates an announcement post' 
