...
module OpenFoodNetwork
  describe UserBalanceCalculator do
    ...
    describe "finding the account balance of a user with a hub" do
      ...
      it "finds the correct balance for this email and enterprise" 
      ...
      context "with another hub" do
        ...
        it "does not find the balance for other enterprises" 
      ...
      context "with another user" do
        ...
        it "does not find the balance for other users" 
      ...
      context "with canceled orders" do
        ...
        it "does not include canceled orders in the balance" 
