...
describe SecretSharesController, type: :controller do
  ...
  describe 'POST create' do
    ...
    context 'signed in as creator of the moment' do
      ...
      it 'Creates Secret Share Identifier' 
    ...
    context 'not signed in' do
      ...
      it 'does not create Secret Share Identifier' 
  ...
  describe 'DELETE' do
    ...
    context 'signed in as creator of the moment' do
      ...
      it 'deletes Secret Share Identifier' 
    ...
    context 'not signed in' do
      ...
      it 'does not delete Secret Share Identifier' 
