...
feature 'Contributions Calendar', :js do
  ...
  describe 'calendar day selection' do
    ...
    describe 'select calendar day' do
      ...
      it 'displays calendar day activities' 
      ...
      describe 'select another calendar day' do
        ...
        it 'displays different calendar day activities' 
      ...
      describe 'deselect calendar day' do
        ...
        it 'hides calendar day activities' 
  ...
  describe 'calendar daily activities' do
    ...
    shared_examples 'a day with activity' do |contribution_count:|
      ...
      it 'displays calendar activity square color for 1 contribution' 


      it 'displays calendar activity square on the correct date' 
    ...
    describe '1 issue creation calendar activity' do
      ...
      describe 'issue title is shown on activity page' do
        ...
        it 'displays calendar activity log' 
    ...
    describe 'calendar activity on two days' do
      ...
      it 'displays calendar activity squares for both days' 


      it 'displays calendar activity square for yesterday' 


      it 'displays calendar activity square for today' 
