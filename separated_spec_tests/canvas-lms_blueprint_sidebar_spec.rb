...
describe "master courses sidebar" do
  ...
  describe "as a master course teacher" do
    ...
    it "should show sidebar trigger tab" 


    it "should show sidebar when trigger is clicked" 


    it "should not show the Associations button" 


    it "should show Sync History modal when button is clicked" 


    it "should show Unsynced Changes modal when button is clicked" 


    it "should not show the tutorial sidebar button" 
  ...
  describe "as a master course admin" do
    ...
    it "should show the Associations button" 


    it "should show Associations modal when button is clicked" 


    it "should open and close Associations modal from course settings page" 
    ...
    it "updates screenreader character usage message with character count" 


    it "issues screenreader alert when message is full" 
