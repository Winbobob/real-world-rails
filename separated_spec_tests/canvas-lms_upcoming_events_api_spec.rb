...
describe UsersController, type: :request do
  ...
  context "with current_user" do
    ...
    it "gets an empty list of upcoming events" 
    ...
    context "having a calendar event and assignment on the course" do
      ...
      it "doesn't gets the events if the course is unpublished and the user is a teacher" 


      it "doesn't gets the events if the course is unpublished and the user is a student" 
