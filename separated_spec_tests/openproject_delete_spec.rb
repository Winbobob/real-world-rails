...
describe 'user deletion: ', type: :feature, js: true do
  ...
  context 'regular user' do
    ...
    it 'cannot delete their own account if the settings forbid it' 
  ...
  context 'admin user' do
    ...
    it 'cannot delete other users if the settings forbid it' 


    it 'can change the deletablilty settings' 
