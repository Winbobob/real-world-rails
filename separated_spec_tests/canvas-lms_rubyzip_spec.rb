...
describe "rubyzip encoding fix patch" do
  ...
  context "with zip file" do
    ...
    describe "entries" do
      it "should return UTF-8 names in UTF-8 encoding" 


      it "should return non-UTF-8 names in ASCII-8BIT encoding" 

    end

    describe "find_entry" do
      it "should find a UTF-8 name" 


      it "should find a non-UTF-8 name" 
