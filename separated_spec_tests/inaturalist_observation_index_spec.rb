...
describe "Observation Index" do
  ...
  it "place_ids should include places that contain the uncertainty cell" 

  it "place_ids should not include places that do not contain the uncertainty cell" 

  it "place_ids should include county-level places that do not contain the uncertainty cell" 
