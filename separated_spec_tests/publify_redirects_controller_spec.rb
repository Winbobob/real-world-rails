...
describe Admin::RedirectsController, type: :controller do
  ...
  describe '#create' do
    it 'should create a new redirect and redirect to #index' 


    it 'should create a redirect with an empty from path and redirect to #index' 
  ...
  describe '#update an existing redirect' do
    it 'should update and redirect to #index' 
