...
describe Archiving do
  ...
  describe ".archive" do
    ...
    context "when uploading to S3 succeeds" do
      ...
      it "removes the temp archive file it creates" 
    ...
    context "when uploading to S3 doesn't happen" do
      ...
      it "does not delete the local copy" 
  ...
  describe ".unarchive" do
    ...
    it "reloads deliveries into the database" 
  ...
  describe ".serialise" do
    ...
    it "produces the same results with a Delivery object created directly as one created with .deserialise from a previously serialised Delivery" 
