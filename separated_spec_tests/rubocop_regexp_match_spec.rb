...
RSpec.describe RuboCop::Cop::Performance::RegexpMatch, :config do
  ...
  shared_examples :offense do |name, code, correction|
    it "registers an offense for #{name}" 
  ...
  shared_examples :all_legacy_match_methods do |name, cond, correction|
    ...
    %w[
      ...
      it "accepts #{name} in method with #{var}" 


      it "accepts #{name} in a class method with #{var}" 


      it "accepts #{name} in method with #{var} before if" 


      it "accepts #{name} in method with #{var} before unless" 


      it "accepts #{name} in method with #{var} in block" 
  ...
  context 'target ruby version < 2.4', :ruby23 do
    it 'accepts match method call in if condition' 


    it 'accepts match method call in elsif condition' 
  ...
  context 'target ruby version >= 2.4', :ruby24 do
    ...
    it 'accepts Regexp#match? method call' 


    it 'accepts String#match? method call' 


    it 'accepts match without arguments' 


    it 'accepts =~ with assignment' 
