...
describe FormHelper do
  ...
  describe '#entry_form' do
    ...
    it 'should contain input for name' 


    it 'should contain input for whatever' 


    it 'should contain input for children' 


    it 'should contain input for rating' 


    it 'should contain input for income' 


    it 'should contain input for birthdate' 


    it 'should contain input for human' 


    it 'should contain input for companion' 


    it 'should contain input for remarks' 
