...
describe 'UpdateCustomParams' do
  ...
  it 'should update specified LTI tools, and subdomains, to include new config variables' 


  it 'should not update subdomains w/o that option' 


  it 'should not update unrelated LTI tools' 


  it 'should validate that valid domains are passed in' 
