...
describe TagManager do
  describe '#initial_tags' do
    ...
    context 'when courses must be approved' do
      it 'adds a returning_instructor tag if the creator is a returning instructor' 


      it 'adds a first_time_instructor tag if the creator is not a returning instructor' 
    ...
    context 'when open course creation is enabled' do
      ...
      it 'adds a returning_instructor tag if the creator has more than one course' 


      it 'adds a first_time_instructor tag if the creator has only one course' 
