...
describe "Granule search overlay", reset: false do
  ...
  context "when clicking the 'Filter Granules' button" do
    ...
    it "should open granule search overlay" 
    ...
    it "should close granule search overlay when clicking close icon" 


    it "should hide the granule search overlay when returning to collection list" 


    it "should hide the granule search overlay when returning to the project" 
