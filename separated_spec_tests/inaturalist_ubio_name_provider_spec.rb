...
describe Ratatosk::NameProviders::UBioNameProvider do
  ...
  it "should not fetch duplicates within the same taxonomicGroup" 


  it "should not make identical taxa for Formica francoeuri"
  it "should work for Rhagastis albomarginatus" 
...
describe Ratatosk::NameProviders::UBioTaxonAdapter do
  ...
  it "should create a Taxon from a uBio LSID namebank RDF" 


  it "should create a Taxon from a uBio LSID classificationbank RDF" 


  it "should set the source_identifier of a Taxon created from a LSID classificationbank RDF to the nambank ID, not the classificationbank ID" 
