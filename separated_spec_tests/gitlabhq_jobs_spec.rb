...
feature 'Jobs', :clean_gitlab_redis_shared_state do
  ...
  describe "POST /:project/jobs/:id/cancel_all" do
    ...
    it 'shows all necessary content' 
  ...
  describe "GET /:project/jobs/:id" do
    ...
    context 'when job is not running', :js do
      ...
      context 'if job passed' do
        it 'does not show New issue button' 
      ...
      context 'if job failed' do
        ...
        it 'links to issues/new with the title and description filled in' 
    ...
    context "Download artifacts" do
      ...
      it 'has button to download artifacts' 
    ...
    context 'Artifacts expire date' do
      ...
      context 'no expire date defined' do
        ...
        it 'does not have the Keep button' 
      ...
      context 'when expire date is defined' do
        ...
        context 'when user has ability to update job' do
          it 'keeps artifacts when keep button is clicked' 
    ...
    context 'when job starts environment' do
      ...
      context 'job creates a new deployment' do
        ...
        it 'shows a link to latest deployment' 
    ...
    context 'Playable manual action' do
      ...
      it 'shows manual action empty state' 
  ...
  describe "POST /:project/jobs/:id/cancel", :js do
    context "Job from project" do
      ...
      it 'loads the page and shows all needed controls' 
  ...
  describe "POST /:project/jobs/:id/retry", :js do
    context "Job from project", :js do
      ...
      it 'shows the right status and buttons' 
