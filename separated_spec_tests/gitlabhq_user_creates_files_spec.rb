...
describe 'Projects > Files > User creates files' do
  ...
  context 'without commiting a new file' do
    ...
    context 'when an user does not have write access' do
      ...
      it 'opens new file page on a forked project' 
  ...
  context 'with commiting a new file' do
    context 'when an user has write access' do
      ...
      it 'allows Chinese characters in file name' 


      it 'allows Chinese characters in directory name' 


      it 'does not allow directory traversal in file name' 
    ...
    context 'when an user does not have write access' do
      ...
      it 'shows a message saying the file will be committed in a fork' 
