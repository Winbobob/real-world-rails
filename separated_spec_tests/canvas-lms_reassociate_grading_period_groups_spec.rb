...
describe DataFixup::ReassociateGradingPeriodGroups do
  ...
  context "pre-fixup" do
    it "root account enrollment terms do not have an associated grading period group" 


    it "root account enrollment terms do not have associated grading periods" 


    it "sub account enrollment terms do not have an associated grading period group" 


    it "sub account enrollment terms do not have associated grading periods" 
  ...
  context "post-fixup" do
    ...
    it "root account enrollment terms have grading periods after the fixup" 
