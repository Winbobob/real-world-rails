...
describe ApplicationHelper do
  describe '#app_assets_base_url' do
    ...
    describe 'with asset_host (SaaS)' do
      it 'returns asset_host' 


      it 'returns asset_host and adds the protocol if needed' 
    ...
    describe 'without asset_host' do
      ...
      it 'with subdomainful urls (OSS/dev) returns a subdomain' 


      it 'with subdomainless urls (onpremise) returns the domain' 
