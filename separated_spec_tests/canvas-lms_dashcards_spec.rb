...
describe 'dashcards' do
  ...
  context 'as a student' do
    ...
    context "dashcard color picker" do
      ...
      it 'should initially focus the nickname input' 
      ...
      it 'sets course nickname' 


      it 'sets course nickname when enter is pressed' 


      it 'sets both dashcard color and course nickname at once' 
