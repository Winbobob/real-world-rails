...
describe AccountsController do
  ...
  describe "courses" do
    ...
    describe "check crosslisting" do
      ...
      it "if crosslisted a section to another account's course, don't show that other course" 


      it "if crosslisted a section to this account, do *not* show other account's course" 


      it "if crosslisted a section to another account, do show other if that param is not set" 


      it "if crosslisted a section to this account, do *not* show other account's course even if param is not set" 

    end

    # Check that both published and un-published courses have the correct count
    it "should count course's student enrollments" 



    it "should list student counts in unclaimed courses" 


    it "should not list rejected teachers" 


    it "should sort courses as specified" 


    it 'can search and sort simultaneously' 
