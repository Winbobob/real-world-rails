...
describe Echo::ClientMiddleware::Echo10CollectionMiddleware do
  ...
  context 'when given parsed Echo10 collection data' do
    ...
    it 'updates the parsed body to contain a list of collections' 


  end

  it 'does not operate on response strings' 


  it 'does not operate on hashes containing parsed Atom granule data' 
