...
describe "Survey questionnaire tests for instructor interface" do
  ...
  it "is able to create a survey" 


  it "is able to deploy a survey with valid dates" 


  it "is not able to deploy a survey with invalid dates" 


  it "is able to view statistics of a survey" 
