...
describe "Jira", :js do
  ...
  shared_examples "correct references" do
    ...
    it "creates a link to the referenced issue on the preview" 


    it "creates a link to the referenced issue after submit" 


    it "creates a note on the referenced issues" 
