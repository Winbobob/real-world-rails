...
describe "/gradebooks/gradebook" do
  ...
  it "should enable grade publishing when appropriate" 


  it "should disable grade publishing when the course disallows it" 


  it "should disable grade publishing when permissions disallow it" 
  ...
  describe "uploading scores" do
    ...
    it "should allow uploading scores for courses" 


    it "should not allow uploading scores for large roster courses" 
