...
describe 'Merge request > User posts diff notes', :js do
  ...
  context 'when hovering over a parallel view diff file' do
    ...
    context 'with an old line on the left and no line on the right' do
      it 'allows commenting on the left side' 


      it 'does not allow commenting on the right side' 

    end

    context 'with no line on the left and a new line on the right' do
      it 'does not allow commenting on the left side' 


      it 'allows commenting on the right side' 
  ...
  context 'when cancelling the comment addition' do
    ...
    context 'with a new line' do
      it 'allows dismissing a comment' 
