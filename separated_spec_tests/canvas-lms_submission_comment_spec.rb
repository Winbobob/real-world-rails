...
describe Api::V1::SubmissionComment do
  ...
  describe "#submission_comment_json" do
    it "includes the 'edited_at' key" 


    it "'edited_at' is set if the submission comment has been edited" 


    it "'edited_at' is nil if the submission comment has not been edited" 
