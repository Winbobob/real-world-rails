...
describe Time do
  ...
  it 'displays unsmoothed time remaining when progress has been made' 
  ...
  it 'displays smoothed estimated time after progress has been made' 
  ...
  it 'displays unknown elapsed time when the timer has not been started' 


  it 'displays elapsed time when the timer has just been started' 


  it 'displays elapsed time if it was previously started' 


  it 'displays elapsed time frozen to a specific time if it was previously stopped' 


  it 'displays unknown elapsed time after reset has been called' 


  it 'raises an exception when an invalid out of bounds time format is specified' 
