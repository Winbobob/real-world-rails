  ...
  describe 'state_machine' do
    ...
    context 'transitions' do
      shared_examples 'valid project transaction flow' do |transition_to|
        ...
        it "should turn current_state to #{transition_to}" 


        it 'should persist the current_status into project.state' 


        it 'should create an most recent transition to_locale' 
      ...
      shared_examples 'invalid project transaction flow' do |transition_to|
        ...
        it "should not turn current_state to #{transition_to}" 


        it "should not turn project.state to #{transition_to}" 


        it 'should not create an most recent transition to_locale' 
      ...
      context 'rejected can go to draft, deleted only' do
        ...
        %i[online successful waiting_funds].each do |state|
          it "can't transition from draft to #{state}" 
        ...
        context 'when project_state is waiting_funds' do
          ...
          context "can't go to waiting_funds" do
            ...
            context 'when project have pending contributions' do
              ...
              it 'should be false but remains on waiting_funds' 
