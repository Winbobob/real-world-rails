...
describe WorkPackages::BulkController, type: :controller do
  ...
  describe '#update' do
    ...
    context 'when updating two work packages with differing whitelisted params' do
      ...
      it 'updates the description if whitelisted' 


      it 'updates the watchers if the watcher user ids are whitelisted' 


      it 'does not update the watchers if the watcher user ids are not whitelisted' 
