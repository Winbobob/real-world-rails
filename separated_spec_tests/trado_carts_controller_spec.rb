...
describe CartsController, broken: true do
    ...
    describe 'GET #mycart' do
        ...
        it "should render the mycart template" 


        it "should assign the calculated cart values to @cart_totals" 
    ...
    describe 'GET #checkout' do
        ...
        context "if the cart delivery_id attribute and order delivery address record are both nil" do
            ...
            it "should assign nil to @delivery_services" 

        end

        context "if the cart delivery_id attribute or order delivery address record are not nil" do

            it "should assign the available delivery service prices to @delivery_services" 

        end

        context "if the cart has no associated order" do

            it "should assign a new order record to @order" 


            it "should assign the carts delivery_id attribute value to @cart_session[:delivery_id]" 
        ...
        context "if the cart has an associated order" do
            ...
            it "should assign the order delivery_id attribute value to @cart_session[:delivery_id]" 
