  ...
  describe '#call' do
    context 'when moving' do
      ...
      context 'the project the work package is moved to' do
        ...
        it 'will not move if the user does not have the permission' 
      ...
      describe '#type' do
        ...
        it 'is false if the current type is not defined for the new project' 
    ...
    describe 'when copying' do
      ...
      describe 'to a different project' do
        ...
        context 'required custom field in the target project' do
          ...
          it 'does not copy the work package' 
