...
feature 'Cycle Analytics', :js do
  ...
  context 'as an allowed user' do
    context 'when project is new' do
      ...
      it 'shows introductory message' 


      it 'shows pipeline summary' 


      it 'shows active stage with empty message' 
    ...
    context "when my preferred language is Spanish" do
      ...
      it 'shows the content in Spanish' 


      it 'resets the language to English' 
  ...
  context "as a guest" do
    ...
    it 'needs permissions to see restricted stages' 
