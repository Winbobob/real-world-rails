xdescribe "Team Creation" do
  ...
  describe 'one student who signup for a topic should send an inviatation to the other student who has no topic' do
    ...
    it 'is able to accept the invitation and form team' 


    it 'is not able to form team on rejecting' 
  ...
  describe 'one student who has a topic sends an invitation to other student who also has a topic' do
    ...
    it 'Student should aceept the invitation sent by the other student and both have topics' 


    it 'student should reject the invitation sent by the other student and both gave topics' 
  ...
  describe 'one student should send an invitation to other student and both does not have topics' do
    ...
    it 'Student should accept other students invitation and both does not have a topic' 


    it "Student should reject the other students invitaton and both dont have a topic" 
  ...
  describe 'one student should send an invitation to other student who has a topic signed up for' do
    ...
    it 'Student should accept the invitation sent by other student who has a topic' 


    it "Student should reject the inviattion sent by the other student who has a topic" 
