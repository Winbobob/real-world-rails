...
describe 'sysctl::common' do
  ...
  describe 'when using with to specify a hash of parameters' do
    it 'should fail if the parameter is not contained in the resource' 

    it 'should pass if the parameters are contained in the resource' 

  end
  describe 'when using without to specify parameter name(s)' do
    it 'should pass if the parameter name is not contained in the resource' 

    it 'should pass if the parameter names are not contained in the resource' 

    it 'should fail if any of the parameter names are contained in the resource' 

  end
  describe 'when using without to specify parameter value(s)' do
    it 'should pass if the parameter value is not contained in the resource' 

    it 'should fail if the parameter value is contained in the resource' 
...
describe 'sysctl::common' do
  ...
  it 'should fail if not enough parameters are contained in the resource' 

  it 'should fail if different parameters are contained in the resource' 
