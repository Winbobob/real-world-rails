...
describe "scheduler" do
  ...
  context "as a teacher" do
    ...
    it "should bring up 'edit appointment group' modal when clicking 'create an appointment group' scheduler button" 


    it "should not enforce minimum event lengths when loading appointment times into the edit group form" 
    ...
    it "should require at least one time slot" 


    it "should allow checkboxes in the options section to be edited" 
    ...
    it "should use the correct context for messages sent through scheduler" 
    ...
    it "should allow removing individual appointment groups" 
    ...
    it "should allow me to override the participant limit on a slot-by-slot basis" 
