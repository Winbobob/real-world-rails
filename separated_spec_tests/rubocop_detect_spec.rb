...
RSpec.describe RuboCop::Cop::Performance::Detect do
  ...
  select_methods.each do |method|
    it "registers an offense when first is called on #{method}" 


    it "doesn't register an offense when first(n) is called on #{method}" 


    it "registers an offense when last is called on #{method}" 


    it "doesn't register an offense when last(n) is called on #{method}" 


    it "registers an offense when first is called on multiline #{method}" 


    it "registers an offense when last is called on multiline #{method}" 


    it "registers an offense when first is called on #{method} short syntax" 


    it "registers an offense when last is called on #{method} short syntax" 
  ...
  it 'does not register an offense when detect is used' 
  ...
  context 'autocorrect' do
    shared_examples 'detect_autocorrect' do |preferred_method|
      context "with #{preferred_method}" do
        ...
        select_methods.each do |method|
          it "corrects #{method}.first to #{preferred_method} (with block)" 
          ...
          it "corrects #{method}.first to #{preferred_method} (short syntax)" 
          ...
          it "corrects #{method}.first to #{preferred_method} (multiline)" 
  ...
  context 'SafeMode true' do
    ...
    select_methods.each do |method|
      it "doesn't register an offense when first is called on #{method}" 
