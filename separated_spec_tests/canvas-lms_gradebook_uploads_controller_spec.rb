...
describe GradebookUploadsController do
  ...
  describe "POST 'create'" do
    ...
    context "with authorized teacher" do
      ...
      it "puts the uploaded data into a durable attachment so it's recoverable" 
      ...
      context "and final grade column" do
        ...
        it "should accept a valid csv upload with a final grade column" 


        it "should accept a valid csv upload with sis id columns" 
  ...
  describe "GET 'data'" do
    ...
    it "retrieves an uploaded gradebook" 


    it "destroys an uploaded gradebook after retrieval" 
