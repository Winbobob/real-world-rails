...
describe EventCreateService do
  ...
  describe '#push', :clean_gitlab_redis_shared_state do
    ...
    it 'creates the push event payload' 


    it 'updates user last activity' 


    it 'caches the last push event for the user' 


    it 'does not create any event data when an error is raised' 
