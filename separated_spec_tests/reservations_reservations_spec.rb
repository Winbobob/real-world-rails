...
describe 'Reservations', type: :feature do
  ...
  context 'banned equipment processing' do
    ...
    shared_examples 'can handle banned user reservation transactions' do
      ...
      it 'cannot checkout successfully' 
  ...
  context 'equipment processing' do
    ...
    shared_examples 'can handle reservation transactions' do
      it 'checks out and checks in successfully' 


      it 'does not update equipment items for missing ToS checkbox' 


      it 'does not update equipment items for duplicate items' 

    end

    context 'as guest' do
      it 'should redirect to the catalog page' 
    ...
    context 'ToS checkbox' do
      ...
      shared_examples 'can utilize the ToS checkbox' do
        ...
        it 'fails when the box isn\'t checked off' 


        it 'succeeds when the box is checked off' 
  ...
  context 'renewing reservations' do
    ...
    context 'as superuser' do
      ...
      it 'can see renew button when disabled' 
  ...
  context 'accessing /reservation/new path with empty cart' do
    ...
    after(:each) { sign_out }
    it 'handles direct url' 

    it 'handles pressing reserve button' 
