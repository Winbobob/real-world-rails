...
STR
  ...
  describe ".backport_mention_syntax" do
    it "replaces the new syntax with the old syntax" 


    it "replaces the new syntax with the old syntax for immediately consecutive mentions" 


    it "removes curly braces from name of the mentioned person when adding it" 


    it "does not change the text, when the mention includes a name" 


    it "does not change the text, when the person is not found" 


    it "does not change the text, when the diaspora ID is invalid" 
