...
describe DialogImportService do
  ...
  describe "#cancel_import" do
    ...
    it "destroys the import file upload" 


    it "destroys the queued deletion" 
  ...
  describe "#import_from_file" do
    ...
    context "when the loaded yaml returns dialogs" do
      ...
      context "when there is an existing dialog" do
        ...
        it "does not create a third dialog" 
      ...
      context "when there is not an existing dialog" do
        it "builds a new dialog" 


        it "builds a dialog tab associated to the dialog" 


        it "builds a dialog group associated to the dialog tab" 


        it "imports the dialog fields" 
    ...
    context "when the loaded yaml does not return dialogs" do
      ...
      it "raises a ParsedNonDialogYamlError" 
  ...
  describe "#import_all_service_dialogs_from_yaml_file" do
    ...
    context "when there is already an existing dialog" do
      ...
      it "overwrites the existing dialog" 
    ...
    context "when there are no existing dialogs" do
      ...
      it "sets only new associations when both new and old style exist" 
  ...
  describe "association creation" do
    context "with only old defunct associations present" do
      ...
      it "sets only old associations when only old style exists" 
  ...
  describe "#import_service_dialogs" do
    ...
    shared_examples_for "DialogImportService#import_service_dialogs that destroys temporary data" do
      ...
      it "unqueues the miq_queue item" 
  ...
  describe "#store_for_import" do
    ...
    context "when the imported file does not raise any errors while determining validity" do
      ...
      it "returns the imported file upload" 


      it "queues a deletion" 
    ...
    context "when the imported file raises an error while determining validity" do
      ...
      it "reraises with the original error" 
    ...
    describe '#build_dialog_fields' do
      ...
      it 'creates a new dialog_field' 


      it 'symbolizes the dialog field options' 
  ...
  context '#import' do
    ...
    it 'creates a new dialog with valid input' 


    it "creates field associations" 


    it 'will raise record invalid for invalid dialog' 
  ...
  describe "#build_associations" do
    ...
    it "creates dialog field associations" 
  ...
  describe "#build_association_list" do
    ...
    it "creates an association list of ids based on names" 


    it "association list doesn't include empty arrays" 
