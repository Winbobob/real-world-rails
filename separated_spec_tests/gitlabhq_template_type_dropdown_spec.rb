...
describe 'Projects > Files > Template type dropdown selector', :js do
  ...
  context 'editing a non-matching file' do
    ...
    it 'selects every template type correctly' 


    it 'updates toggle value when input matches' 
  ...
  context 'editing a matching file' do
    ...
    it 'is displayed when input matches' 
    ...
    context 'user previews changes' do
      ...
      it 'type selector is hidden and shown correctly' 
  ...
  context 'creating a matching file' do
    ...
    it 'toggle is set to the correct value' 
  ...
  context 'creating a file' do
    ...
    it 'type selector is shown' 


    it 'toggle is set to the proper value' 
