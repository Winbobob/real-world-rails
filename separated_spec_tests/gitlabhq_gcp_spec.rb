...
feature 'Gcp Cluster', :js do
    ...
    context 'when user has a GCP project with billing enabled' do
      ...
      context 'when user does not have a cluster and visits cluster index page' do
        ...
        context 'when user filled form with valid parameters' do
          ...
          it 'user sees a cluster details page and creation status' 


          it 'user sees a error if something worng during creation' 
  ...
  context 'when user has not dismissed GCP signup offer' do
    ...
    it 'user sees offer on cluster index page' 


    it 'user sees offer on cluster create page' 


    it 'user sees offer on cluster GCP login page' 
  ...
  context 'when user has dismissed GCP signup offer' do
    ...
    it 'user does not see offer after dismissing' 
