...
describe "dashboard" do
  ...
  context "as a student" do
    ...
    it "should not show announcement stream items without permissions" 
    ...
    it "should interpolate the user's domain in global notifications" 


    it "should interpolate the user's id in global notifications" 
  ...
  context "as a teacher" do
    ...
    context "restricted future courses" do
      ...
      it "should show future courses (even if restricted) to students on courses page" 


      it "should not show restricted future courses to students on courses page if configured on account" 
