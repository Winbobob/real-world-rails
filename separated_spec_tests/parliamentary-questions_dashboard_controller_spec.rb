...
describe DashboardController, type: :controller do
  ...
  context 'dashboard sorting' do
    ...
    describe 'GET index' do
      it 'should sort the new questions by date and state weight' 

    end


    describe 'GET in_progress' do
      it 'should sort the in-progress questions by date and state weight and return them all' 

    end

    describe 'GET backlog' do
      it 'should sort the Backlog questions by date and state weight and return them all' 

    end

    describe 'GET by_status' do
      it 'should return all questions in unassigned status sorted for dashboard order' 
