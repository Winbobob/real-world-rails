...
RSpec.describe FetchCountryRegisterJob, type: :job do
  ...
  context "when a country does not exist" do
    ...
    describe "attribute assignment" do
      ...
      it "assigns 'country' to Location#code" 


      it "assigns 'name' to Location#name" 


      it "assigns 'start-date' to Location#start_date" 


      it "assigns 'end-date' to Location#end_date" 
  ...
  context "when a country does exist" do
    ...
    describe "attribute assignment" do
      ...
      it "updates Location#start_date" 


      it "updates Location#end_date" 
  ...
  context "when a country does not change" do
    ...
    it "doesn't update an existing record" 
