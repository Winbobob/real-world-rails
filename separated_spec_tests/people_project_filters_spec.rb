...
describe 'Project dashboard filters', js: true do
  ...
  describe 'roles filter' do
    it 'shows all projects when empty string provided' 


    it 'shows only matched projects when role is provided' 

  end

  describe 'users filter' do
    it 'returns only matched projects when user name provided' 


    it 'returns all projects when no selectize provided' 
