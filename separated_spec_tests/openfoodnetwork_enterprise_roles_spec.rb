...
feature %q{
  ...
  context "as a site administrator" do
    ...
    describe "using the enterprise managers interface" do
      ...
      it "lists managers and shows icons for owner, contact, and email confirmation" 


      it "allows adding new managers" 


      it "shows changes to enterprise contact or owner" 


      it "can invite unregistered users to be managers" 
