...
describe Carto::VisualizationsExportService2 do
  ...
  describe 'importing' do
    ...
    it 'imports synchronization with missing log' 
  ...
  describe 'exporting + importing' do
    ...
    describe 'maps' do
      ...
      describe 'if full_restore is' do
        ...
        it 'false, it should generate a random uuid and blank permission and no mapcap' 


        it 'true, it should keep the imported uuid, permission and mapcap' 
