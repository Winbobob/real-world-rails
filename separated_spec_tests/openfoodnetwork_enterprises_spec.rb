...
feature %q{
  ...
  describe "producer properties" do
    it "creates producer properties" 


    it "updates producer properties" 
  ...
  describe "inventory settings", js: true do
    ...
    it "refreshes the cache when I change what products appear on my shopfront" 
  ...
  context "as an Enterprise user", js: true do
    ...
    context "when I have reached my enterprise ownership limit" do
      it "shows a 'limit reached' modal message when trying to create a new enterprise" 
    ...
    describe "enterprises I have edit permission for, but do not manage" do
      it "allows me to edit them" 


      it "does not show links to manage shipping methods, payment methods or enterprise fees on the edit page" 
