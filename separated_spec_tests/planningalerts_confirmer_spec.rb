  ...
  context "alert" do
    ...
    context "default theme" do
      ...
      describe "confirm" do
        ...
        it "should come from the planningalerts' normal email" 


        it "should go to the alert's email address" 


        it "should tell the person what the email is about" 
    ...
    context "nsw theme" do
      ...
      describe "confirm" do
        ...
        it "should come from the nsw planningalerts' normal email" 
  ...
  context "comment" do
    ...
    context "default theme" do
      ...
      describe "confirm" do
        ...
        it "should go to the comment's email address" 
