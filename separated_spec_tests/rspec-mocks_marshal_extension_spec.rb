RSpec.describe Marshal, 'extensions' do
  ...
  describe '#dump' do
    context 'when rspec-mocks has been fully initialized' do
      ...
      it 'duplicates objects with stubbed or mocked implementations before serialization' 


      it 'does not duplicate other objects before serialization' 


      it 'does not duplicate nil before serialization' 
    ...
    context 'outside the per-test lifecycle' do
      ...
      it 'does not duplicate the object before serialization' 
