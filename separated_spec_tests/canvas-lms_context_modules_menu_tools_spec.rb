...
describe "context modules" do
  ...
  context "menu tools", priority: "1" do
      ...
      it "should show tool launch links in the gear for modules" 


      it "should show tool launch links in the gear for modules on course home if set to modules" 


      it "should not render tool links unless the lor flag is enabled" 


      it "should show tool launch links in the gear for exportable module items" 


      it "should add links to newly created modules" 


      it "should add links to newly created module items" 


      it "should not show add links to newly created module items if not exportable" 
