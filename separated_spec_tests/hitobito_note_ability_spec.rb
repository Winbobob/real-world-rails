...
describe NoteAbility do
  ...
  context :layer_and_below_full do
    ...
    it 'may create and destroy note in his layer' 


    it 'may create and destroy note in bottom layer' 
  ...
  context 'layer_and_below_full in bottom layer' do
    ...
    it 'may not create and destroy note in top layer' 
  ...
  context :layer_full do
    ...
    it 'may not create or delete note in bottom layer' 
  ...
  context 'layer_full in bottom layer' do
    ...
    it 'may create or delete note in his layer' 


    it 'may not create or delete note in upper layer' 
  ...
  context :group_and_below_read do
    ...
    it 'may not create or delete note in his layer' 
