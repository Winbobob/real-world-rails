...
describe SupportHelpers::Crocodoc::CrocodocFixer do
  ...
  describe "#resubmit_attachment" do
    it 'resubmits the attachment to crocodoc' 

  end

  describe "ShardFixer" do
    it 'resubmits crocodocs in an error state' 

  end

  describe "SubmissionFixer" do
    it 'resubmits crodocodcs for a given assignment and user' 


    it 'does not resubmit processing crodocodcs' 


    it 'resubmits processing crodocodcs if stuck for more than a day' 
