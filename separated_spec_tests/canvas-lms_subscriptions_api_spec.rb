...
module Lti
  describe 'Webhook Subscription API', type: :request do
    ...
    describe '#create' do
      ...
      it 'checks that the tool proxy has the correct enabled capabilities' 


      it 'gives error message when missing capabilities' 


      it 'renders 401 if Lti::ToolProxy#active_in_context? does not return true' 


      it 'gives error message if Lti::ToolProxy#active_in_context? does not return true' 


      it 'requires JWT Access token' 


      it 'gives 500 if the subscription service is not configured' 


      it 'gives useful message if the subscription service is not configured' 
    ...
    describe '#destroy' do
      ...
      it 'gives 404 if subscription does not exist' 
    ...
    describe '#show' do
      ...
      it 'gives gives 404 if subscription does not exist' 
    ...
    describe '#index' do
      ...
      it 'shows subscriptions for a tool proxy' 


      it 'shows subscriptions for a tool proxy from a pagination response' 


      it 'includes pagination headers' 


      it 'shows subscriptions for a tool proxy with optional pagination header' 
