...
describe Invoice::BatchUpdate do
  ...
  it 'tracks error if invoice cannot be issued because no invoice_item is present' 


  it 'tracks error if invoice cannot be sent because no invoice_item is present' 


  it 'tracks error if no reminder can be issued because config is missing' 
