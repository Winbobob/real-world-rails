...
describe "announcements" do
  ...
  context "announcements as a teacher" do
    ...
    it "should allow saving of section announcement", test_id:3469728, priority: "1" 


    it "should not allow empty sections", test_id:3469730, priority: "1" 


    it "should not show the allow comments checkbox if globally disabled" 


    it "should show the comments checkbox if not globally disabled" 
    ...
    context "section specific announcements" do
      ...
      it "should be visible to teacher in course" 
    ...
    it "displayed delayed post note on page of delayed announcement" 
