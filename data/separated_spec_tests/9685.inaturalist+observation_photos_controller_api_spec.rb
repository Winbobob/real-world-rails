...
shared_examples_for "an ObservationPhotosController" do
  ...
  describe "create" do
    ...
    describe "observation" do
      ...
      it "should change quality_grade from casual to needs_id" 


      it "should change quality_grade in the observations index" 
  ...
  describe "destroy" do
    ...
    it "should return 403 Forbidden if user doesn't own the observation" 
