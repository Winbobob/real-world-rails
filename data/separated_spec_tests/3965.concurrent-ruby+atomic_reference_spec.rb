...
module Concurrent
  ...
  RSpec.describe AtomicReference do
    if Concurrent.on_jruby?
      it 'inherits from JavaAtomicReference' 

    elsif Concurrent.allow_c_extensions?
      it 'inherits from CAtomicReference' 

    elsif Concurrent.on_rbx?
      it 'inherits from RbxAtomicReference' 

    elsif Concurrent.on_truffleruby?
      it 'inherits from TruffleRubyAtomicReference' 

    else
      it 'inherits from MutexAtomicReference' 
