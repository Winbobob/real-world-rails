...
RSpec.describe "public_activity/study/_erb_status_id_changed.html.erb",
  ...
  context "when the erb status is bad" do
    ...
    it "is given negative styling" 

  end

  it "Sets the title from the status" 


  it "Sets the description to say who updated it" 
