...
describe "mentioning", type: :request do
  ...
  it "only mentions people that are in the target aspect" 
  ...
  context "in private post via federation" do
    ...
    it "receiver is mentioned in status message" 


    it "receiver can see status message in streams" 


    it "non-receiver is not mentioned in status message" 


    it "non-receiver can't see status message in streams" 
  ...
  context "in private post via federation with multiple recipients" do
    ...
    it "mentions all recipients in the status message" 


    it "all recipients can see status message in streams" 

  end

  it "mentions people in public posts" 


  it "mentions people that are in the target aspect" 
  ...
  context "in comments" do
    ...
    context "with public post" do
      ...
      context "when comment is received via federation" do
        context "when mentioned user is remote" do
          it "relays the comment to the mentioned user" 
    ...
    context "with private post" do
      ...
      context "when comment is received via federation" do
        ...
        it "mentions all the recepients" 
        ...
        context "with only post author mentioned" do
          ...
          it "makes only one notification for each recipient" 
      ...
      it "only creates one notification for the mentioned person, when mentioned person commented twice before" 
