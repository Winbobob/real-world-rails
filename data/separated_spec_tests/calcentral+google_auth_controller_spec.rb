describe GoogleAuthController do
  ...
  describe 'Google transaction' do
    ...
    describe '#refresh_tokens' do
      ...
      context 'user can refresh Google OAuth tokens' do
        ...
        context 'omit domain restriction' do
          ...
          it 'should redirect to Google with ' 
    ...
    describe '#process_callback' do
      context 'handle Google callback' do
        ...
        it 'should record new client_id and client_secret' 
  ...
  describe '#error' do
    context 'Google reports an error' do
      ...
      it 'should not record client_id and client_secret' 

    end
  end

  describe '#dismiss_reminder' do
    it 'should store a dismiss_reminder key-value when there is no token for a user' 


    it 'should not store a dismiss_reminder key-value when there is an existing token' 
  ...
  describe '#current_scope' do
    ...
    context 'access granted' do
      ...
      it 'should return scope information' 
  ...
  describe '#remove_authorization' do
    ...
    it 'should delete all tokens, everywhere' 
