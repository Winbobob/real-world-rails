...
describe Admin::ContentController, type: :controller do
  ...
  describe '#create' do
    shared_examples_for 'create action' do
      ...
      it 'should send notifications on create' 


      it 'should create an article with tags' 


      it 'should create an article with a unique Tag instance named lang:FR' 


      it 'should correctly interpret time zone in :published_at' 


      it 'should respect "GMT+0000 (UTC)" in :published_at' 


      it 'should create a filtered article' 
  ...
  describe '#update' do
    context 'as an admin' do
      ...
      it 'should allow updating body_and_extended' 
  ...
  describe '#auto_complete_for_article_keywords' do
    ...
    it 'should return foo for keywords fo' 
