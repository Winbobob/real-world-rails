...
RSpec.describe RuboCop::Cop::Performance::StartWith do
  ...
  shared_examples 'different match methods' do |method|
    ...
    %w[. * ? $ ^ |].each do |str|
      ...
      it "doesn't register an error for #{method} /\\A#{str}/" 
    ...
    it "formats the error message correctly for #{method} /\\Aabc/" 
