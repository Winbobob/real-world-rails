...
describe SafeYAML::Store do
  ...
  it 'should be a YAML::Store' 


  it 'should be a SafeYAML::Store' 


  it 'should use SafeYAML.load instead of YAML.load' 


  it 'preserves default SafeYAML behavior' 
  ...
  describe 'with options' do
    ...
    it 'should accept options for SafeYAML.load' 
