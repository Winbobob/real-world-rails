...
describe ::API::V3::WorkPackages::Schema::WorkPackageSchemaRepresenter do
  ...
  context 'generation' do
    ...
    describe '_type' do
      it 'is indicated as Schema' 

    end

    describe '_attributeGroups' do
      it 'renders form attribute group elements of the schema' 


      it 'renders form query group elements of the schema' 
  ...
  describe '#json_cache_key' do
    ...
    it 'changes when the project updates' 


    it 'changes when the type updates' 
    ...
    it 'changes when the custom_fields changes' 
