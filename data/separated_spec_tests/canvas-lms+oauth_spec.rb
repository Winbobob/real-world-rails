...
describe "oauth2 flow" do
  ...
  describe "oauth2 tool icons" do
    ...
    it "should show remember authorization checkbox only for 'auth/userinfo' scoped token requests" 


    it "should not show remember authorization checkbox for unscoped requests" 


    it "should not show remember authorization checkbox for other scope requests" 
