  ...
  describe 'GET #index' do
    context 'when the user is authenticated' do
      ...
      context 'as a user' do
        ...
        it 'assigns the search form' 


        it 'assigns the DwpMonitor state' 


        it "assigns last updated applications" 
  ...
  describe 'POST #completed_search' do
    ...
    context 'when reference parameter is present' do
      ...
      context 'when the search returns a url' do
        ...
        it 'redirects to the edit page for that application' 


        it 'does not assign the DwpMonitor state' 
  ...
  describe 'POST #online_search' do
    ...
    context 'when reference parameter is present' do
      ...
      context 'when an online application is found with that reference' do
        ...
        it 'redirects to the edit page for that online application' 
