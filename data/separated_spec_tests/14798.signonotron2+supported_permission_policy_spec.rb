...
describe SupportedPermissionPolicy do
  ...
  describe described_class::Scope do
    ...
    context 'for super organisation admins' do
      ...
      it 'contains all permissions for apps with delegatable signin permission that the super organisation admin has access to' 


      it 'does not contain any permissions for apps with non-delegatbale signin permission the super organisation admin has access to' 


      it 'does not contain any permissions for apps the super organisation admin does not have access to' 
    ...
    context 'for organisation admins' do
      ...
      it 'contains all permissions for apps with delegatable signin permission that the organisation admin has access to' 


      it 'does not contain any permissions for apps with non-delegatbale signin permission the organisation admin has access to' 


      it 'does not contain any permissions for apps the organisation admin does not have access to' 
