...
RSpec.describe RewardPolicy do
  ...
  shared_examples_for 'create permissions' do
    ...
    it 'should deny access if user is not project owner' 


    it 'should permit access if user is project owner' 
  ...
  shared_examples_for 'destroy permissions' do
    ...
    it 'should deny access if reward has one contribution waiting for confirmation' 


    it 'should deny access if reward has one confirmed contribution' 
