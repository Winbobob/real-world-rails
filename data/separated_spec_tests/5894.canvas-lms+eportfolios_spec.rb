...
describe "eportfolios" do
  ...
  context "eportfolio created with user" do
    ...
    it "should not have new section option when adding submission" 
    ...
    it "should click on all wizard options and validate the text" 


    it "should be viewable with a shared link" 
...
describe "eportfolios file upload" do
  ...
  it "should upload a file to the main page" 


  it "should upload a file to an eportfolio section" 


  it "should upload a file to an eportfolio page" 
