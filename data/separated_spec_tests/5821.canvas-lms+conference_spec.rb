...
describe 'Web conferences' do
  ...
  context 'when one conference exists' do
    ...
    context 'when the conference is open' do
      ...
      it 'should set focus to the Add Conference button if there are no preceeding conferences', priority: "2" 


      it 'should set focus to the cog menu if the delete was cancelled', priority: "2" 


      it 'should open editor if edit selected from cog menu', priority: "2" 
  ...
  context 'when two conferences exist' do
    ...
    it 'should set focus to the preceding conference\'s cog after deleting', priority: "2" 
