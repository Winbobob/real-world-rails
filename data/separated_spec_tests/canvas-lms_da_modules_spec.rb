...
describe "interaction with differentiated assignments/quizzes/discusssions in modules" do
  ...
  context "Student" do
    ...
    it "should not show inaccessible module items" 

    it "should display module items with overrides" 

    it "should show module items with graded submissions" 

    it "should ignore completion requirements of inaccessible module items" 
  ...
  context "Observer" do
    ...
    context "without a student attached" do
      ...
      it "should display all module items" 
