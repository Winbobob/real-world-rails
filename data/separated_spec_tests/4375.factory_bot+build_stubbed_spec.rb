...
describe "defaulting `created_at`" do
  ...
  it "doesn't add created_at to objects who don't have the method" 
  ...
  it "allows assignment of created_at" 
...
describe "defaulting `updated_at`" do
  ...
  it "doesn't add updated_at to objects who don't have the method" 
  ...
  it "allows assignment of updated_at" 
