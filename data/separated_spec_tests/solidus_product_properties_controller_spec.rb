    ...
    describe ProductPropertiesController, type: :controller do
      ...
      describe "#index" do
        ...
        context "no option values are provided" do
          ...
          it "instantiates a new variant property rule" 


          it "instantiates a new variant property rule value" 
        ...
        context "option values are provided" do
          ...
          context "a rule matches the option values" do
            ...
            it "assigns the property rule to the only property rule that matches the option values" 
