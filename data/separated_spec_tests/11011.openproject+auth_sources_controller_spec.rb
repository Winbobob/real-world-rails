...
describe AuthSourcesController, type: :controller do
  ...
  describe 'new' do
    ...
    it 'initializes a new AuthSource' 
  ...
  describe 'destroy' do
    ...
    context 'with users' do
      ...
      it 'doesn not destroy the AuthSource' 
  ...
  context 'with password login disabled' do
    ...
    it 'cannot find index' 


    it 'cannot find new' 


    it 'cannot find create' 


    it 'cannot find edit' 


    it 'cannot find update' 


    it 'cannot find destroy' 
