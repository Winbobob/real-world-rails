...
RSpec.describe Webui::PackageController, vcr: true do
  ...
  describe 'POST #submit_request' do
    ...
    context "sending a valid submit request with 'sourceupdate' parameter" do
      ...
      it 'creates a submit request with correct sourceupdate attibute' 
    ...
    context 'sending a submit request for an older submission' do
      ...
      it 'creates a submit request for the correct revision' 
  ...
  describe 'GET #meta' do
    ...
    it 'sends the xml representation of a package' 
  ...
  describe 'POST #branch' do
    ...
    it 'shows an error if source package does not exist' 


    it 'shows an error if source package parameter not provided' 


    it 'shows an error if source project does not exist' 


    it 'shows an error if user has no permissions for source project' 


    it 'shows an error if source project parameter not provided' 


    it "shows an error if current revision parameter is provided, but there wasn't any revision before" 
    ...
    context 'with target package name' do
      ...
      it 'redirects to the branched package' 
  ...
  describe 'POST #remove' do
    ...
    describe 'authentication' do
      ...
      it 'does not allow other users than the owner to delete a package' 


      it "allows admins to delete other user's packages" 
    ...
    context 'a package with dependencies' do
      ...
      it 'does not delete the package and shows an error message' 
  ...
  describe 'GET #binaries' do
    ...
    context 'with build results and binaries' do
      ...
      it "excludes the '_statistics' files from the binaries page" 


      it "lists all binaries returned as build result with a 'Download' link" 


      it 'does not show the details link for the rpmlint.log' 


      it "shows the name of each binary together with it's size" 


      it 'shows a cloud upload link for binaries that can be uploaded to the cloud' 
  ...
  describe 'POST #save_file' do
    RSpec.shared_examples 'tests for save_file action' do
      ...
      context 'with an invalid filename' do
        it 'fails with a backend error message' 
      ...
      context 'uploading a file from remote URL' do
        ...
        it 'creates a valid service file' 
  ...
  describe 'GET #show' do
    context 'require_package before_action' do
      context 'with an invalid package' do
        ...
        it 'redirects to project show path' 
  ...
  describe 'GET #revisions' do
    ...
    context 'with source access' do
      ...
      context 'when not passing the rev parameter' do
        ...
        it 'returns revisions with the default pagination' 
        ...
        context 'and passing the show_all parameter' do
          ...
          it 'returns revisions without pagination' 
        ...
        context 'and passing the page parameter' do
          ...
          it "returns the paginated revisions for the page parameter's value" 
      ...
      context 'when passing the rev parameter' do
        ...
        it "returns revisions up to rev parameter's value with the default pagination" 
        ...
        context 'and passing the show_all parameter' do
          ...
          it "returns revisions up to rev parameter's value without pagination" 
  ...
  describe 'POST #trigger_rebuild' do
    ...
    context 'when triggering a rebuild fails' do
      ...
      it 'lets the user know there was an error' 


      it 'redirects to the package binaries path' 
  ...
  describe 'POST #wipe_binaries' do
    ...
    context 'when wiping binaries fails' do
      ...
      it 'redirects to package binaries' 
