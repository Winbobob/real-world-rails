  ...
  describe '#execute' do
    ...
    context 'subgroups', :nested_groups do
      ...
      context 'without a user' do
        it 'only returns parent and public subgroups' 
      ...
      context 'with a user' do
        ...
        it 'returns parent, public, and internal subgroups' 


        context 'being member' do
          it 'returns parent, public subgroups, internal subgroups, and private subgroups user is member of' 
        ...
        context 'parent group private' do
          ...
          context 'authorized to private project' do
            context 'project one level deep' do
              ...
              it 'includes the subgroup of the project' 


              it 'does not include private subgroups deeper down' 
            ...
            context 'project two levels deep' do
              ...
              it 'returns all the ancestor groups' 


              it 'returns the groups for a given parent' 
