...
describe CoursesController do
  describe "GET 'index'" do
    ...
    describe 'future_enrollments' do
      ...
      it "should not include published course enrollments if account disallows future view and listing" 


      it "should not include unpublished course enrollments if account disallows future listing" 
