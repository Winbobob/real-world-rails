...
RSpec.describe RuboCop::Cop::Naming::VariableNumber, :config do
  ...
  shared_examples :offense do |style, variable, style_to_allow_offenses|
    it "registers an offense for #{Array(variable).first} in #{style}" 

  end

  shared_examples :accepts do |style, variable|
    it "accepts #{variable} in #{style}" 
  ...
  context 'when configured for snake_case' do
    ...
    it 'registers an offense for normal case numbering in method parameter' 
  ...
  context 'when configured for normal' do
    ...
    it 'registers an offense for snake case numbering in method parameter' 
