...
describe Jobs::UserEmail do
  ...
  context "disable_emails setting" do
    ...
    it "does not send an email when yes" 


    it "sends when critical" 
  ...
  context "email_log" do
    ...
    it "creates a skipped email log when the mail is skipped" 
  ...
  context 'args' do
    ...
    context 'notification' do
      ...
      it "erodes bounce score each time an email is sent" 
