...
RSpec.describe "bundle show" do
  context "with a standard Gemfile" do
    ...
    it "prints path if gem exists in bundle", :bundler => "< 2" 


    it "prints path if gem exists in bundle", :bundler => "2" 


    it "prints path if gem exists in bundle (with --paths option)", :bundler => "< 2" 
    ...
    it "prints the path to the running bundler", :bundler => "< 2" 
    ...
    it "prints path of all gems in bundle sorted by name", :bundler => "< 2" 
