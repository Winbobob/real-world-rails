...
describe UserSpamScorer do
  ...
  describe '.spam_name_formats' do
    ...
    it 'sets a default spam_name_formats value' 


    it 'sets a custom spam_name_formats value' 
  ...
  describe '.spam_about_me_formats' do
    ...
    it 'sets a default spam_about_me_formats value' 


    it 'sets a custom spam_about_me_formats value' 
  ...
  describe '#name_is_spam_format?' do
    ...
    it 'is true if the name matches a spammy format' 


    it 'is false if the name is not a spammy format' 


    context 'the default spam formats' do

      it 'is true if it matches bitcoin' 


      it 'is true if it matches currency' 


      it 'is true if it matches support' 


      it 'is true if it matches customer service' 


      it 'is true if it matches customer care' 


      it 'is true if it matches buy online' 


      it 'is true if it matches real estate' 


      it 'is true if it matches web design' 


      it 'is true if it matches mac desktop' 


      it 'is true if it matches Inc' 


      it 'is true if it matches LLC' 


      it 'is true if it matches spyware' 


      it 'is true if it matches malware' 


      it 'is true if it matches CRM' 
  ...
  describe '#user_agent_is_suspicious?' do
    ...
    it 'is true if the user agent matches' 


    it 'is false if the user agent does not match' 


    it 'is false if the user does not have a user agent' 
  ...
  describe '#ip_range_is_suspicious?' do
    ...
    it 'is true if the IP address is within a suspicious range' 


    it 'is false if the IP address is not within a suspicious range' 


    it 'is false if the user does not have a IP address' 
