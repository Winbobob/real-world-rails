...
describe Carto::OrganizationMetadataExportService do
  ...
  describe '#organization export' do
    ...
    it 'exports notifications and received notifications' 
  ...
  describe '#organization import' do
    ...
    it 'imports 1.0.1 (without connector configurations)' 


    it 'imports 1.0.0 (without password expiration)' 

  end

  describe '#full export + import (organization, users and visualizations)' do
    it 'export + import organization, users and visualizations' 
