...
describe Carto::Api::MapcapsController do
  ...
  describe '#create' do
    ...
    it 'creates new mapcap' 


    it 'should only allow MAX_MAPCAPS_PER_VISUALIZATION mapcaps' 


    it 'returns 403 if user does not own the visualization' 


    it 'triggers autoindex regeneration' 


    it 'triggers autoindex regeneration for torque layers' 
  ...
  describe '#show' do
    ...
    it 'returns 404 for an inexistent mapcap' 
