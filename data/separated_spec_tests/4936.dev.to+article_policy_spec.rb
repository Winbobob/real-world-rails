...
RSpec.describe ArticlePolicy do
  ...
  context "when trying to view analytics with proper permissions" do
    ...
    it "allows all users to view analytics" 
  ...
  context "when a user with analytics tries to view someone else's article" do
    ...
    it "forbids the first user from viewing the other user's analytics via their article" 


    it "forbids the other user from viewing the first user's analytics" 


    it "forbids them from viewing another person's analytics even if their article is first" 
