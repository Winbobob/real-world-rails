...
describe Redmine::AccessControl do
  describe '.remove_modules_permissions' do
    ...
    it 'removes from global permissions' 


    it 'removes from public permissions' 


    it 'removes from members only permissions' 


    it 'removes from loggedin only permissions' 


    it 'should disable repository module' 
