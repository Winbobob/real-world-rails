...
RSpec.describe UsersController, type: :controller do
  ...
  describe 'GET reactivate' do
    ...
    context 'when token is nil' do
      ...
      it 'should not set deactivated_at to nil' 
    ...
    context 'when token is valid' do
      ...
      it 'should set deactivated_at to nil' 
  ...
  describe 'DELETE destroy' do
    context 'when user has published_projects' do
      ...
      it 'should not set deactivated_at' 
    ...
    context 'when user is beign deactivated by admin' do
      ...
      it 'should set deactivated_at' 


      it 'should not sign user out' 
  ...
  describe 'PUT update' do
    ...
    context 'with mail marteking attributes' do
      ...
      it "should in new list" 


      it "should be removed from list check for destroy" 
  ...
  describe 'GET show' do
    ...
    it 'should set referral session' 
