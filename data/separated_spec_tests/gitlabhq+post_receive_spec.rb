...
describe PostReceive do
  ...
  describe "#process_project_changes" do
    context 'empty changes' do
      it "does not call any PushService but runs after project hooks" 
    ...
    context 'with changes' do
      ...
      context "merge-requests" do
        ...
        it "does not call any of the services" 
  ...
  describe '#process_wiki_changes' do
    ...
    it 'updates project activity' 

  end

  context "webhook" do
    it "fetches the correct project" 


    it "does not run if the author is not in the project" 


    it "asks the project to trigger all hooks" 


    it "enqueues a UpdateMergeRequestsWorker job" 
