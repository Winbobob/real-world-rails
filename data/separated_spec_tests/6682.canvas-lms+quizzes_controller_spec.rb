  ...
  describe "PUT 'update'" do
    ...
    context 'post_to_sis' do
      ...
      context 'with required due dates' do
        ...
        it "saves with a due date" 


        it "fails to save without a due date" 
    ...
    it "can change a graded quiz with overrides into an ungraded quiz" 


    it 'should not remove attributes when called with no description param' 
    ...
    describe "DueDateCacher" do
      ...
      it "runs DueDateCacher when transitioning a 'created' quiz to 'edited'" 


      it "runs DueDateCacher when transitioning from ungraded quiz to graded" 
