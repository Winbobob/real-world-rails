...
describe ExternalToolsController, type: :request do
  ...
  describe "in a course" do
    ...
    it "should show an external tool" 


    it "should include allow_membership_service_access if feature flag enabled" 


    it "should return 404 for not found tool" 


    it "should return external tools" 


    it "should return filtered external tools" 


    it "should search for external tools by name" 


    it "should only find selectable tools" 


    it "should create an external tool" 


    it "should update an external tool" 


    it "should destroy an external tool" 


    it "should give errors for required properties that aren't included" 


    it "should give authorized response" 
    ...
    if Canvas.redis_enabled?
      ...
      describe 'sessionless launch' do
        ...
        it 'should allow sessionless launches by url' 


        it 'should allow sessionless launches by tool id' 


        it 'returns 401 if the user is not authorized for the course' 


        it "returns a service unavailable if redis isn't available" 
        ...
        context 'assessment launch' do
          ...
          it 'returns a bad request response if there is no assignment_id' 


          it 'returns a not found response if the assignment is not found in the class' 


          it "returns an unauthorized response if the user can't read the assignment" 


          it "returns a bad request if the assignment doesn't have an external_tool_tag" 


          it "returns a sessionless launch url" 


          it "returns sessionless launch URL when default URL is not set and placement URL is" 


          it "returns sessionless launch URL for an assignment launch no URL is set on the tool" 


          it "returns a json error if there is no matching tool" 


        end

        it "returns a bad request response if there is no tool_id or url" 

      end
    end

    describe "in a group" do
      it "should return course level external tools" 
  ...
  describe "in an account" do
    ...
    it "should give unauthorized response" 
    ...
    describe "in a group" do
      it "should return account level external tools" 
