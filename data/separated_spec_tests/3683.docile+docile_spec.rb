  ...
  describe ".dsl_eval" do
    ...
    context "when DSL blocks are nested" do
      ...
      context "identity of 'self' inside nested dsl blocks" do
        ...
        it "identifies self inside outer dsl block" 


        it "replaces self inside inner dsl block" 


        it "restores self to the outer dsl object after the inner dsl block" 
    ...
    context "when DSL context object is the same as the block's context object" do
      ...
      it "calls DSL methods and sets instance variables on the DSL context object" 
