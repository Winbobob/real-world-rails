...
describe SiteSettingExtension do
  ...
  it "Does not leak state cause changes are not linked" 
  ...
  describe "refresh!" do
    ...
    it "does not override types in the type supervisor" 
  ...
  describe ".set_and_log" do
    ...
    it "scrubs secret setting values from logs" 
  ...
  describe "shadowed_by_global" do
    ...
    context "default_locale" do
      it "supports adding a default locale via a global" 
  ...
  describe "secret" do
    ...
    it "is in the `secret_settings` collection" 


    it "can be retrieved" 


    it "is present in all_settings by default" 
