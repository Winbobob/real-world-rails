...
describe "Wiki pages and Tiny WYSIWYG editor features" do
  ...
  context "WYSIWYG generic as a teacher" do
    ...
    it "should not load mathjax if no mathml" 


    it "should load mathjax if mathml" 


    it "should not load mathjax if displaying an equation editor image and non-visible mathml" 


    it "should display record video dialog" 


    it "should save with an iframe in a list" 


    it "should save with an iframe in a table" 
