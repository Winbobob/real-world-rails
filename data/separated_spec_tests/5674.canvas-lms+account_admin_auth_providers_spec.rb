  ...
  describe 'identity provider' do
    ...
    context 'saml' do
      ...
      context 'federated attributes' do
        ...
        it 'saves federated attributes' 


        it 'shows and saves provisioning only checkboxes' 


        it 'hides provisioning only when jit provisioning is disabled' 


        it 'clears provisioning only when toggling jit provisioning' 


        it 'hides the add attributes button when all are added' 


        it 'can remove all attributes' 


        it "doesn't include screenreader text when removing attributes" 
    ...
    context 'microsoft' do
      ...
      it 'should allow creation of config', priority: "2" 


      it 'should allow update of config', priority: "2" 


      it 'should allow deletion of config', priority: "2" 
