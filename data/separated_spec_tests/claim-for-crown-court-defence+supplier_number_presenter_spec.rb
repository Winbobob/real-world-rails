...
RSpec.describe SupplierNumberPresenter do
  ...
  describe '#supplier_label' do
    it 'returns a label including the supplier number, name and postcode' 


    context 'when the supplier does not have a defined postcode' do
      let(:postcode) { nil }

      it 'returns a label including only the supplier number' 
    ...
    context 'when the supplier does not have a defined name' do
      ...
      it 'returns a label including only the supplier number and postcode' 
