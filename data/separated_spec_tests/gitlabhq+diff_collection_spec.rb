...
describe Gitlab::Git::DiffCollection, :seed_helper do
  ...
  describe '#decorate!' do
    ...
    it 'avoids future iterator iterations' 
    ...
    context 'adding few enough files' do
      ...
      context 'and few enough lines' do
        ...
        describe '#size' do
          ...
          it 'does not change after peeking' 
  ...
  describe '#each' do
    context 'when diff are too large' do
      ...
      it 'yields Diff instances even when they are too large' 


      it 'prunes diffs that are too large' 
    ...
    context 'when diff is quite large will collapse by default' do
      ...
      context 'when no collapse is set' do
        ...
        it 'yields Diff instances even when they are quite big' 


        it 'does not prune diffs' 
      ...
      context 'when no collapse is unset' do
        ...
        it 'prunes diffs that are quite big' 
        ...
        context 'when go over safe limits on files' do
          ...
          it 'prunes diffs by default even little ones' 
