...
describe Admin::PagesController, type: :controller do
  ...
  describe 'POST #create' do
    context 'should create a new page' do
      ...
      it 'creates a published page with a redirect' 


      it 'creates an unpublished page without a redirect' 


      it 'creates a page published in the future without a redirect' 
