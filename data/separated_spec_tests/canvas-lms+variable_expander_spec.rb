...
module Lti
  describe VariableExpander do
    ...
    it 'echoes registered variable if blacklisted' 


    it 'echoes substring variable if blacklisted' 


    it 'echoes multiple substring variables if blacklisted' 
    ...
    describe "#variable expansions" do
      context '$com.instructure.Assignment.anonymous_grading' do
        ...
        it 'is true if the assignment has anonymous grading on' 


        it 'is false if the assignment does not have anonymous grading on' 
      ...
      context 'context is a course' do
        ...
        it 'has substitution for $com.Instructure.membership.roles' 


        it 'has substitution for foo' 
      ...
      context 'user is logged in' do
        ...
        it 'has substitution for $com.instructure.Person.name_sortable' 
        ...
        it 'has substitution for $Membership.role in LTI 1.3 mode' 
