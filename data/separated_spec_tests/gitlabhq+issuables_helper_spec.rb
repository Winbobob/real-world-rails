...
describe IssuablesHelper do
  ...
  describe '#group_dropdown_label' do
    ...
    it 'returns default group label when group_id is nil' 


    it 'returns "any group" when group_id is 0' 


    it 'returns group full path when a group was found for the provided id' 


    it 'returns default label when a group was not found for the provided id' 
