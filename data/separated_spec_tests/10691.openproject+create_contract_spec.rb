...
describe WorkPackages::CreateContract do
  ...
  describe 'author_id' do
    it 'is valid if the user is the user is the user the contract is evaluated for' 


    it 'is invalid if the user is different from the user the contract is evaluated for' 
