...
describe TeamsController, type: :controller do
  ...
  context 'when logged in' do
    context 'as admin' do
      ...
      describe '#switch' do
        it 'must set the current_team_slug session' 
      ...
      describe '#manage_users' do
        ...
        it 'only list users this team to manage' 
      ...
      describe '#create_enrollment' do
        ...
        context 'with valid parameters' do
          ...
          context 'when the user is not in the current team' do
            ...
            it 'should return successfully associate in current team' 

          end

          context 'when the user is in the current team' do
            let(:normal_user_with_team) { create :user, teams: [team], email: 'sample@example.com' }
            it 'should return that user is already in this team ' 

          end

          context 'when the user does not exist' do
            it 'should not find a user to associate' 
      ...
      describe '#destroy' do
        ...
        describe 'when the flag send_email: true' do
          it 'sends email to team members' 


          it 'increases the number of send mails' 

        end

        describe 'when the flag send_email: false' do
          it 'not increases the number of send mails' 
