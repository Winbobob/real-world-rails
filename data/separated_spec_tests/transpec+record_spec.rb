...
module Transpec
  describe Record do
    ...
    describe '#to_s' do
      ...
      context "when it's a conversion" do
        ...
        it 'returns "Conversion from `old syntax` to `new syntax`"' 
      ...
      context "when it's an addition" do
        ...
        it 'returns "Addition of `new syntax`"' 
      ...
      context "when it's a removal" do
        ...
        it 'returns "Removal of `old syntax`"' 
  ...
  describe RecordBuilder do
    describe '.build' do
      ...
      it 'returns an instance of Record' 
...

      {
        ...
        it "sets builder's ##{attribute} value to record's ##{attribute}" 
