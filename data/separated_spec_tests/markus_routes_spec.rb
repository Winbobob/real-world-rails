...
describe 'An Assignment' do
  ...
  context 'member' do
    ...
    it 'routes GET creategroup properly' 


    it 'routes GET join_group properly' 


    it 'routes GET deletegroup properly' 


    it 'routes GET decline_invitation properly' 


    it 'routes POST disinvite_member properly' 
  ...
  context 's criteria' do
    context 'collection' do
      ...
      it 'routes GET show id: move_criterion' 
  ...
  context 's automated_tests' do
    ...
    context 'collection' do
      ...
      it 'routes GET move_criterion properly' 
  ...
  context 'groups' do
    ...
    context 'collection' do
      it 'routes GET populate properly' 
  ...
  context 'submission' do
    ...
    context 'collection' do
      ...
      it 'routes POST populate_file_manager properly' 
      ...
      it 'routes GET update_submissions properly' 


      it 'routes GET populate_submissions_table' 


      it 'routes POST populate_file_manager' 
  ...
  context 'grader' do
    ...
    context 'collection' do
      it 'routes GET add_grader_to_grouping properly' 
      ...
      it 'routes GET grader_criteria_dialog properly' 


      it 'routes GET global_actions properly' 


      it 'routes GET groups_coverage_dialog properly' 


      it 'routes POST set_assign_criteria properly' 


      it 'routes GET random_assign properly' 
