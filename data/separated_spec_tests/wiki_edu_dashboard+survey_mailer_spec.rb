...
describe SurveyMailer, type: :mailer do
  ...
  describe '#notification' do
    ...
    context 'when it is an instructor survey' do
      ...
      it 'sends a personalized email to the instructor' 
    ...
    context 'when it is a student assessment survey' do
      ...
      it 'sends a personalized email about the student survey' 
    ...
    context 'when it is a custom survey' do
      ...
      it 'sends an email with the custom email content' 
  ...
  describe '#follow_up' do
    ...
    context 'when it is an instructor survey' do
      ...
      it 'contains the correct user email and body' 
