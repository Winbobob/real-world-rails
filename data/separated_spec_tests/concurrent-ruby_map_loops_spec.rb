...
module Concurrent
  ...
  RSpec.describe 'MapTorture', stress: true, notravis: true do
    ...
    it '#compute_put_if_absent' 


    it '#compute_if_absent_and_present' 


    it 'add_remove_to_zero' 


    it 'add_remove_to_zero_via_merge_pair' 


    it 'add_remove' 


    it 'add_remove_via_compute' 


    it 'add_remove_via_compute_if_absent_present' 


    it 'add_remove_indiscriminate' 


    it 'count_up' 


    it 'count_up_via_compute' 


    it 'count_up_via_merge_pair' 
