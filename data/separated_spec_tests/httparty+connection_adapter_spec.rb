...
RSpec.describe HTTParty::ConnectionAdapter do
  describe "initialization" do
    ...
    it "takes a URI as input" 


    it "raises an ArgumentError if the uri is nil" 


    it "raises an ArgumentError if the uri is a String" 


    it "sets the uri" 


    it "also accepts an optional options hash" 
  ...
  describe ".call" do
    ...
    it "generates an HTTParty::ConnectionAdapter instance with the given uri and options" 


    it "calls #connection on the connection adapter" 
  ...
  describe '#connection' do
    ...
    describe "the resulting connection" do
      ...
      context "when dealing with IPv6" do
        ...
        it "strips brackets from the address" 
      ...
      context "specifying ciphers" do
        ...
        it "should set the ciphers on the connection" 

      end if RUBY_VERSION > '1.9'

      context "when timeout is not set" do
        it "doesn't set the timeout" 
      ...
      context "when timeout is not set and read_timeout is set to 6 seconds" do
        ...
        it "should not set the open_timeout" 
      ...
      context "when timeout is set and read_timeout is set to 6 seconds" do
        ...
        it "should override the timeout option" 
      ...
      context "when timeout is not set and open_timeout is set to 7 seconds" do
        ...
        it "should not set the read_timeout" 
      ...
      context "when debug_output" do
        ...
        context "is set to $stderr" do
          ...
          it "has debug output set" 

        end

        context "is not provided" do
          it "does not set_debug_output" 
      ...
      context 'when providing nil as proxy address' do
        ...
        it "does pass nil proxy parameters to the connection, this forces to not use a proxy" 
      ...
      context 'when not providing a proxy address' do
        ...
        it "does not pass any proxy parameters to the connection" 
      ...
      context "when providing PEM certificates" do
        ...
        context "when scheme is https" do
          ...
          it "will verify the certificate" 
      ...
      context "when providing PKCS12 certificates" do
        ...
        context "when scheme is https" do
          ...
          it "uses the provided P12 certificate " 
