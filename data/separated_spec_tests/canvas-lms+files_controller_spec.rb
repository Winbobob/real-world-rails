...
describe FilesController do
  ...
  describe "GET 'show'" do
    ...
    it "should respect user context" 
    ...
    it "should remember most recent valid sf_verifier in session" 


    it "should ignore invalid sf_verifiers" 
  ...
  describe "POST api_capture" do
    ...
    context 'with a course' do
      ...
      it "should include the attachment json in the response" 
      ...
      context 'with an Assignment' do
        ...
        context 'with a Progress' do
          ...
          it "completes the Progress object" 


          it "sets the attachment id in the Progress#results" 


          it "returns a 201 http status" 


          it 'should not submit the attachment' 
        ...
        context 'with Progress tagged as :upload_via_url' do
          ...
          it 'should submit the attachment' 


          it 'should save the eula_agreement_timestamp' 
