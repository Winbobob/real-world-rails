...
describe ProducerMailer do
  ...
  it "should send an email when an order cycle is closed" 


  it "sets a reply-to of the oc coordinator's email" 


  it "includes receival instructions" 


  it "cc's the oc coordinator" 


  it "contains an aggregated list of produce in alphabetical order" 



  it "displays tax totals for each product" 


  it "does not include incomplete orders" 


  it "does not include canceled orders" 


  it "includes the total" 


  it "sends no mail when the producer has no orders" 
