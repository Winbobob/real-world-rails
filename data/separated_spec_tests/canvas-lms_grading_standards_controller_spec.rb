...
describe GradingStandardsController do
  describe "POST 'create'" do
    ...
    it "responds with a 200 with a valid user, course id, and json format" 


    it "uses the default grading standard if no standard data is provided" 


    it "allows the user to send in a :data param to set the standard" 


    it "allows the user to send in a :standard_data param to set the standard" 
  ...
  describe "GET 'index'" do
    context "context is an account" do
      ...
      it "returns a 200 for a valid request" 


      it "renders the 'account_index' template" 
    ...
    context "context is a course" do
      ...
      it "renders the 'course_index' template" 
