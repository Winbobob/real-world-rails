...
RSpec.describe Lti::ToolConfigurationsApiController, type: :controller do
  ...
  shared_examples_for 'an endpoint that accepts a settings_url' do
    ...
    context 'when the request does not time out' do
      ...
      it 'uses the tool configuration JSON from the settings_url' 


      it 'sets the "disabled_placements"' 


      it 'sets the "custom_fields"' 
    ...
    context 'when the request times out' do
      ...
      it 'responds with helpful error message' 
  ...
  shared_examples_for 'an endpoint that accepts developer key parameters' do
    ...
    it 'sets the developer key name' 


    it 'sets the developer key email' 


    it 'sets the developer key notes' 


    it 'sets the developer key test_cluster_only' 


    it 'sets the developer key scopes' 


    it 'sets the developer key require_scopes' 
  ...
  describe '#create' do
    ...
    context 'when the tool configuration does not exist' do
      ...
      it 'creates a developer key on the correct account' 
  ...
  describe '#update' do
    ...
    context do
      ...
      it 'updates the tool configuration' 
  ...
  describe '#show' do
    ...
    context 'when the tool configuration exists' do
      it 'renders the tool configuration' 
  ...
  describe '#destroy' do
    ...
    context 'when the tool configuration exists' do
      it 'destroys the tool configuration' 
