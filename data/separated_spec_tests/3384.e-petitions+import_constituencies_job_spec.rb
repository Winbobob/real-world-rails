...
RSpec.describe ImportConstituenciesJob, type: :job do
  ...
  context "when the request is successful" do
    shared_examples_for "a job that imports constituencies" do
      ...
      describe "attribute assignment" do
        ...
        it "doesn't import old constituencies" 


        it "imports constituencies without an end date" 


        it "assigns the constituency id" 


        it "assigns the constituency name" 


        it "assigns the constituency ONS code" 


        it "assigns the constituency example postcode" 
      ...
      describe "error handling" do
        context "when a record fails to save" do
          ...
          it "notifies Appsignal of the failure" 
  ...
  context "when the request is unsuccessful" do
    context "because the API is not responding" do
      ...
      it "doesn't import any constituencies" 
