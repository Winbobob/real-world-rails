...
describe Gitlab::GithubImport::Importer::PullRequestImporter, :clean_gitlab_redis_cache do
  ...
  describe '#create_merge_request' do
    ...
    context 'when the author could be found' do
      ...
      it 'returns the created merge request' 


      it 'triggers internal_id functionality to track greatest iids' 
    ...
    context 'when the merge request already exists' do
      ...
      it 'returns the existing merge request' 
  ...
  describe '#insert_git_data' do
    ...
    it 'creates the merge request diff commits' 


    context 'when the merge request exists' do
      it 'creates the merge request diffs if they do not yet exist' 
