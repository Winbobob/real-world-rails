...
describe "assignments" do
  ...
  context "as a teacher" do
    ...
    it 'creates a simple assignment and defaults post_to_sis' 
    ...
    context 'sync to sis' do
      ...
      context 'assignment name length' do
        ...
        it 'validates name length while sis is on' 


        it 'does not validate when sis is off' 
      ...
      context 'due date required' do
        ...
        it 'validates due date while sis is on' 
        ...
        describe 'differentiated assignment' do
          ...
          it 'checks each due date when on' 


          it 'does not check when sis is off' 
      ...
      context 'when on index page' do
        ...
        describe "when there are due dates" do
          it 'where there are no overrides' 


          it 'when there are overrides and no base' 


          it 'when there is a base and overrides' 
        ...
        describe 'when due dates for quizzes' do
          ...
          it 'when there are no overrides' 
    ...
    context "group assignments" do
      ...
      it "should show and hide the intra-group peer review toggle depending on group setting" 
