...
describe "context modules" do
  ...
  context "progressions", priority: "1" do
    ...
    it "should show student progressions to teachers" 
    ...
    it "should show multiple student progressions to observers" 
  ...
  context "progression link" do
    ...
    it "should show progressions link in modules home page", priority: "2" 
    ...
    it "should not show progressions link in modules home page for large rosters (MOOCs)", priority: "2" 
