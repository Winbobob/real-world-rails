...
describe "assignment_submitted_late.email" do
  ...
  it "body includes the student name" 


  it "body does not include the student name if assignment is anonymous and muted" 


  it "body includes the student name if assignment is anonymous and unmuted" 
