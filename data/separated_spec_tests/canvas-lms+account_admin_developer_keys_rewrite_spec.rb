...
describe 'Developer Keys' do
  ...
  describe 'with developer key management UI rewrite feature flag' do
    ...
    context "Account Binding" do
      ...
      it "only show create developer key button for account tab panel" 
    ...
    context "scopes" do
      ...
      it "does not have enforce scopes toggle activated on initial dev key creation" 


      it "enforce scopes toggle allows scope creation" 


      it "allows filtering by scope group name" 


      it "expands scope group when group name is selected" 


      it "includes proper scopes for scope group" 


      it "scope group select all checkbox adds all associated scopes" 


      it "scope group individual checkbox adds only associated scope" 


      it "adds scopes to backend developer key via UI" 


      it "adds scopes to backend developer key via UI in site admin" 


      it "removes scopes from backend developer key through UI" 


      it "keeps all endpoints read only checkbox checked after save" 


      it "keeps all endpoints read only checkbox checked if check/unchecking another http method" 


      it "opens the developer key modal when open modal anchor is present" 


      it "displays flash alert if scopes aren't selected when enforce scopes toggled" 


      it "clears current developer key state when browser back button is pressed" 


      it "allows saving developer key when scopes are present" 
