...
describe Carto::VisualizationsExportService2 do
  ...
  describe 'importing' do
    ...
    describe '#build_visualization_from_json_export' do
      ...
      it 'fails if version is not 2' 


      it 'builds base visualization' 


      it 'builds base visualization that can be persisted by VisualizationsExportPersistenceService' 


      it 'builds base vis with symbols in name that can be persisted by VisualizationsExportPersistenceService' 


      it 'is backwards compatible with old models' 


      it 'imports private maps as public for users that have not private maps' 


      it 'imports protected maps as private' 


      it 'imports protected maps as public if the user does not have private maps enabled' 


      it 'does not import more layers than the user limit' 


      it "Doesn't register layer tables dependencies if user table doesn't exist" 


      it "Register layer tables dependencies if user table exists" 


      describe 'maintains backwards compatibility with' do
        describe '2.1.1' do
          it 'defaults to locked visualizations' 


          it 'sets password protected visualizations to private' 

        end

        describe '2.1.0' do
          it 'without mark_as_vizjson2' 
        ...
        it '2.0.9 (without permission, sync nor user_table)' 


        it '2.0.8 (without id)' 


        it '2.0.7 (without Widget.style)' 
        ...
        it '2.0.5 (without version)' 


        it '2.0.4 (without Widget.order)' 


        it '2.0.3 (without Layer.legends)' 


        it '2.0.2 (without Visualization.state)' 


        describe '2.0.1 (without username)' do
          it 'when not renaming tables' 


          it 'when renaming tables' 

        end

        it '2.0.0 (without Widget.source_id)' 
  ...
  describe 'exporting' do
    describe '#export_visualization_json_string' do
      ...
      describe 'visualization types' do
        ...
        it 'works for derived/canonical/remote visualizations' 

      end

      it 'exports visualization' 


      it 'only exports layers that a user has permissions at' 


      it 'truncates long sync logs' 
    ...
    describe 'exporting + importing visualizations with shared tables' do
      ...
      it 'replaces owner name with new user name on import for user_name and query' 


      it 'replaces owner name (with dash) with new user name on import for user_name and query' 


      it 'replaces owner name (without dash) with new user name (with dash) on import for user_name and query' 


      it 'removes owner name from user_name and query importing into a non-organization account' 


      it 'removes owner name from user_name and query importing into a non-org. even if username matches' 


      it 'does not replace owner name with new user name on import when new query fails' 
    ...
    describe 'exporting + importing visualizations with renamed tables' do
      ...
      it 'replaces table name in default queries on import (with schema)' 


      it 'replaces table name in more complex queries on import' 


      it 'does not replace table name as part of a longer identifier' 


      it 'does not replace table name when query fails' 
  ...
  describe 'exporting + importing' do
    ...
    describe 'maps' do
      ...
      it 'importing an exported visualization should create a new visualization with matching metadata' 


      it 'importing an exported visualization several times should change imported name' 


      it 'importing an exported visualization into another account should change layer user_name option' 


      it 'importing an exported visualization should not keep the vizjson2 flag, but should return it' 


      it 'importing a password-protected visualization keeps the password' 
      ...
      describe 'if full_restore is' do
        ...
        it 'false, it should generate a random uuid and blank permission, no mapcap and unlocked' 


        it 'true, it should keep the imported uuid, permission, mapcap, synchroniztion and locked' 
      ...
      describe 'basemaps' do
        describe 'custom' do
          ...
          it 'importing an exported visualization with a custom basemap should add the layer to user layers' 


          it 'importing an exported visualization with a custom basemap twice should add the layer to user layers only once' 
    ...
    describe 'datasets' do
      ...
      it 'importing an exported dataset should keep the user_table' 


      it 'importing a dataset with an existing name should raise an error' 


      it 'importing a dataset without a table should raise an error' 


      it 'importing an exported dataset should keep the synchronization' 


      it 'imports a synchronization without log' 


      it 'imports an exported dataset with external data import without a synchronization' 


      it 'keeps private privacy is private tables enabled' 


      it 'converts to privacy public if private tables disabled' 
