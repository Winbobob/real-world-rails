...
describe EOL::Solr::ActivityLog do
  ...
  describe '#search_with_pagination' do
    ...
    it 'should have some reasonable default options' 


    it 'should not exclude user_added_data if the user can see it' 


    it 'should escape the query' 


    it 'should handle specific time ... whatever that means' 
