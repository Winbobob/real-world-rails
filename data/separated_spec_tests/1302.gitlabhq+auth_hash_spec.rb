...
describe Gitlab::Auth::OAuth::AuthHash do
  ...
  context 'username not provided' do
    ...
    it 'takes the first part of the email as username' 
  ...
  context 'name not provided' do
    ...
    it 'concats first and lastname as the name' 

  end

  context 'auth_hash constructed with ASCII-8BIT encoding' do
    it 'forces utf8 encoding on uid' 


    it 'forces utf8 encoding on provider' 


    it 'forces utf8 encoding on name' 


    it 'forces utf8 encoding on username' 


    it 'forces utf8 encoding on email' 


    it 'forces utf8 encoding on password' 
