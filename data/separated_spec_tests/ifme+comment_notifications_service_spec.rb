  ...
  context '#remove' do
    ...
    context 'when model_name is moment' do
      ...
      context 'when comment visibility is all' do
        ...
        it 'remove comments and notifications related to that moment' 
    ...
    context 'when model_name is strategy' do
      ...
      context 'when comment visibility is all' do
        ...
        it 'remove comments and notifications related to that strategy' 
    ...
    context 'when model_name is meeting' do
      ...
      it 'remove comments and notifications related to that meeting' 
