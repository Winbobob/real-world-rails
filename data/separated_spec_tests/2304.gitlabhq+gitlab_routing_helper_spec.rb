...
describe GitlabRoutingHelper do
  ...
  describe '#preview_markdown_path' do
    ...
    it 'returns group preview markdown path for a group parent' 


    it 'returns project preview markdown path for a project parent' 


    it 'returns snippet preview markdown path for a personal snippet' 


    it 'returns project preview markdown path for a project snippet' 

  end

  describe '#edit_milestone_path' do
    it 'returns group milestone edit path when given entity parent is a Group' 


    it 'returns project milestone edit path when given entity parent is not a Group' 
