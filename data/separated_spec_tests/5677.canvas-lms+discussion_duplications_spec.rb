  ...
  context 'discussion created by teacher' do
    ...
    context 'duplicating' do
      ...
      describe 'group context' do
        ...
        it "has duplication option for group discussions page" 
        ...
        it "teacher can duplicate a discussion" 


        it "student can duplicate a discussion if student editing enabled" 


        it "a teacher can duplicate a student's discussion" 
