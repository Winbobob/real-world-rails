...
describe PostDestroyer do
  ...
  describe "recovery and post actions" do
    ...
    it "restores public post actions" 


    it "does not recover previously-deleted actions" 


    it "updates post like count" 
  ...
  context 'private message' do
    ...
    it "doesn't update post_count for a reply" 


    it "doesn't update topic_count for first post" 


    it 'triggers the extensibility events' 
  ...
  context 'deleting the second post in a topic' do
    ...
    it 'resets the highest_post_number' 
  ...
  describe "post actions" do
    ...
    it "should not send the flags_agreed_and_post_deleted message if it was deleted by system" 


    it "should not send the flags_agreed_and_post_deleted message if it was deleted by author" 


    it "should not send the flags_agreed_and_post_deleted message if flags were deferred" 


    it "should set the deleted_public_actions custom field" 
