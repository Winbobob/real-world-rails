  ...
  describe WebhookHandler do
    ...
    describe 'Mandates' do
      ...
      describe 'general behaviour' do
        ...
        it 'sets updates state on payment method record' 


        it 'persists event' 


        it 'persists events just once' 
      ...
      describe 'with repeated events' do
        ...
        it 'sets state to appropriate event' 
