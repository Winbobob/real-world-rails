...
describe Hashie::Trash do
  ...
  context 'when copying properties from other properties' do
    it 'retains the original and also sets the copy' 


    it 'grabs the default for the original if it is not set' 


    it 'can be a required value' 


    it 'does not set properties that do not exist' 


    it 'is not order-dependent in definition' 
