...
describe 'API v3 Work package resource',
  ...
  describe '#get list' do
    ...
    it 'returns visible work packages' 


    it 'embedds the work package schemas' 
  ...
  describe '#get' do
    ...
    context 'when acting as a user with permission to view work package' do
      ...
      describe 'response body' do
        ...
        it 'should respond with work package in HAL+JSON format' 
        ...
        it 'should resolve simple macros' 
  ...
  describe '#patch' do
    ...
    context 'user with needed permissions' do
      ...
      context 'subject' do
        ...
        it 'should respond with updated work package subject' 
      ...
      context 'start date' do
        ...
        it 'should respond with updated start date' 
      ...
      context 'finish date' do
        ...
        it 'should respond with updated finish date' 
      ...
      context 'status' do
        ...
        context 'valid status' do
          ...
          it 'should respond with updated work package status' 
      ...
      context 'type' do
        ...
        context 'valid type' do
          ...
          it 'should respond with updated work package type' 
        ...
        context 'valid type changing custom fields' do
          ...
          it 'responds with the new custom field having the desired value' 
      ...
      context 'project' do
        ...
        context 'is changed' do
          ...
          it 'responds with the project changed' 
      ...
      context 'version' do
        ...
        context 'valid' do
          ...
          it 'should respond with the work package assigned to the version' 
      ...
      context 'category' do
        ...
        context 'valid' do
          ...
          it 'should respond with the work package assigned to the category' 
      ...
      context 'priority' do
        ...
        context 'valid' do
          ...
          it 'should respond with the work package assigned to the priority' 
      ...
      context 'list custom field' do
        ...
        context 'valid' do
          ...
          it 'should respond with the work package assigned to the new value' 
      ...
      context 'claiming attachments' do
        ...
        it 'replaces the current with the provided attachments' 
  ...
  describe '#delete' do
    ...
    context 'with required permissions' do
      ...
      it 'responds with HTTP No Content' 


      it 'deletes the work package' 
    ...
    context 'without permission to delete work packages' do
      ...
      it 'does not delete the work package' 
  ...
  describe '#post' do
    ...
    it 'should be associated with the provided project' 


    it 'should be associated with the provided type' 
    ...
    context 'claiming attachments' do
      ...
      it 'creates the work package and assigns the attachments' 
