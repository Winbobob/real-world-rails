...
describe Gitlab::BackgroundMigration::FixCrossProjectLabelLinks, :migration, schema: 20180702120647 do
  ...
  shared_examples_for 'resource with cross-project labels' do
    it 'updates only cross-project label links which exist in the local project or group' 


    it 'ignores cross-project label links if label color is different' 


    it 'ignores cross-project label links if label name is different' 
