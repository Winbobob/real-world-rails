...
describe PeerReviewsApiController, type: :request do
  ...
  describe "Delete 'delete'" do
    ...
    context 'with admin context' do
      ...
      it 'should delete peer review' 


      it 'should delete peer review for course section' 


      it 'should render bad request' 
  ...
  describe "Post 'create'" do
    ...
    context 'with admin_context' do
      ...
      it 'should create peer review' 


      it 'should create peer review for course section' 


      it 'should not create peer review where the reviewer and student are same' 
  ...
  describe "Get 'index'" do
    ...
    context 'with admin_context' do
      ...
      it 'should return all peer reviews' 


      it 'should return all peer reviews in a section' 


      it 'should return all peer reviews when anonymous peer reviews enabled' 


      it 'should include user information' 


      it 'should include submission comments' 


      it 'should return peer reviews for a specific submission' 


      it 'should return peer reviews for a specific submission in a section' 
    ...
    context 'with student_context' do
      ...
      it 'should return peer reviews for user' 


      it 'should not return assessor if anonymous peer reviews enabled' 


      it 'should not return peer reviews for assessor' 


      it 'should include user information' 


      it 'should not include assessor information when peer reviews are enabled' 
      ...
      it 'should not include submission comments user information when anonymous peer reviews' 


      it 'should return peer reviews for a specific submission' 


      it 'should return no peer reviews for invalid submission' 
