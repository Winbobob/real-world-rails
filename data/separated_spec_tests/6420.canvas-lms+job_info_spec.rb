  ...
  class Errors
    describe JobInfo do
      ...
      describe "#to_h" do
        ...
        it "tags all exceptions as 'BackgroundJob'" 


        it "includes the tag from the job if there is one" 


        it "grabs some common attrs from jobs into extras" 


        it "includes the worker name" 


        it "includes the job id in the extras hash" 


        it 'includes the source, which has the request context id' 
