...
describe EportfolioEntriesController do
  ...
  describe "GET 'submission'" do
    ...
    it 'passes anonymize_students: false to the template if the assignment is not anonymous' 


    it 'passes anonymize_students: false to the template if the assignment is anonymous and unmuted' 


    it 'passes anonymize_students: true to the template if the assignment is anonymous and muted' 
