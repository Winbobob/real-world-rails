...
module OpenFoodNetwork
  describe ScopeVariantToHub do
    ...
    describe "overriding price" do
      it "returns the overridden price when one is present" 


      it "returns the variant's price otherwise" 
    ...
    describe "overriding stock levels" do
      it "returns the overridden stock level when one is present" 


      it "returns the variant's stock level otherwise" 


      describe "overriding stock on an on_demand variant" do
        let(:v) { create(:variant, price: 11.11, on_demand: true) }

        it "clears on_demand when the stock is overridden" 


        it "does not clear on_demand when only the price is overridden" 


        it "does not clear on_demand when there is no override" 
      ...
      describe "overriding on_demand" do
        context "when an override exists" do
          ...
          context "with an on_demand set" do
            it "returns the overridden on_demand" 
          ...
          context "without an on_demand set" do
            ...
            context "when count_on_hand is not set" do
              ...
              it "returns the variant's on_demand" 
