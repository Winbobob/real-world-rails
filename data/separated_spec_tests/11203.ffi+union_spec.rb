...
describe 'Union' do
  ...
  it 'should place all the fields at offset 0' 

  LibTest::Types.each do |k, type|
    it "should correctly align/write a #{type[0]} value" 

  end
  LibTest::Types.each do |k, type|
    it "should read a #{type[0]} value from memory" 

  end

  it 'should return a size equals to the size of the biggest field' 
