...
describe BasicLTI::BasicOutcomes do
  ...
  describe "#handle_replaceResult" do
    ...
    it "Does not increment the attempt number" 


    it "sets 'submitted_at' to the current time when result data is not sent" 
    ...
    context 'with submitted_at details' do
      ...
      it "does not increment the submision count" 
