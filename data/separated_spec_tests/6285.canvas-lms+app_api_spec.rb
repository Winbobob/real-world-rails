...
describe AppCenter::AppApi do
  ...
  describe '#get_app_config_url' do
    ...
    it 'uses the current context app center token if set' 


    it 'uses the inherited access token if not set at current context' 


    it 'defaults to the plugin setting access token if no current context token is set' 
