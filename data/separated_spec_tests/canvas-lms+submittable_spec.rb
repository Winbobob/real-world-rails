...
shared_examples_for "submittable" do
  describe "visible_ids_by_user" do
    ...
    it "should return both topics for a student with an override" 


    it "should not return differentiated topics to a student with no overrides" 
...
describe "section specific topic" do
  ...
  it "filters section specific topics properly" 
