...
RSpec.describe Orgs::RostersController, type: :controller do
  ...
  describe "GET #new", :vcr do
    context "with flipper enabled" do
      ...
      it "sends not found if the user doesn't belong to the organization" 
  ...
  describe "GET #show", :vcr do
    ...
    context "with flipper enabled" do
      ...
      context "download roster button" do
        ...
        it "should export CSV with all entries" 


        it "succeeds when accessible grouping is provided" 


        it "404s when inaccessible grouping is provided" 
  ...
  describe "PATCH #add_students", :vcr do
    ...
    context "with flipper enabled" do
      ...
      context "when some identifiers get added" do
        ...
        it "creates only one roster entry" 
