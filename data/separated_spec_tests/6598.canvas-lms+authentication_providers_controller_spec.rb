...
describe AuthenticationProvidersController do
  ...
  describe "start_debugging" do
    it "complains about unsupported auth type" 


    it "works for supported auth type" 
  ...
  describe "POST #create" do
    ...
    it "adds a new auth config successfully" 


    it "adds a singleton type successfully" 


    it "rejects a singleton type if it already exists" 


    it "allows multiple non-singleton types" 


    it "allows re-adding a singleton type that was previously deleted" 
...
<EntityDescriptor xmlns="urn:oasis:names:tc:SAML:2.0:metadata" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" entityID="https://sso.school.edu/idp/shibboleth">
  <IDPSSODescriptor protocolSupportEnumeration="urn:mace:shibboleth:1.0 urn:oasis:names:tc:SAML:1.1:protocol urn:oasis:names:tc:SAML:2.0:protocol">
    ...
    it "populates SAML from metadata" 
