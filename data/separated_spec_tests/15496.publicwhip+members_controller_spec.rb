...
describe MembersController, type: :request do
  ...
  describe "#show" do
    ...
    context "Barnaby Joyce" do
      ...
      it "should redirect to the senator's page even if the id param incorrectly identifies a member as a senator and vice versa" 

    end

    it "should 404 with an unknown person" 


    it "should 404 when the wrong name is given for a correct electorate" 
