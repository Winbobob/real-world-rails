...
shared_examples 'something fabricatable' do
  ...
  context 'state of the object' do
    it 'generates a fresh object every time' 
  ...
  context 'belongs_to associations' do
    ...
    it 'sets the parent association' 


    it 'sets the id of the associated object' 
...
describe Fabrication do
  ...
  context 'active_record models', depends_on: :active_record do
    ...
    context 'associations in attributes_for' do
      ...
      it 'serializes the belongs_to as an id' 
  ...
  context 'sequel models', depends_on: :sequel do
    ...
    context 'with class table inheritance' do
      ...
      it 'generates the right number of objects' 
  ...
  context 'with the generation parameter' do
    ...
    it 'evaluates the fields in order of declaration' 
  ...
  context 'multiple instance' do
    ...
    it 'parent_ruby_object1 has the correct string field' 


    it 'parent_ruby_object2 has the correct string field' 


    it 'they have different extra fields' 
  ...
  context 'with a mongoid document', depends_on: :mongoid do
    ...
    it "sets lazy dynamic fields" 


    context "with disabled dynamic fields" do
      it "raises NoMethodError for mongoid_dynamic_field=" 
  ...
  describe 'using the rand option' do
    ...
    context 'with an integer' do
      ...
      it 'generates between 1 and 3 child_ruby_objects' 
    ...
    context 'with a range' do
      ...
      it 'generates between 3 and 5 child_ruby_objects' 
