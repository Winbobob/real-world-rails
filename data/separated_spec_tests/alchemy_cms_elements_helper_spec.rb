...
module Alchemy
  describe Admin::ElementsHelper do
    ...
    context "partial rendering" do
      it "should render an element editor partial" 


      it "should render a picture gallery editor partial" 
    ...
    describe "#grouped_elements_for_select" do
      ...
      context "with an element collection given" do
        ...
        it "returns an array of elements grouped by cell for select_tag helper" 
        ...
        context "with an element in a cell only" do
          ...
          it "returns an option for the element in the cell only" 
        ...
        context "with the same element in both cell and page" do
          ...
          it "returns two options of same element, one for the cell and one for the page" 
    ...
    describe "#elements_for_select" do
      context "passing element instances" do
        ...
        it "should return a array for option tags" 
      ...
      context "passing a hash with element definitions" do
        ...
        it "should render the elements display name" 
    ...
    describe '#element_editor_classes' do
      ...
      it "returns css classes for element editor partial" 
