...
describe EmailSpec::Matchers do
  ...
  describe "#deliver_to" do
    ...
    it "should match when the email is set to deliver to the specified name and address" 
    ...
    it "should match when the names and email addresses match in any order" 


    it "should use the passed in objects :email method if not a string" 


    it "should not match when the email does not have a recipient" 
    ...
    it "should deliver to nobody when the email does not perform deliveries" 
  ...
  describe "#deliver_from" do
    ...
    it "should not deliver from anybody when perform_deliveries is false" 
  ...
  describe "#bcc_to" do
    ...
    it "should bcc to nobody when the email does not perform deliveries" 
  ...
  describe "#cc_to" do
    ...
    it "should cc to nobody when the email does not perform deliveries" 
  ...
  describe "#have_body_text" do
    ...
    describe "when strings are used" do
      it "should match when the body includes text with symbols" 
