...
describe PG::Result do
	...
	context "result streaming in single row mode" do
		it "can iterate over all rows as Hash" 
		...
		it "can iterate over all rows as Array" 
		...
		it "can iterate over all rows as PG::Tuple" 
	...
	it "encapsulates errors in a PG::Error object" 
	...
	it "can return the values of a single tuple" 


	it "can return the values of a single vary lazy tuple" 
