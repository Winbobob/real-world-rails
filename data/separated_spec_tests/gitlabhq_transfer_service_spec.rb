...
describe Labels::TransferService do
  describe '#execute' do
    ...
    it 'recreates the missing group labels at project level' 


    it 'recreates label priorities related to the missing group labels' 


    it 'does not recreate missing group labels that are not applied to issues or merge requests' 


    it 'does not recreate missing group labels that already exist in the project group' 


    it 'updates only label links in the given project' 
