...
describe "speed grader" do
  ...
  it "displays inactive students" 


  it "can grade and comment inactive students" 


  it "displays concluded students" 
  ...
  context 'when student names are hidden' do
    ...
    it 'sorts by submission date when eg_sort_by is submitted_at' 


    it 'sorts by submission status when eg_sort_by is submission_status' 
  ...
  context "student dropdown" do
    ...
    it "show all sections menu item is present", priority: "2", test_id: "164207" 


    it "should list all course sections", priority: "2", test_id: "588914" 
