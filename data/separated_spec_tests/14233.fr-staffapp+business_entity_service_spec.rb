...
describe BusinessEntityService do
  ...
  describe '#persist!' do
    ...
    context 'when persisting a new object' do
      ...
      it 'the business_entity has no error messages' 
    ...
    context 'when persisting an update' do
      ...
      context 'invalid data' do
        ...
        it 'return false if fails to persist' 


        it 'the business_entity has the error messages' 
