  ...
  context "employment" do
    ...
    describe 'current_situation' do
      context 'when still_employed' do
        ...
        it 'does not include fields pertaining to employment end date or notice period' 
      ...
      context 'when notice_period' do
        ...
        it 'does not include fields pertaining to employment end date or notice period pay' 
      ...
      describe 'when target.worked_notice_period_or_paid_in_lieu' do
        context 'is true' do
          ...
          it 'includes notice period pay' 

        end

        context 'is false' do
          it 'does not include notice period pay' 
      ...
      context 'when employment is blank' do
        ...
        it 'presents as not employed there' 
