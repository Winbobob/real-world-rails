...
describe "speed grader" do
  ...
  context 'manually submitted comments' do
    ...
    it "has option for adding attachments" 
    ...
    it 'displays attachments', test_id: 3058055, priority: "1" 
    ...
    context 'with inactive students' do
      ...
      it "creates comments", test_id: 1407014, priority: "1" 
    ...
    describe 'deleting a comment' do
      ...
      it 'decreases the number of published comments' 


      it 'removes the deleted comment from the list of comments' 
  ...
  describe 'auto-saved draft comments' do
    ...
    describe 'saving a draft comment' do
      it 'when going to the next student', test_id: 1407005, priority: "1" 


      it 'when going to the previous student', test_id: 1407006, priority: "1" 


      it 'when choosing a student from the dropdown', test_id: 1407007, priority: "1" 


      it 'when going back to the assignment', test_id: 1407008, priority: "1" 

    end

    describe 'notice on auto-saving a draft comment' do
      it 'is displayed', test_id: 1407009, priority: "1" 


      it 'can be dismissed', test_id: 1407010, priority: "1" 
    ...
    describe 'draft comment display' do
      ...
      it 'has an asterisk prepended to the comment', test_id: 1407011, priority: "1" 


      it 'has a link to publish a comment for the teacher who is logged in', test_id: 1407012, priority: "1" 
    ...
    describe 'publishing a draft comment' do
      ...
      it 'should increase the number of published comments', test_id: 1407013, priority: "1" 


      it 'replaces the draft comment in the list of comments with a published comment' 
    ...
    describe 'deleting a draft comment' do
      ...
      it 'decreases the number of draft comments' 
