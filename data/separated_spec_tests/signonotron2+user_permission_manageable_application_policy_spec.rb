...
describe UserPermissionManageableApplicationPolicy do
  ...
  describe described_class::Scope do
    ...
    context 'for super organisation admins' do
      ...
      it 'includes applications with delegatable signin that the super organisation admin has access to' 


      it 'does not include applications without delegatable signin that the super organisation admin does has access to' 


      it 'does not include applications that the super organisation admin does not have access to' 
    ...
    context 'for organisation admins' do
      ...
      it 'includes applications with delegatable signin that the organisation admin has access to' 


      it 'does not include applications without delegatable signin that the organisation admin does has access to' 


      it 'does not include applications that the organisation admin does not have access to' 
