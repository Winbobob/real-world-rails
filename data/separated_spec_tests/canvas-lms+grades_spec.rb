...
describe "grades" do
  ...
  context "as a student" do
    ...
    context "rubric criterion ranges disabled" do
      ...
      it "should not highlight scores between ranges when range rating is disabled" 

    end

    context "rubric criterion ranges enabled" do
      it "should highlight scores between ranges when range rating is enabled" 

    end

    it "shows the assessment link when there are assessment ratings with nil points" 
