...
-----END CERTIFICATE-----
      ...
      describe '#authenticate!' do
        ...
        it 'returns true for a valid lambda message' 


        it 'raises when the SigningCertURL is not https' 


        it 'raises when the SigningCertURL is not AWS hosted' 


        it 'raises when the SigningCertURL is not a pem file' 


        it 'raises when the message signature fails validation' 


        it 'caches the pem file' 


        it 'attempts to download the cert 3 times' 


        it 'raises when the signing cert can not be downloaded due to networking erros' 


        it 'raises when the signing cert can not be downloaded' 
      ...
      describe '#authentic?' do
        ...
        it 'returns true if the message can be authenticated' 


        it 'returns false if the message can not be authenticated' 
