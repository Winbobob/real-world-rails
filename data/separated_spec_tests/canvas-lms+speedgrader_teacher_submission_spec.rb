...
describe "speed grader submissions" do
  ...
  context "as a teacher" do
    ...
    context "LTI Plagiarism Platform" do
      ...
      it "displays a pending icon if submission status is pending", priority: "1" 


      it "displays a score if submission has an originality report", priority: "1" 


      it "displays an error icon if submission status is error", priority: "2" 
