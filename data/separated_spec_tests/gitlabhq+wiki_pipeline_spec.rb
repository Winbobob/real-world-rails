...
describe Banzai::Pipeline::WikiPipeline do
      ...
      context test_name do
        ...
        describe "linking to pages within the wiki" do
          ...
          describe "when creating non-hierarchical links" do
            ...
            it 'rewrites non-file links (with spaces) to be at the scope of the wiki root' 
            ...
            it 'rewrites links (with spaces) with anchor' 
  ...
  describe 'videos' do
    ...
    it 'generates video html structure' 


    it 'rewrites and replaces video links names with white spaces to %20' 
