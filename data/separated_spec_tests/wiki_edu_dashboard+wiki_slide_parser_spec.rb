...
describe WikiSlideParser do
  ...
  describe '#title' do
    it 'extracts title from translation-enabled source wikitext' 

    it 'extracts title from translated source wikitext' 

    it 'handles nil input' 

    it 'extracts only the title from variant translation markup formats' 

    it 'extracts the title from translated wikitext with leading whitespace' 

  end

  describe '#content' do
    it 'converts wiki markup to markdown' 

    it 'converts an image template into figure markup' 

    it 'converts multiple image templates into distinct figure markups' 

    it 'converts a video template into iframe markup' 

    it 'includes a forced newline after figure markup' 
  ...
  describe '#quiz' do
    it 'converts a wiki template into a hash representing a quiz' 
