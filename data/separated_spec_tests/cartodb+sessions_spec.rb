...
feature "Sessions" do
  ...
  describe "Organization login" do
    ...
    it 'allows login to organization users' 


    it 'does not allow user+password login to organization users if auth_username_password_enabled is false' 


    it 'does not allow google login to organization users if auth_google_enabled is false' 
    ...
    describe 'ldap login' do
      ...
      it 'does not allow google login to organization users if they have ldap configuration' 
