...
RSpec.describe "/internal/reports", type: :request do
  ...
  describe "POST /save_status" do
    context "when a valid request is made" do
      ...
      it "returns a JSON with an outcome key and Success value" 


      it "updates the status of the feedback message" 
  ...
  describe "POST /send_email" do
    context "when a valid request is made" do
      ...
      it "creates a new email message with the same params" 
  ...
  describe "POST /internal/reports/create_note" do
    context "when a valid request is made" do
      ...
      it "renders the proper JSON response" 


      it "creates a note with the correct params" 
