...
describe Gitlab::ImportExport::ProjectTreeRestorer do
  describe 'restore project tree' do
    ...
    context 'JSON' do
      ...
      it 'pipeline has the correct user ID' 
      ...
      it 'restores issue resource label events' 


      it 'restores merge requests resource label events' 
  ...
  shared_examples 'restores project correctly' do |**results|
    ...
    it 'does not set params that are excluded from import_export settings' 
  ...
  context 'Light JSON' do
    ...
    context 'with clashing milestones on IID' do
      ...
      it 'preserves the project milestone IID' 
