...
describe SystemHooksService do
  ...
  context 'event data' do
    ...
    it 'includes the correct project visibility level' 


    it 'handles nil datetime columns' 


    context 'group_rename' do
      it 'contains old and new path' 


      it 'contains old and new full_path for subgroup' 

    end

    context 'user_rename' do
      it 'contains old and new username' 

    end

    context 'user_failed_login' do
      it 'contains state of user' 
