...
RSpec.describe RuboCop::Cop::Layout::AlignHash, :config do
  ...
  context 'with default configuration' do
    ...
    it 'accepts left-aligned hash keys with single spaces' 


    it 'registers an offense for zero or multiple spaces' 


    it 'registers an offense for separator alignment' 


    it 'registers an offense for table alignment' 


    it 'registers an offense when multiline value starts in wrong place' 


    it 'does not register an offense when value starts on next line' 
