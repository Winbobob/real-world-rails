...
describe NotificationService, :mailer do
    ...
    context 'issue note' do
      ...
      describe 'new note on issue in project that belongs to a group' do
        ...
        context 'which is a subgroup', :nested_groups do
          ...
          it 'overrides child objects with global level' 
  ...
  describe 'Merge Requests' do
    ...
    describe '#merge_request_unmergeable' do
      it "sends email to merge request author" 
      ...
      describe 'when merge_when_pipeline_succeeds is true' do
        ...
        it "sends email to merge request author and merge_user" 
  ...
  describe 'GroupMember' do
    ...
    describe '#new_access_request' do
      ...
      it 'sends notification to group owners_and_maintainers' 
  ...
  describe 'ProjectMember' do
    ...
    describe '#new_access_request' do
      context 'for a project in a user namespace' do
        ...
        it 'sends notification to project owners_and_maintainers' 
  ...
  describe 'Pages domains' do
    ...
    %i[
      ...
      describe "##{sym}" do
        ...
        it 'emails current watching maintainers' 
  ...
  context 'Auto DevOps notifications' do
    describe '#autodevops_disabled' do
      ...
      it 'emails project owner and user that triggered the pipeline' 
