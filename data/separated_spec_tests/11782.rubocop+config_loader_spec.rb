...
RSpec.describe RuboCop::ConfigLoader do
  ...
  describe '.configuration_from_file', :isolated_environment do
    ...
    context 'when inherit_mode is set to merge for Exclude' do
      ...
      it 'merges AllCops:Exclude with the default configuration' 


      it 'merges Rails/Exit:Exclude with parent and default configuration' 


      it 'overrides Rails/Exit:Include' 
