...
describe Projects::UpdateRemoteMirrorService do
  ...
  describe "#execute", :skip_gitaly_mock do
    ...
    it "fetches the remote repository" 
    ...
    describe 'Syncing branches' do
      it "push all the branches the first time" 


      it "does not push anything is remote is up to date" 


      it "sync new branches" 


      it "sync updated branches" 
      ...
      context 'when push only protected branches option is set' do
        ...
        it "sync updated protected branches" 


        it 'does not sync unprotected branches' 
      ...
      describe 'for delete' do
        context 'when branch exists in local and remote repo' do
          it 'deletes the branch from remote repo' 
        ...
        context 'when push only protected branches option is set' do
          ...
          context 'when branch exists in local and remote repo' do
            ...
            it 'deletes the protected branch from remote repo' 


            it 'does not delete the unprotected branch from remote repo' 
          ...
          context 'when branch only exists on remote repo' do
            ...
            context 'when it has diverged' do
              it 'does not delete the remote branch' 
