...
describe CourseMeetingsManager do
  ...
  describe '#week_meeting_dates' do
    ...
    context 'course with timeline start and end' do
      it 'returns an array of meetings dates for each week, factoring in blackout dates' 
  ...
  describe '#week_meetings' do
    ...
    context 'course with timeline start and end' do
      it 'returns an array of day meetings for each week, factoring in blackout dates' 
    ...
    context 'course with no week days, but with day exceptions' do
      ...
      it 'returns the day exceptions, week by week' 
  ...
  describe '#day_meetings' do
    ...
    it 'returns an array of symbols reprensenting the course meeting days' 
  ...
  describe '#calculate_timeline_week_count' do
    ...
    context 'course has start and end dates' do
      it 'returns an integer representing the weeks in the timeline, irrespective of blackouts' 
  ...
  describe '#all_potential_meetings' do
    ...
    it 'returns an array of all days the course would have met, irrespective of blackouts' 
  ...
  describe '#open_weeks' do
    ...
    context 'course has timeline start/end' do
      it 'returns an int representing the weeks the timeline can accomodate' 
  ...
  describe '#meeting_dates_of' do
    ...
    context 'for a week with meetings' do
      ...
      it 'returns the dates of meetings that week' 
  ...
  describe '#weeks_before_timeline' do
    ...
    it 'works for exactly two weeks between start and timeline start' 
