...
describe SIS::UserImporter do
  context "when the unique_id is invalid the error message reported to the user" do
    ...
    it 'must include the login_id' 


    it 'must include the user_id field' 


    it 'must include the text "Invalid login_id"' 

  end

  it 'should handle user_ids as integers just in case' 
