...
describe Gitlab::GitalyClient::OperationService do
  ...
  describe '#user_create_branch' do
    ...
    it 'sends a user_create_branch message and returns a Gitlab::git::Branch' 
    ...
    context "when pre_receive_error is present" do
      ...
      it "throws a PreReceive exception" 
  ...
  describe '#user_update_branch' do
    ...
    it 'sends a user_update_branch message' 
  ...
  describe '#user_delete_branch' do
    ...
    it 'sends a user_delete_branch message' 
  ...
  describe '#user_ff_branch' do
    ...
    it 'sends a user_ff_branch message and returns a BranchUpdate object' 
  ...
  describe '#user_squash' do
    ...
    it 'sends a user_squash message and returns the squash sha' 
    ...
    context "when git_error is present" do
      ...
      it "raises a GitError exception" 
