...
describe "authentication_providers/index" do
  ...
  it "should list the auth ips" 


  it "should display the last_timeout_failure" 


  it "should display more than 2 LDAP configs" 


  it "doesn't display delete button for the config the current user logged in with" 
