  ...
  describe 'rules' do
    describe 'rules for protected ref' do
      ...
      context 'when no one can push or merge to the branch' do
        ...
        it 'does not include ability to play pipeline schedule' 
      ...
      context 'when no one can create the tag but it is not a tag' do
        ...
        it 'includes ability to play pipeline schedule' 
    ...
    describe 'rules for owner of schedule' do
      ...
      it 'includes abilities to do do all operations on pipeline schedule' 
    ...
    describe 'rules for non-owner of schedule' do
      ...
      it 'includes abilities to take ownership' 
