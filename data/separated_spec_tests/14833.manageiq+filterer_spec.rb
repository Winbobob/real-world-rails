describe Rbac::Filterer do
  describe "using expressions as managed filters" do
    ...
    it "doesn't filter by tags on classes that are not taggable" 
  ...
  describe ".search" do
    ...
    context 'with tags' do
      ...
      context 'searching for instances of Switches' do
        ...
        it 'lists only tagged Switches' 


        it 'lists only all Switches' 
      ...
      it "tag entitled playbook with no tagged authentications" 


      it "tag entitled ansible authentications without a playbook for it" 
      ...
      context "with :include_for_find" do
        ...
        context "with a references based where_clause" do
          ...
          context "and targets is a NullRelation scope" do
            ...
            it "will not try to skip references" 
    ...
    describe "with find_options_for_tenant filtering" do
      ...
      context "with accessible_tenant_ids filtering (strategy = :descendants_id) through" do
        it "can see their own request in the same tenant" 


        it "a child tenant user in a group with tag filters can see their own request" 


        it "can see other's request in the same tenant" 


        it "can't see parent tenant's request" 


        it "can see descendant tenant's request" 
      ...
      context "tenant access strategy VMs and Templates" do
        ...
        context "searching CloudTemplate" do
          ...
          context "when tenant is not mapped to cloud tenant" do
            it 'returns all cloud templates when user is admin' 
            ...
            context "when user is restricted user" do
              ...
              it "returns all public cloud templates" 
          ...
          context "when tenant is mapped to cloud tenant" do
            ...
            it "finds tenant's private cloud templates" 


            it "finds tenant's private and public cloud templates" 


            it "ignores other tenant's private templates" 


            it "finds other tenant's public templates" 
  ...
  context "common setup" do
    ...
    context "with User and Group" do
      ...
      context 'with EvmRole-tenant_administrator' do
        ...
        it 'can see all roles except for EvmRole-super_administrator' 


        it 'can see all groups except for group with role EvmRole-super_administrator' 


        it 'can see all groups in the current tenant only' 
        ...
        it 'can see all users except for user with group with role EvmRole-super_administrator' 
