...
describe CalendarEventsApiController, type: :request do
  ...
  context 'events' do
    ...
    it "should not allow user to create calendar events" 
    ...
    it 'should not update event if all_day, start_at, and end_at are provided in a request' 
  ...
  context "calendar feed" do
    ...
    it "should include the appointment details in the teachers export" 


    it "should not expose details of other students appts to a student" 
