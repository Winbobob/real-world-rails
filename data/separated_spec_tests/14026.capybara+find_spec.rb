...
Capybara::SpecHelper.spec '#find' do
  ...
  context 'with custom selector with custom filter' do
    ...
    it 'should not raise an ElementNotFound error from in a filter' 
  ...
  context 'with Capybara.test_id' do
    it 'should not match on it when nil' 


    it 'should work with the attribute set to `data-test-id` attribute' 


    it 'should use a different attribute if set' 
