require File.expand_path(File.dirname(__FILE__) + '/test_helper')
  ...
  describe "Webmock" do
    ...
    it "should update assertions count" 


    it "should raise error on non stubbed request" 


    it "should verify that expected request occured" 


    it "should verify that expected http stub occured" 


    it "should verify that expected https stub occured" 
