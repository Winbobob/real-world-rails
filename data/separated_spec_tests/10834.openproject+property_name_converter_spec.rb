...
describe ::API::Utilities::PropertyNameConverter do
  describe '#from_ar_name' do
    ...
    it 'stringifies attribute names' 
    ...
    context 'custom fields' do
      ...
      it 'converts short custom fields to their long form' 
    ...
    context 'special replacements' do
      ...
      it 'performs special replacements' 


      context 'foreign keys' do
        let(:attribute_name) { :assigned_to_id }

        it 'sanitizes id-suffix before replacement lookup' 
  ...
  describe '#to_ar_name' do
    ...
    it 'snake_cases attribute names' 


    context 'foreign keys' do
      let(:attribute_name) { 'status' }

      it 'does not add an id suffix by default' 
    ...
    context 'custom fields' do
      ...
      it 'converts long custom fields to their short form' 
    ...
    context 'special replacements' do
      ...
      context 'foreign keys' do
        ...
        it 'correctly appends the id suffix' 
      ...
      context 'inappropriate replacement as context does not respond to it with foreign key' do
        ...
        it 'does not take the special replacement but appends the id suffix' 
