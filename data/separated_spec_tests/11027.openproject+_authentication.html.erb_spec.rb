...
describe 'settings/_authentication', type: :view do
  context 'with password login enabled' do
    ...
    it 'shows automated user blocking options' 
  ...
  context 'with password login disabled' do
    ...
    it 'does not show password settings' 


    it 'does not show automated user blocking options' 
  ...
  context 'with no registration_footer configured' do
    ...
    it 'shows the registration footer textfield' 
  ...
  context 'with registration_footer configured' do
    ...
    it 'does not show the registration footer textfield' 
