...
describe Hashie::Mash do
  ...
  context 'updating' do
    ...
    describe '#deep_update' do
      ...
      it 'does not raise an exception when default_proc raises an error' 
  ...
  context '#initialize' do
    ...
    it 'allows propagation of a default block' 
  ...
  describe '.load(filename, options = {})' do
    ...
    context 'when the file has aliases in it' do
      it 'can use the aliases and does not raise an error' 
