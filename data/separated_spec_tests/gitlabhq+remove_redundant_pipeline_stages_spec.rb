...
describe RemoveRedundantPipelineStages, :migration do
  ...
  it 'removes ambiguous stages and preserves builds' 


  it 'retries when incorrectly added index exception is caught' 


  it 'does not retry when unknown exception is being raised' 
