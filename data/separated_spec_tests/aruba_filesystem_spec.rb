...
RSpec.describe Aruba::Api::Filesystem do
  ...
  context '#write_fixed_size_file' do
    it "should write a fixed sized file" 


    it "works with ~ in path name" 
  ...
  context "#with_file_content" do
    ...
    it "checks the given file's full content against the expectations in the passed block" 
    ...
    context "checking the file's content against the expectations in the block" do
      it "is successful when the inner expectations match" 


      it "raises RSpec::Expectations::ExpectationNotMetError when the inner expectations don't match" 
