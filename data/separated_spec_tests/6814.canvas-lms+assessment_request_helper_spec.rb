...
describe AssessmentRequestHelper do
  ...
  describe 'submission_author_name_for' do
    ...
    it 'should return assessment user name' 


    it 'should return assessment user name for assessor when anonymous reviews are disabled' 


    it 'should return assessment user name when anonymous reviews are enabled and user has permission' 


    it 'should return anonymous user when anonymous peer reviews are enabled' 
