...
describe EnrollmentsApiController, type: :request do
  describe "enrollment creation" do
    ...
    context "self enrollment" do
      ...
      it "should not allow self-enrollment in a concluded course" 
  ...
  describe "enrollment listing" do
    ...
    describe "sharding" do
      ...
      context "when scoped by a user" do
        it "returns enrollments from all of the current user's associated shards" 


        it "returns enrollments from all of another user's associated shards" 
