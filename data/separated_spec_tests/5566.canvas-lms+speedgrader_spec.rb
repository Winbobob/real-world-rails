...
describe 'Speedgrader' do
  ...
  context 'grading' do
    ...
    context 'quizzes' do
      ...
      it "page should load in acceptable time ", priority:"1" 
    ...
    context 'Using a rubric' do
      ...
      it "properly shows the view longer description link" 
    ...
    context 'rubric with points removed' do
      ...
      it 'can be viewed on speedgrader' 


      it 'does not show points in rating tiers' 
      ...
      context 'saving rubric ratings' do
        ...
        it 'saves the correct ratings on speedgrader' 


        it 'saves the correct ratings on student grades page' 
  ...
  context 'speedgrader nav bar' do
    ...
    it 'navigates to gradebook via link' 
  ...
  context "mute/unmute dialogs" do
    ...
    it "shows dialog when attempting to mute and mutes" 


    it "shows dialog when attempting to unmute and unmutes" 
