...
describe UsersController, type: :controller do
  ...
  describe 'GET new' do
    context "with user limit reached" do
      ...
      context "with fail fast" do
        ...
        it "shows a user limit error" 


        it "redirects back to the user index" 
      ...
      context "without fail fast" do
        ...
        it "shows a user limit warning" 


        it "shows the new user page" 
  ...
  describe 'POST resend_invitation' do
    ...
    context 'with admin rights' do
      ...
      it 'redirects back to the edit user page' 


      it 'sends another activation email' 
  ...
  describe '#change_status',
    ...
    describe 'WHEN activating a registered user' do
      ...
      it 'should send an email to the correct user in the correct language' 


      context "with user limit reached" do
        let(:user_limit_reached) { true }

        it "shows the user limit reached error and recommends to upgrade" 
  ...
  describe 'index' do
    describe 'with session lifetime' do
      ...
      shared_examples_for 'index action with disabled session lifetime or inactivity not exceeded' do
        it "doesn't logout the user and renders the index action" 

      end

      shared_examples_for 'index action with enabled session lifetime and inactivity exceeded' do
        it 'logs out the user and redirects with a warning that he has been locked out' 
  ...
  describe 'update' do
    context 'fields' do
      ...
      it 'should be assigned their new values' 
    ...
    context 'with external authentication' do
      ...
      it 'should ignore setting force_password_change' 
    ...
    context 'ldap auth source' do
      ...
      it 'switchting to internal authentication on a password change' 
    ...
    context 'with disabled_password_choice' do
      ...
      it 'ignores password parameters and leaves the password unchanged' 
  ...
  describe 'show' do
    ...
    describe 'for user with Activity' do
      ...
      it 'should include the number of reported work packages' 


      it 'should have @events_by_day grouped by day' 


      it 'should have more than one event for today' 
