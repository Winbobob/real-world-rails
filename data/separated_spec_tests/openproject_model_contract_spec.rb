...
describe ModelContract do
  ...
  describe 'child' do
    ...
    it 'should collect its own writable attributes' 


    it 'should collect its own attribute validations' 
  ...
  describe 'grand_child' do
    ...
    it 'should consider its ancestor writable attributes' 


    it 'should not contain the same attribute twice, but also has the _id variant' 


    it 'should execute all the validations' 
