...
describe "reply attachment" do
  ...
  it "should allow reply after cancel" 


  it "should reply to the discussion with attachment" 


  it "should delete the attachment from the reply" 


  it 'media attachment modal can be opened' 
