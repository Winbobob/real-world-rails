...
describe Admin::PagesController, type: :controller do
  ...
  describe 'POST #create' do
    context 'should create a new page' do
      ...
      it 'should create a published page with a redirect' 


      it 'should create an unpublished page without a redirect' 


      it 'should create a page published in the future without a redirect' 
