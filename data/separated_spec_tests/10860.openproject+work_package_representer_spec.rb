  ...
  context 'generation' do
    ...
    describe '_links' do
      ...
      describe 'attachments' do
        ...
        it 'embeds the attachments as collection' 
        ...
        it 'addAttachments is a post link' 
      ...
      context 'when the user is not watching the work package' do
        it 'should have a link to watch' 


        it 'should not have a link to unwatch' 
      ...
      context 'when the user is watching the work package' do
        ...
        it 'should have a link to unwatch' 


        it 'should not have a link to watch' 

      end

      context 'when the user has permission to add comments' do
        it 'should have a link to add comment' 
      ...
      context 'when the user does not have the permission to add comments' do
        ...
        it 'should not have a link to add comment' 

      end

      context 'when the user has the permission to add and remove watchers' do
        it 'should have a link to add watcher' 


        it 'should have a link to remove watcher' 
      ...
      context 'when the user does not have the permission to add watchers' do
        ...
        it 'should not have a link to add watcher' 
      ...
      context 'when the user does not have the permission to remove watchers' do
        ...
        it 'should not have a link to remove watcher' 
      ...
      describe 'watchers link' do
        context 'when the user is allowed to see watchers' do
          ...
          it 'embeds the watchers as collection' 
      ...
      describe 'relations' do
        ...
        context 'when the user has the permission to manage relations' do
          it 'should have a link to add relation' 
        ...
        context 'when the user does not have the permission to manage relations' do
          ...
          it 'should not have a link to add relation' 

        end
      end

      context 'when the user has the permission to add work packages' do
        it 'should have a link to add child' 
      ...
      context 'when the user does not have the permission to add work packages' do
        ...
        it 'should not have a link to add child' 
      ...
      context 'when the user does not have the permission to view time entries' do
        ...
        it 'should not have a link to timeEntries' 
      ...
      describe 'linked relations' do
        ...
        context 'ancestors' do
          ...
          context 'when ancestors are visible' do
            ...
            it 'renders two items in ancestors' 
      ...
      describe 'customActions' do
        it 'has a collection of customActions' 
    ...
    describe '_embedded' do
      ...
      describe 'relations' do
        ...
        it 'embeds a collection' 


        it 'embeds with an href containing the work_package' 


        it 'embeds the visible relations' 

      end

      describe 'customActions' do
        it 'has an array of customActions' 
    ...
    describe 'caching' do
      ...
      describe '#json_cache_key' do
        ...
        it 'changes when the feeds_enabled? setting is switched' 


        it 'changes when the work_package_done_ratio setting is changes' 


        it 'changes when the work_package is updated' 


        it 'factors in the eager loaded cache_checksum' 
