describe TaskHelpers::Exports::CustomizationTemplates do
  ...
  describe "when --all is not specified" do
    ...
    it 'exports user customization templates to a given directory with unique filenames' 
  ...
  describe "when --all is specified" do
    ...
    it 'exports all provision dialogs to a given directory with unique filenames' 
