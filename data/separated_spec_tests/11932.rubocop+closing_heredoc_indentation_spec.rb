...
RSpec.describe RuboCop::Cop::Layout::ClosingHeredocIndentation do
  ...
  it 'accepts correctly indented closing heredoc' 
  ...
  it 'registers an offense for bad indentation of a closing heredoc' 


  it 'registers an offense for incorrectly indented empty heredocs' 


  it 'does not register an offense for correctly indented empty heredocs' 


  it 'does not register an offense for a << heredoc' 
