...
describe DataAccessController do
  describe "GET options" do
    ...
    context 'when requesting options for a collection with no matching granules' do
      ...
      it "returns 0 granule hits" 


      it "returns an empty list of available methods" 
    ...
    context 'when requesting options for a collection with matching granules' do
      ...
      it "returns a response containing the number of matching granules" 


      context 'whose granules are downloadable' do
        let(:downloadable) { 1 }

        it 'returns a response containing a "Download" access method' 
        ...
        context 'when there are more than 150 matching granules' do
          ...
          context 'and all are downloadable' do
            ...
            it 'indicates that all matching granules are downloadable' 


            it 'gives a count equal to the granule hits' 
          ...
          context 'and not all are downloadable' do
            ...
            it 'indicates that not all matching granules are downloadable' 


            it 'gives an estimated count produced by the percentage of downloadable granules found' 
        ...
        context 'when there are fewer than 150 matching granules' do
          ...
          context 'and not all are downloadable' do
            ...
            it 'gives a count equal to the exact number of downloadable granules' 
      ...
      context 'whose granules are not downloadable' do
        ...
        it 'does not return "Download" as an access method' 
      ...
      context 'whose granules have order options' do
        ...
        it 'returns a response containing access methods for each option' 


        it 'retrieves and returns the corresponding form for each option' 
        ...
        context 'when there are more than 150 matching granules' do
          ...
          context 'and all have a given order option' do
            let(:orderable) { 150 }
            it 'indicates that all matching granules have the order option' 
          ...
          context 'and not all have a given order option' do
            let(:orderable) { 75 }
            it 'indicates that not all matching granules have the order option' 


            it 'gives an estimated count produced by the percentage of granules found with the given order option' 
        ...
        context 'when there are fewer than 150 matching granules' do
          ...
          context 'and not all have a given order option' do
            ...
            it 'gives a count equal to the exact number of granules with the given order option' 
      ...
      context 'whose granules have no order options' do
        ...
        it 'does not return any order option access methods' 
      ...
      context 'whose collection is serviceable' do
        ...
        it 'returns a response containing a service access method' 
      ...
      context 'whose collection is not serviceable' do
        ...
        it 'does not return and service access methods' 
      ...
      context 'whose granules are downloadable and have order options' do
        ...
        it 'returns a response containing a download access method followed by access methods for each option' 
      ...
      context 'whose granules have size information' do
        ...
        context 'when the aggregate size is smaller than 1024 bytes' do
          ...
          it 'returns the aggregate size expressed in bytes' 


          it 'returns a size unit of "Bytes"' 
        ...
        context 'when the aggregate size is between 1KB and 1MB' do
          ...
          it 'returns the aggregate size expressed in kilobytes' 


          it 'returns a size unit of "Kilobytes"' 
        ...
        context 'when the aggregate size is between 1MB and 1GB' do
          ...
          it 'returns the aggregate size expressed in megabytes' 


          it 'returns a size unit of "Megabytes"' 
        ...
        context 'when the aggregate size is between 1GB and 1TB' do
          ...
          it 'returns the aggregate size expressed in gigabytes' 


          it 'returns a size unit of "Gigabytes"' 
        ...
        context 'when the aggregate size is between 1TB and 1PB' do
          ...
          it 'returns the aggregate size expressed in terabytes' 


          it 'returns a size unit of "Terabytes"' 
        ...
        context 'when the aggregate size is between 1PB and 1EB' do
          ...
          it 'returns the aggregate size expressed in petabytes' 


          it 'returns a size unit of "Petabytes"' 
        ...
        context 'when the aggregate size is greater than 1EB' do
          ...
          it 'returns the aggregate size expressed in exabytes' 


          it 'returns a size unit of "Exabytes"' 
        ...
        context 'when there are more than 150 matching granules' do
          ...
          it 'estimates size based on the average size of the matching granules' 
