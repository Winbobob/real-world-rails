...
RSpec.describe Bundler do
  ...
  describe "#mkdir_p" do
    it "creates a folder at the given path" 


    context "when mkdir_p requires sudo" do
      it "creates a new folder using sudo" 

    end

    context "with :no_sudo option" do
      it "forces mkdir_p to not use sudo" 
  ...
  describe "#user_home" do
    context "home directory is set" do
      ...
      context "is not a directory" do
        it "should issue a warning and return a temporary user home" 
  ...
  describe "#requires_sudo?" do
    ...
    context "writable paths" do
      it "should return false and display nothing" 
    ...
    context "unwritable paths" do
      ...
      it "should return true and display warn message" 
