...
describe WorkPackages::UpdateAncestorsService, type: :model do
  ...
  context 'for the new ancestor chain' do
    shared_examples 'attributes of parent having children' do
      ...
      it 'updated one work package - the parent' 


      it 'has the expected aggregate done ratio' 


      it 'has the expected estimated_hours' 
  ...
  context 'for the previous ancestors' do
    ...
    it 'returns the former ancestors in the dependent results' 


    it 'updates the done_ratio of the former parent' 


    it 'updates the estimated_hours of the former parent' 


    it 'updates the done_ratio of the former grandparent' 


    it 'updates the estimated_hours of the former grandparent' 
  ...
  context 'for new ancestors' do
    ...
    it 'returns the new ancestors in the dependent results' 


    it 'updates the done_ratio of the new parent' 


    it 'updates the estimated_hours of the new parent' 


    it 'updates the done_ratio of the new grandparent' 


    it 'updates the estimated_hours of the new grandparent' 
