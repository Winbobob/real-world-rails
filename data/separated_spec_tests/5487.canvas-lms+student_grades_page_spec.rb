...
describe "gradebook - logged in as a student" do
  ...
  describe 'total point displays' do
    ...
    it 'should display total "out of" point values' 
  ...
  describe 'grade-only assignment' do
    ...
    it 'does not show point/percentage on student grades page' 


    it 'shows total grade not as points' 


    it 'does not calculate into total points' 
