describe LicenseChecklist do
  describe '#add' do
    ...
    context 'HMO licence applied for' do 
      ...
      it 'should add the section 2 text when section 2 is chosen' 


      it 'should add the section 3 text when section 3 chosen' 
    ...
    context 'HMO licence held' do
      it 'should not add anything when section 2 is chosen' 


      it 'should not add anything when section 3 is chosen' 
