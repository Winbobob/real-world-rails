...
describe SetLocalizationService do
  ...
  shared_examples_for "falls back to the instane's default language" do
    it "falls back to the instance's default language" 

  end

  context 'for a logged in user' do
    it "sets the language to the user's selected language" 
    ...
    context 'with a language prefix being valid' do
      ...
      it "sets the language to the valid prefix of the user's selected language" 
    ...
    context 'with the language not being valid' do
      ...
      context 'with a language prefix being valid' do
        ...
        it "sets the language to the valid prefix of the accept header" 
