...
describe 'Late Policies:' do
  ...
  context 'when applied' do
    ...
    it 'late policy adjusts grades correctly', test_id: 3196973, priority: '1' 


    it 'missing policy adjusts grades correctly', test_id: 3196972, priority: '1' 


    it 'late policy with floor adjust the grades correctly', test_id: 3196974, priority: '1' 


    it 'missing/late deductions dont affect paper assignments', test_id: 3354104, priority: '1' 


    it 'missing policy adjusts pass/fail assignment', test_id: 3354099, priority: '1' 


    it 'late & missing policy wont affect no-submission assignment', test_id: 3354106, priority: '2' 


    it 'late penalty re-applied if submission graded same as its effective grade', test_id: 3354105, priority: '2' 


    it 'updates score when late policy changes', test_id: 3354108, priority: '1' 


    it 'once applied, missing policy change does not re-trigger score change', test_id: 3354107, priority: '2' 
  ...
  context 'when created' do
    ...
    it 'saves late policy', test_id: 3196970, priority: '1' 


    it 'saves missing policy', test_id: 3196968, priority: '1' 


    it 'saves late policy with floor', test_id: 3196971, priority: '1' 
