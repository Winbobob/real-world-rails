...
describe DataFixup::FixupGroupOriginalityReports do
  ...
  it 'creates an originality report for each other submission in the group' 


  it 'propagates originality reports to all group submissions' 


  it 'does not create originality reports for submissions outside of the group' 
