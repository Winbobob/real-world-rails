...
RSpec.describe RuboCop::Cop::Style::NegatedIf do
  ...
  describe 'with “prefix” style' do
    ...
    it 'registers an offense for prefix' 


    it 'does not register an offense for postfix' 
  ...
  describe 'with “postfix” style' do
    ...
    it 'registers an offense for postfix' 


    it 'does not register an offense for prefix' 
