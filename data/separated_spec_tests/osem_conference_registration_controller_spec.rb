  ...
  context 'user is signed in' do
    ...
    describe 'GET #show' do
      ...
      context 'user has purchased a ticket' do
        ...
        it 'does not assign price of purchased tickets to total_price and purchased tickets to tickets without payment' 
      ...
      context 'user has not purchased any ticket' do
        ...
        it 'assigns 0 dollars to total_price and empty array to tickets variables' 
    ...
    describe 'GET #edit' do
      ...
      it 'assigns conference and registration variable' 
    ...
    describe 'PATCH #update' do
      ...
      context 'updates successfully' do
        ...
        it 'redirects to registration show path' 


        it 'shows success message in flash notice' 


        it 'updates the registration' 
      ...
      context 'update fails' do
        ...
        it 'does not update the registration' 
    ...
    describe 'DELETE #destroy' do
      ...
      context 'delete fails' do
        ...
        it 'does not delete the registration' 
