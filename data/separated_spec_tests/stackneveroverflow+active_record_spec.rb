    ...
    describe '[ActiveRecord orm adapter]' do
      ...
      describe "#conditions_to_fields" do
        describe "with non-standard association keys" do
          ...
          it "should convert polymorphic object in conditions to the appropriate fields" 


          it "should convert belongs_to object in conditions to the appropriate fields" 
