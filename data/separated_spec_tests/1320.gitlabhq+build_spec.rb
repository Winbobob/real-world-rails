...
describe Gitlab::Ci::Pipeline::Seed::Build do
  ...
  describe '#attributes' do
    it 'returns hash attributes of a build' 

  end

  describe '#to_resource' do
    it 'returns a valid build resource' 


    it 'memoizes a resource object' 


    it 'can not be persisted without explicit assignment' 
