...
RSpec.describe SessionsController, type: :controller, skip: true do
  ...
  describe 'tracking code' do
    it 'applies the exsiting tracking code to a on sign in' 


    it 'updates the tracking code even if the user isnt logged in' 


    it 'updates the tracking code to the one already setup for a user' 


    it 'creates a tracking code when one doesnt exist' 
  ...
  describe 'github' do
    ...
    it 'redirects user to profile when they already have account' 


    it 'logs oauth response if it is an unexpected structure' 


    it 'sets up a new user and redirects to signup page' 


    it 'redirects back to settings page if user is already signed in' 
  ...
  describe 'twitter' do
    ...
    it 'does not override a users about if its already set' 


    it 'attempting to link an account already used should notify user' 


    it 'successful linking of an account should redirect to settings page' 
