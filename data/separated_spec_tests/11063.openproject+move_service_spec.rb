...
describe WorkPackages::MoveService, type: :model do
  ...
  context 'when copying' do
    ...
    it 'calls the copy service and merges its result' 
    ...
    context 'for a parent' do
      ...
      it 'calls the copy service twice and merges its result' 
  ...
  context 'when moving' do
    ...
    it 'calls the update service and returns its result' 
