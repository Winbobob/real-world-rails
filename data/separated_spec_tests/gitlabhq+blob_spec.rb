...
describe Gitlab::Git::Blob, :seed_helper do
  ...
  describe '.find' do
    ...
    context 'six submodule' do
      ...
      it 'does not get messed up by load_all_data!' 


      it 'does not mark the blob as binary' 
    ...
    context 'large file' do
      ...
      it 'check that this test is sane' 


      it 'can load all data' 


      it 'marks the blob as binary' 
  ...
  shared_examples 'finding blobs by ID' do
    ...
    context 'large file' do
      it 'limits the size of a large file' 
  ...
  describe '.batch' do
    ...
    context 'limiting' do
      ...
      context 'negative' do
        ...
        it 'ignores MAX_DATA_DISPLAY_SIZE' 
  ...
  describe '.batch_metadata' do
    ...
    it 'returns an empty data attribute' 
  ...
  describe '.batch_lfs_pointers' do
    ...
    it 'returns a list of Gitlab::Git::Blob' 


    it 'accepts blob IDs as a lazy enumerator' 


    it 'handles empty list of IDs gracefully' 


    it 'silently ignores tree objects' 


    it 'silently ignores non lfs objects' 


    it 'avoids loading large blobs into memory' 
