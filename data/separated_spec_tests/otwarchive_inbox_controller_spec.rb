...
describe InboxController do
  ...
  describe "GET #show" do
    it "redirects to user page when not logged in" 


    it "redirects to user page when logged in as another user" 
  ...
  describe "PUT #update" do
    ...
    context "with no comments selected" do
      it "redirects to inbox with caution" 


      it "redirects to the previously viewed page if HTTP_REFERER is set" 
