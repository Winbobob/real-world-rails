...
describe 'creating a quiz' do
  ...
  context "post to sis default setting" do
    ...
    it "should default to post grades if account setting is enabled" 


    it "should not default to post grades if account setting is not enabled" 
    ...
    describe 'upon save' do
      ...
      it 'should block with only overrides' 
      ...
      context 'with due dates' do
        ...
        describe 'and differentiated' do
          it 'should not block with base due date and override' 
      ...
      context 'without due dates' do
        ...
        it 'should block with base set with override not' 
