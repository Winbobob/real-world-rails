  ...
  describe '.parse' do
    context 'HEX format' do
      [
        ...
        it "parses the valid hex color #{color}" 
      ...
      [
        ...
        it "does not parse the invalid hex color #{color}" 
    ...
    context 'RGB format' do
      [
        ...
        it "parses the valid rgb color #{color}" 
      ...
      [
        ...
        it "does not parse the invalid rgb color #{color}" 
    ...
    context 'HSL format' do
      [
        ...
        it "parses the valid hsl color #{color}" 
      ...
      [
        ...
        it "does not parse the invalid hsl color #{color}" 
