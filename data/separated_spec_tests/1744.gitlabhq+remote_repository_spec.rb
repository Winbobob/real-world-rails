...
describe Gitlab::Git::RemoteRepository, :seed_helper do
  ...
  describe '#commit_id' do
    it 'returns an OID if the revision exists' 


    it 'is nil when the revision does not exist' 
  ...
  describe '#fetch_env' do
    ...
    it 'creates a plausible GIT_SSH_COMMAND' 


    it 'creates a plausible GITALY_PAYLOAD' 
