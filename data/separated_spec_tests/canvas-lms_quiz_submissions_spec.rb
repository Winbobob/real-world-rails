...
describe Quizzes::QuizSubmissionsController do
  ...
  describe "record_answer / backup" do
    it "shouldn't allow overwriting answers for cant_go_back" 


    it "should allow overwriting answers otherwise" 


    it "should redirect back to take quiz if the user loses connection" 
  ...
  describe "submit quiz" do
    it "doesn't allow overwriting answers for cant_go_back" 


    it "allows overwriting answers otherwise" 


    context "with a symbol in an answer" do
      it "should mark the answer as correct" 
