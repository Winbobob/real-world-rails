...
RSpec.describe MailMarketingUsersController, type: :controller do
  describe '#subscribe' do
    ...
    context 'when email is on user database' do
      ...
      it 'should insert mail_marketing_users to user' 


      it 'should subscribe and redirect back' 
    ...
    context 'when email is not in user database' do
      ...
      it "should subscribe only on sendgrid" 
  ...
  describe '#unsubscribe' do
    ...
    context 'with valid token' do
      ...
      it 'should delete mail marketing user' 
