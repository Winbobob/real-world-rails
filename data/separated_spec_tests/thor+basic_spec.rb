...
describe Thor::Shell::Basic do
  ...
  describe "#file_collision" do
    ...
    describe "when a block is given" do
      it "displays diff and merge options to the user" 


      it "invokes the diff command" 


      it "invokes the merge tool" 


      it "invokes the merge tool that specified at ENV['THOR_MERGE']" 


      it "show warning if user chooses merge but merge tool is not specified" 
