...
describe NamespaceFileUploader do
  ...
  context '.base_dir' do
    it 'returns local storage base_dir without store param' 


    it 'returns local storage base_dir when store param is Store::LOCAL' 


    it 'returns remote base_dir when store param is Store::REMOTE' 

  end

  describe '#workhorse_local_upload_path' do
    it 'returns the correct path in uploads directory' 
