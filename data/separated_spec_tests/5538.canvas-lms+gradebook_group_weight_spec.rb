...
describe "group weights" do
  ...
  it 'should show total column as points' 


  it 'should show total column as percent' 
  ...
  context "warning message" do
    ...
    it 'should not display triangle warnings if an assignment is muted in both header and total column' 


    it 'should display triangle warnings if an assignment is unmuted in both header and total column' 
