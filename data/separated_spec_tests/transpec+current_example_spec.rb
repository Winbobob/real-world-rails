      ...
      describe '#convert!' do
        ...
        (RSpecDSL::EXAMPLE_METHODS + RSpecDSL::HOOK_METHODS).each do |method|
          context "with expression `#{method} do example end`" do
            ...
            it "converts to `#{method} do |example| example end` form" 


            it "adds record `#{method} { example }` -> `#{method} { |example| example }`" 
        ...
        RSpecDSL::HELPER_METHODS.each do |method|
          context "with expression `#{method}(:name) do example end`" do
            ...
            it "converts to `#{method}(:name) do |example| example end` form" 


            it "adds record `#{method}(:name) { example }` -> `#{method}(:name) { |example| example }`" 
        ...
        context 'with expression `after { example }`' do
          ...
          it 'converts to `after { |example| example }` form' 
        ...
        context 'with expression `after do running_example end`' do
          ...
          it 'converts to `after do |example| example end` form' 
        ...
        context 'with expression `around do |ex| example end`' do
          ...
          it 'converts to `around do |ex| ex end` form' 
        ...
        context 'with expression `def helper_method example; end`' do
          ...
          it 'converts to `def helper_method RSpec.current_example; end` form' 


          it 'adds record `def helper_method example; end` -> `def helper_method RSpec.current_example; end`' 
