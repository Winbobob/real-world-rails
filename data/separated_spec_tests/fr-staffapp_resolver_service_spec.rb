...
describe ResolverService do
  ...
  describe '#complete' do
    ...
    shared_examples 'application, evidence check or part payment completed' do |type, state, decided, cost|
      it 'sets completed_at for current time' 


      it 'sets completed_by to be the user' 


      it "sets state to be :#{state}" 


      if decided
        it "sets decision from the #{type} outcome" 


        it 'sets decision_type to be application' 


        it 'sets decision_date to current time' 


        it 'sets decision_cost' 
    ...
    shared_examples 'application reference and business_entity' do
      context 'when the application has reference number already' do
        ...
        it 'does not generate a new reference' 


        it 'stores the business entity' 

      end

      context 'when the application does not have a reference number' do
        it 'generates and stores the reference' 
    ...
    context 'for Application' do
      ...
      context 'when the application needs evidence check' do
        ...
        it 'stores the business entity used to generate the reference' 
      ...
      context 'when the application has outcome and does not need evidence check or part payment' do
        ...
        context 'for discretion applied set to false' do
          ...
          it "complete application without EvidenceCheck" 


          it "complete application without PartPaymentBuilder" 
        ...
        context 'for discretion applied set to true' do
          ...
          it "complete application with EvidenceCheck" 


          it "complete application with PartPaymentBuilder" 
  ...
  describe '#return' do
    ...
    shared_examples 'application, evidence check or part payment returned' do |type|
      ...
      it 'sets the outcome to be return' 


      it 'sets state to be :processed' 


      it 'sets decision to be none' 


      it "sets decision_type to be #{type}" 


      it 'sets the decision_cost to 0' 
  ...
  describe '#delete' do
    ...
    context 'when the application state is :processed and it has :deleted_reason set' do
      ...
      it 'moves the application to :deleted state' 


      it 'sets deleted_at for current time' 


      it 'sets deleted_by to be the user' 
