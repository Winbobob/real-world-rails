...
describe Excon::Error do
  ...
  context 'when remaining backwards compatible' do
    describe '#new' do
      it 'should raise standard error and catch standard error' 


      it 'should raise legacy errors and catch legacy errors' 


      it 'should raise standard error and catch legacy errors' 

    end

    describe '#status_error' do
      it 'should raise with status_error() and catch with standard error' 


      it 'should raise with  status_error() and catch with legacy error' 


      it 'should raise with legacy status_error() and catch with standard' 
  ...
  context 'when exceptions are rescued' do
    ...
    context 'when :debug_request and :debug_response are switched on' do
      it 'exception message includes request and response info' 
