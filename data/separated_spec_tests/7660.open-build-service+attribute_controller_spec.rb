...
RSpec.describe Webui::AttributeController do
  ...
  describe 'GET index' do
    it 'shows an error message when package does not exist' 


    it 'shows an error message when project does not exist' 
  ...
  describe 'GET #edit' do
    ...
    context 'when attribute is not added to the project' do
      it 'renders the 404 page (production mode)' 
