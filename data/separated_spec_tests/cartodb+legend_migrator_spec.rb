...
module Carto
  describe LegendMigrator do
    ...
    describe('#with templates') do
      ...
      it 'should migrate to custom for type custom' 


      it 'should migrate to custom for type category' 


      it 'should migrate to custom for type bubble' 


      it 'should migrate to custom for type choropleth' 


      it 'should migrate to custom for type intensity' 


      it 'should migrate to custom for type density' 
    ...
    describe('#custom types') do
      describe('#with categories') do
        ...
        it 'omits badly formatted colors' 


        it 'migrates old category to new custom' 


        it 'migrates old custom to new custom with no template' 
      ...
      describe('#with html') do
        ...
        it 'migrates old bubble with custom labels to new custom' 


        it 'migrates old custom with template to new custom' 


        it 'migrates old bubble to new custom' 


        it 'migrates old choropleth to new custom' 


        it 'migrates old density to new custom' 


        it 'migrates old density without labels to new custom' 


        it 'migrates old intensity to new custom' 


        it 'migrates old intensity without labels to new custom' 
    ...
    describe('#bad legends') do
      ...
      it 'returns invalid legends for invalid definitions' 
