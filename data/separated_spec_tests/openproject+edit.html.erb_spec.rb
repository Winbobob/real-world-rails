...
describe 'users/edit', type: :view do
  ...
  context 'authentication provider' do
    ...
    it 'shows the authentication provider' 


    it 'does not show a no-login warning when password login is disabled' 
  ...
  context 'with an invited user' do
    ...
    context 'for an admin' do
      ...
      it 'renders the resend invitation button' 
    ...
    context 'for a non-admin' do
      ...
      it 'does not render the resend invitation button' 
  ...
  context 'with a normal (not invited) user' do
    ...
    it 'also renders the resend invitation button' 
  ...
  context 'with password-based login' do
    ...
    context 'with password login disabled' do
      ...
      it 'warns that the user cannot login' 
      ...
      context 'with auth sources' do
        ...
        it 'does not show the auth source selection' 
    ...
    context 'with password login enabled' do
      ...
      context 'with auth sources' do
        ...
        it 'shows the auth source selection' 
      ...
      context 'with password choice enabled' do
        ...
        it 'shows the password and password confirmation fields' 
      ...
      context 'with password choice disabled' do
        ...
        it "doesn't show the password and password confirmation fields" 
