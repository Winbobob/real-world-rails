...
describe VersionsController, type: :controller do
  ...
  describe '#index' do
    ...
    context 'without additional params' do
      ...
      it 'shows Version with no date set' 

      it 'shows Version with date set' 

      it 'not shows Completed version' 
    ...
    context 'with showing subprojects versions' do
      ...
      it 'shows Version from sub project' 
  ...
  describe '#destroy' do
    ...
    it 'redirects to projects versions and the version is deleted' 
