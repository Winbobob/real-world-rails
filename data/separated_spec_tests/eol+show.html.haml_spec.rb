describe 'collections/show' do
  ...
  it "should display hidden for hidden image in list view" 

  
  it "should display hidden for hidden image in annotated view" 

  
  it "should display hidden for hidden image in gallery view" 
