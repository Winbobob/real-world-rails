...
describe "routing for people", type: :routing do
  ...
  it "routes /:username to people controller" 


  it "routes /:username to people controller when username has locale as substring" 


  it "routes /:username/settings to settings controller" 


  it "routes /en to home page" 


  it "routes /pt-BR to home page" 
