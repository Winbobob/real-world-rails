...
describe Pry::Code do
  describe '.from_file' do
    ...
    describe 'find Ruby files relative to $LOAD_PATH' do
      ...
      it 'finds files with `.rb` extension' 


      it 'finds files with `.rb` omitted' 


      it 'finds files in a relative directory with `.rb` extension' 


      it 'finds files in a relative directory with `.rb` omitted' 


      it "doesn't confuse files with the same name, but without an extension" 


      it "doesn't confuse files with the same name, but with an extension" 


      it "recognizes special Ruby files without extensions" 
  ...
  describe '#initialize' do
    ...
    it 'an array or string specify produce an equivalent object' 
