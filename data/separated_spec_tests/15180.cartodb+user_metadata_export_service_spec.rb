...
describe Carto::UserMetadataExportService do
  ...
  describe '#export' do
    ...
    it 'includes all user model attributes' 
  ...
  describe '#user import' do
    ...
    it 'imports 1.0.6 (without password_reset_token and password_reset_sent_at)' 


    it 'imports 1.0.5 (without client_application)' 


    it 'imports 1.0.4 (without synchornization oauths nor connector configurations)' 


    it 'imports 1.0.3 (without company nor phone)' 


    it 'imports 1.0.2 (without rate limits)' 


    it 'imports 1.0.1 (without static notifications)' 


    it 'imports 1.0.0 (without search tweets)' 
  ...
  describe '#full export + import (user and visualizations)' do
    ...
    it 'export + import user with rate limit and visualizations' 


    it 'export + import user and visualizations for a viewer user' 


    it 'skips a canonical visualization without a user table' 


    it 'skips not remote visualizations without a map' 


    it 'keeps visualization password' 
