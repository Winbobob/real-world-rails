...
describe MarkDonePresenter do
  ...
  describe "#has_requirement?" do
    ...
    it "should be false when there is no mark as done requirement" 


    it "should be true when there is a mark as done requirement" 

  end

  describe "#checked?" do

    it "should be true when the mark as done requirement is fulfilled" 


    it "should be false when the mark as done requirement is not fulfilled" 
