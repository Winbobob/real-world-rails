...
EXPECTED
    ...
    describe 'options' do
      describe '#format' do
        ...
        it 'uses format of options, if specified' 
...
WIKI_TEXT
    ...
    context 'w/ request present' do
      ...
      it 'emits a table of contents for headings h1-h4 with links present' 
    ...
    context 'w/o request present' do
      ...
      it 'emits a table of contents for headings h1-h4 with anchors' 
