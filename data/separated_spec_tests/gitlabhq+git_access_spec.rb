...
describe Gitlab::GitAccess do
  ...
  describe '#check with single protocols allowed' do
    ...
    context 'ssh disabled' do
      ...
      it 'blocks ssh git push and pull' 
  ...
  describe '#check_project_accessibility!' do
    context 'when the project exists' do
      context 'when actor exists' do
        context 'when actor is a DeployKey' do
          ...
          context 'when the DeployKey has access to the project' do
            ...
            it 'allows push and pull access' 

          end

          context 'when the Deploykey does not have access to the project' do
            it 'blocks push and pull with "not found"' 
        ...
        context 'when actor is :ci' do
          ...
          it 'allows pull access' 


          it 'does not block pushes with "not found"' 
      ...
      context 'when actor is nil' do
        ...
        context 'when guests cannot read the project' do
          it 'blocks pulls with "not found"' 


          it 'blocks pushes with "not found"' 
    ...
    context 'when the project is nil' do
      ...
      context 'when user is allowed to create project in namespace' do
        ...
        it 'blocks pull access with "not found"' 
  ...
  shared_examples 'check_project_moved' do
    it 'enqueues a redirected message for pushing' 
  ...
  describe '#check_authentication_abilities!' do
    ...
    context 'when download' do
      ...
      it 'raises unauthorized with download error' 
    ...
    context 'when upload' do
      ...
      it 'raises unauthorized with push error' 
  ...
  describe '#check_download_access!' do
    it 'allows maintainers to pull' 


    it 'disallows guests to pull' 


    it 'disallows blocked users to pull' 
    ...
    describe 'without access to project' do
      ...
      context 'when project is public' do
        ...
        context 'when repository is enabled' do
          it 'give access to download code' 

        end

        context 'when repository is disabled' do
          it 'does not give access to download code' 
  ...
  describe 'check LFS integrity' do
    ...
    it 'checks LFS integrity only for first change' 
  ...
  describe '#check_push_access!' do
    ...
    def self.run_permission_checks(permissions_matrix)
      permissions_matrix.each_pair do |role, matrix|
        ...
        it "has the correct permissions for #{role}s" 
    ...
    context 'when pushing to a project' do
      ...
      it 'raises TimeoutError when #check_single_change_access raises a timeout error' 
