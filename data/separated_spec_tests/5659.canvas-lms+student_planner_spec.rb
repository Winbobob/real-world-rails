...
describe "student planner" do
  ...
  context "responsive layout" do
    ...
    it "changes layout on browser resize" 
  ...
  context "Peer Reviews" do
    ...
    it "shows peer review submissions" 


    it "navigates to peer review submission when clicked" 


    it "marks peer review as completed" 
  ...
  context "Create To Do Sidebar" do
    ...
    it "edits a completed To Do.", priority: "1" 
    ...
    it "ensures time zones with offsets higher than UTC update the planner items" 
  ...
  context "teacher in a course" do
    ...
    it "shows correct default time in a wiki page" 


    it "shows correct default time in an ungraded discussion" 
  ...
  context "interaction with ToDoSidebar" do
    ...
    it "completes planner item when dismissed from a course sidebar" 
