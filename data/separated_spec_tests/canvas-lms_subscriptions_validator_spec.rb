  ...
  describe SubscriptionsValidator do
    ...
    describe "#check_required_capabilities!" do
      context "ALL" do
        ...
        it 'allows all subscription types if installed in context' 
      ...
      context "QUIZ_SUBMITTED" do
        ...
        it 'allows subscription if vnd.instructure.webhooks.root_account.quiz_submitted enabled' 


        it 'allows subscription if vnd.instructure.webhooks.assignment.quiz_submitted enabled' 


        it 'raises MissingCapability if missing capabilities' 
      ...
      context "GRADE_CHANGE" do
        ...
        it 'allows subscription if vnd.instructure.webhooks.root_account.grade_change' 
      ...
      context "ATTACHMENT_CREATED" do
        ...
        it 'allows subscription if vnd.instructure.webhooks.root_account.attachment_created' 


        it 'allows subscription if vnd.instructure.webhooks.assignment.attachment_created' 
      ...
      context "SUBMISSION_CREATED" do
        ...
        it 'allows subscription if vnd.instructure.webhooks.root_account.submission_created' 


        it 'allows subscription if vnd.instructure.webhooks.assignment.submission_created' 
      ...
      context "SUBMISSION_UPDATED" do
        ...
        it 'allows subscription if vnd.instructure.webhooks.root_account.submission_updated' 


        it 'allows subscription if vnd.instructure.webhooks.assignment.submission_updated' 
      ...
      context "PLAGIARISM_RESUBMIT" do
        ...
        it 'allows subscription if vnd.instructure.webhooks.root_account.plagiarism_resubmit' 
    ...
    describe "#check_tool_context!" do
      ...
      it "does not raise error if ToolProxy::active_in_context? returns true" 


      it "Uses the assignment's course as the context" 


      it "raises ToolNotInContext if ToolProxy::active_in_context? returns false" 


      it "raises InvalidContextType if a non-whilelisted context is requested" 
