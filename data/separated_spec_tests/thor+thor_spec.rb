...
describe Thor do
  ...
  describe "#stop_on_unknown_option!" do
    ...
    it "still passes everything after -- to command, complex" 
    ...
    context "along with check_unknown_options!" do
      ...
      it "does not accept if first non-option looks like an option, but only refuses that invalid option" 


      it "still accepts options that are given before non-options" 


      it "still accepts when non-options are given after real options and argument" 


      it "does not accept when non-option looks like an option and is after real options" 
  ...
  describe "#check_unknown_options!" do
    ...
    it "still accept options and arguments" 


    it "still accepts options that are given before arguments" 


    it "does not accept if non-option that looks like an option is before the arguments" 


    it "does not accept if non-option that looks like an option is after an argument" 


    it "does not accept when non-option that looks like an option is after real options" 


    it "does not accept when non-option that looks like an option is before real options" 
