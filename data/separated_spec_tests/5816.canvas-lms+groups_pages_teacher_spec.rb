...
describe "groups" do
  ...
  context "as a teacher" do
    ...
    describe "announcements page v2" do
      ...
      it "should allow teachers to see announcements" 


      it "should allow teachers to create an announcement" 


      it "should allow teachers to delete their own group announcements" 


      it "should allow teachers to delete group member announcements" 


      it "should let teachers see announcement details" 


      it "edit button from announcement details works on teachers announcement" 


      it "edit page should succeed for their own announcements" 


      it "should let teachers edit group member announcements" 


      it "edit page should succeed for group member announcements" 
