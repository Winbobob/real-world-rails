...
describe ChargesController do
  ...
  describe 'POST create' do
    context 'with valid card_token and customer parameters' do
      ...
      it 'should save and process the customer' 


      context 'with a pre-existing customer' do
        let!(:customer) { create(:customer, email: valid_customer_parameters['email'])}

        it 'should create a charge and link it properly' 

      end

      let(:config_parameters) { { 'ak_test' => 'foo' } }

      it 'should allow me to pass arbitrary config parameters' 


      it 'should complain if I do not give it a pusher token' 


      it 'should complain if organization is invalid' 


      it 'should complain if the email address is missing' 


      it 'should tag the charge' 
    ...
    context 'without the required parameters' do
      it 'should response with unprocessable entity' 
