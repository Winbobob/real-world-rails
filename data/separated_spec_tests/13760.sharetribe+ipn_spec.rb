...
describe PaypalService::IPN do
  ...
  context "update payment" do
    it "should send event only on changed payment" 


    it "should keep payment in payment-review when payment-review ipn msg received" 


    it "should handle authorization when payment in payment-review state" 


    it "should handle authorization without order" 


    it "should not move authorized payment to payment-review is ipns arrive out of order" 


    it "shouldn't move backwards in state" 


    it "should update to pending ext from authorization" 


    it "should keep the fee_total even if ipn completed does not have it" 


    it "should create refund" 


    it "should deny payment" 


    it "should handle commission" 


    it "should handle commission pending ext" 


    it "should handle commission refunded" 


    it "should handle authorization expired" 


    it "should handle billing agreement created" 


    it "should handle billing agreement cancelled" 
  ...
  context "async handling" do
    ...
    it "should store and handle ipn messages asynchronously" 
