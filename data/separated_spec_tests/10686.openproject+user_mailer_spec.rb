...
describe UserMailer, type: :mailer do
  ...
  shared_examples_for 'mail is sent' do
    it 'actually sends a mail' 


    it 'is sent to the recipient' 


    it 'is sent from the configured address' 
  ...
  describe '#test_mail' do
    ...
    it 'escapes the name attribute properly' 
  ...
  describe '#work_package_added' do
    ...
    it 'contains the WP subject in the mail subject' 
  ...
  describe '#wiki_content_updated' do
    ...
    it 'should link to the latest version diff page' 
    ...
    describe 'plain text mail' do
      ...
      describe 'done ration modifications' do
        context 'changed done ratio' do
          ...
          it 'displays changed done ratio' 
        ...
        context 'deleted done ratio' do
          ...
          it 'displays deleted done ratio' 
      ...
      describe 'start_date attribute' do
        context 'format the start date' do
          ...
          it 'old date should be formatted' 


          it 'new date should be formatted' 
      ...
      describe 'project attribute' do
        ...
        it "shows the old project's name" 


        it "shows the new project's name" 
      ...
      describe 'attribute issue status' do
        ...
        it "shows the old status' name" 


        it "shows the new status' name" 
      ...
      describe 'attribute type' do
        ...
        it "shows the old type's name" 


        it "shows the new type's name" 
      ...
      describe 'attribute assigned to' do
        ...
        it "shows the old assignee's name" 


        it "shows the new assignee's name" 
      ...
      describe 'attribute priority' do
        ...
        it "shows the old priority's name" 


        it "shows the new priority's name" 
      ...
      describe 'attribute category' do
        ...
        it "shows the old category's name" 


        it "shows the new category's name" 
      ...
      describe 'attribute fixed version' do
        ...
        it "shows the old version's name" 


        it "shows the new version's name" 
      ...
      describe 'attribute estimated hours' do
        ...
        it 'shows the old estimated hours' 


        it 'shows the new estimated hours' 
      ...
      describe 'custom field' do
        ...
        it 'shows the old custom field value' 


        it 'shows the new custom field value' 
      ...
      describe 'attachments' do
        ...
        context 'added' do
          ...
          it "shows the attachment's filename" 


          it "shows status 'added'" 


          it "shows no status 'deleted'" 
        ...
        context 'removed' do
          ...
          it "shows no status 'added'" 


          it "shows status 'deleted'" 
