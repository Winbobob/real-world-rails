...
RSpec.describe RuboCop::Cop::Rails::BulkChangeTable, :config do
  ...
  shared_examples 'offense' do
    it 'registers an offense when including combinable transformations' 


    it 'registers an offense when including combinable alter methods' 
  ...
  context 'when database is MySQL' do
    ...
    it 'registers offenses when including combinable alter methods' 
    ...
    it 'does not register an offense when including a transformation' 


    it 'does not register an offense when transformations are inside of `if`' 
    ...
    it 'does not register an offense when including an alter method' 


    it 'does not register an offense when alter methods are inside of `if`' 


    it 'does not register an offense when using empty migration' 


    it 'register an offense when using string as table name' 


    it 'register an offense when using mixed style table name' 


    it 'does not register an offense when using variables as table name' 
