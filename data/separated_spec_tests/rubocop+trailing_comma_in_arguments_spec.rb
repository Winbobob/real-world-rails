...
RSpec.describe RuboCop::Cop::Style::TrailingCommaInArguments, :config do
  ...
  shared_examples 'single line lists' do |extra_info|
    it 'registers an offense for trailing comma in a method call' 
    ...
    it 'accepts method call without parameters' 


    it 'accepts chained single-line method calls' 


    it 'auto-corrects unwanted comma in a method call' 
  ...
  context 'with multi-line list of values' do
    context 'when EnforcedStyleForMultiline is no_comma' do
      ...
      it 'accepts comma inside a heredoc parameter at the end' 
    ...
    context 'when EnforcedStyleForMultiline is comma' do
      ...
      it 'accepts a method call with two parameters on the same line' 
      ...
      it 'accepts an empty hash being passed as a method argument' 
      ...
      it 'accepts a multiline call with a single argument and trailing comma' 
