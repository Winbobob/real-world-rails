...
describe OpenFoodNetwork::ScopeVariantsForSearch do
  ...
  describe "search" do
    ...
    context "when a search query is provided" do
      ...
      it "returns all products whose names or SKUs match the query" 
    ...
    context "when a schedule_id is specified" do
      ...
      it "returns all products distributed through that schedule" 
    ...
    context "when an order_cycle_id is specified" do
      ...
      it "returns all products distributed through that order cycle" 
    ...
    context "when a distributor_id is specified" do
      ...
      it "returns all products distributed through that distributor" 
