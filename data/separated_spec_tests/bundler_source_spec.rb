...
RSpec.describe Bundler::Plugin::API::Source do
  ...
  describe "attributes" do
    it "allows access to uri" 


    it "allows access to name" 
  ...
  context "post_install" do
    ...
    it "calls Path::Installer's post_install" 
  ...
  context "install_path" do
    ...
    it "returns basename with uri_hash" 

  end

  context "to_lock" do
    it "returns the string with remote and type" 
