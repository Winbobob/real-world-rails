    ...
    describe PagesController, type: :controller do
      ...
      describe "valid templates" do
        ...
        describe 'layout templates' do
          it 'returns the names of all files which fit the pattern and are in the whitelist' 


          it 'does not return files whose names are not in the whitelist' 


          it 'does not return files that do not fit the pattern' 

        end

        describe "valid view templates" do
          it 'returns the names of all files which fit the pattern' 


          it "does not return names which don't fit the pattern" 
