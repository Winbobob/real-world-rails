...
describe "login/canvas/new.html.erb" do
  ...
  it "uses canvas route by default" 


  it "uses ldap route for the ldap 'controller'" 


  it "should use internal forgot password mechanism by default" 
  ...
  context "with external mechanism specified" do
    ...
    it "should use external forgot password mechanism" 
