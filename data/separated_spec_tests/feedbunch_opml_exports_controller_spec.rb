...
describe Api::OpmlExportsController, type: :controller do
  ...
  context 'GET show' do
    ...
    it 'returns export process state successfully' 


    it 'assigns the correct opml_export_job_state' 
  ...
  context 'POST create' do
    ...
    it 'creates a OpmlExportJobState instance with ERROR state if an error happens' 

  end

  context 'PUT update' do

    it 'asigns the correct OpmlExportJobState' 
...
OPML_DOCUMENT
    ...
    it 'assigns the correct OPML data' 


    it 'redirects to main application page if an error happens' 


    it 'puts alert in flash if an error happens' 
