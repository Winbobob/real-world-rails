...
describe GitPushService, services: true do
  ...
  describe "Push Event" do
    context "with an existing branch" do
      ...
      it 'generates a push event with one commit' 
    ...
    context "with a new branch" do
      ...
      it 'generates a push event with more than one commit' 
    ...
    describe 'system hooks' do
      ...
      it "sends a system hook after pushing a branch" 
  ...
  describe '#update_signatures' do
    ...
    context 'when the commit has a signature' do
      ...
      context 'when the signature is not yet cached' do
        ...
        it 'can queue several commits to create the gpg signature' 
