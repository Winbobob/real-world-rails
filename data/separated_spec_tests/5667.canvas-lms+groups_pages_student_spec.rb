  ...
  context "as a student" do
    ...
    describe "home page" do
      ...
      describe "for concluded course" do
        it "should not be accessible to students" 


        it "should be accessible to teachers" 
    ...
    describe "announcements page v2" do
      ...
      it "should allow group members to delete their own announcements" 


      it "should allow any group member to create an announcement" 


      it "should allow group members to edit their own announcements" 


      it "edit page should succeed for their own announcements" 


      it "should not allow group members to edit someone else's announcement" 


      it "student in group can see teachers announcement in index" 


      it "should only allow group members to access announcements" 
    ...
    describe "conferences page" do
      ...
      it "should not allow inviting users with inactive enrollments" 
    ...
    describe "collaborations page" do
      ...
      it 'cannot invite students with inactive enrollments' 
