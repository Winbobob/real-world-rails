...
describe CoursesHelper do
  ...
  describe "#user_type" do
    ...
    it "returns nil for random users with no course association" 


    it "returns 'teacher' for TeacherEnrollments" 


    it "returns 'ta' for TaEnrollments" 


    it "returns 'student' for StudentEnrollments" 


    it "returns 'student' for StudentViewEnrollments" 


    it "returns 'student' for ObserverEnrollments" 


    it "returns 'admin' for admin enrollments" 


    it "can optionally be passed preloaded enrollments" 


    it "returns the correct user type when passed preloaded enrollments" 
