...
describe XPath do
  ...
  describe '#ends_with' do
    it 'should find nodes that end with the given string' 
  ...
  describe '#uppercase' do
    it 'should match uppercased text' 

  end

  describe '#lowercase' do
    it 'should match lowercased text' 
  ...
  describe '#where' do
    ...
    it 'should be a no-op when nil condition is passed' 
