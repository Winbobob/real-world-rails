...
describe Gitlab::ImportExport::RelationFactory do
  ...
  context 'hook object' do
    ...
    it 'does not have the original ID' 


    it 'does not have the original service_id' 


    it 'does not have the original project_id' 


    it 'has the new project_id' 
    ...
    context 'excluded attributes' do
      ...
      it 'are removed from the imported object' 
  ...
  context 'Potentially hazardous foreign keys' do
    ...
    it 'does not preserve any foreign key IDs' 
  ...
  context 'Project references' do
    ...
    it 'does not preserve any project foreign key IDs' 
  ...
  context 'Notes user references' do
    ...
    it 'maps the right author to the imported note' 
  ...
  context 'encrypted attributes' do
    ...
    it 'has no value for the encrypted attribute' 
