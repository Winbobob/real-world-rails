...
describe Jobs::PullHotlinkedImages do
  ...
  describe "#nochange" do
    it 'does saves nothing if there are no large images to pull' 
  ...
  describe '#execute' do
    ...
    it 'replaces images without protocol' 


    it 'replaces images without extension' 
