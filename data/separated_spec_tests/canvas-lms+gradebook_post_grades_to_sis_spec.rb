...
describe "gradebook - post grades to SIS" do
  ...
  it "should be visible when enabled on course with sis_source_id" 
  ...
  context 'post grades button' do
    ...
    it "should show post grades lti button when only one section available" 
  ...
  context "when new_sis_integrations is enabled" do
    ...
    it "should show post grades tools in exports dropdown" 


    it "should show max number of items when too many tools are installed" 
    ...
    it "should show powerschool option in exports dropdown" 
