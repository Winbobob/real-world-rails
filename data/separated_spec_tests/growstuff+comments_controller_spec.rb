...
describe CommentsController do
  ...
  describe "GET new" do
    ...
    describe "with valid params" do
      ...
      it "picks up post from params" 


      let(:old_comment) { FactoryBot.create(:comment, post: post) }

      it "assigns the old comments as @comments" 

    end

    it "dies if no post specified" 
  ...
  describe "GET edit" do
    ...
    describe "my comment" do
      ...
      it "assigns previous comments as @comments" 
  ...
  describe "PUT update" do
    ...
    describe "my comment" do
      ...
      it "redirects to the comment's post" 
  ...
  describe "DELETE destroy" do
    ...
    describe "my comment" do
      ...
      it "redirects to the post the comment was on" 
