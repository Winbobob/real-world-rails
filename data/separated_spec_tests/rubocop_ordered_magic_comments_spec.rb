...
RSpec.describe RuboCop::Cop::Lint::OrderedMagicComments, :config do
  ...
  it 'does not register an offense when using `encoding` magic comment only' 
  ...
  it 'autocorrects ordered magic comments' 


  it 'autocorrects ordered magic comments with shebang' 
