...
describe "a generated attributes hash where order matters" do
  ...
  context "factory with a parent" do
    ...
    it "assigns attributes in the order they're defined with preference to static attributes" 
  ...
  context "factory without a parent" do
    ...
    it "assigns attributes in the order they're defined with preference to static attributes without a parent class" 
