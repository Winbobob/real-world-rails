...
RSpec.describe RuboCop::Cop::Lint::FormatParameterMismatch do
  ...
  context 'when splat argument is present' do
    ...
    it 'does register an offense when args count is more than expected' 
  ...
  context 'with wildcard' do
    it 'does not register an offence for width' 


    it 'does not register an offence for precision' 
