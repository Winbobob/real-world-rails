...
describe QuickActions::InterpretService do
  ...
  describe '#execute' do
    ...
    shared_examples 'lock command' do
      ...
      it 'returns discussion_locked: true if content contains /lock' 
    ...
    shared_examples 'unlock command' do
      ...
      it 'returns discussion_locked: true if content contains /unlock' 
    ...
    shared_examples 'confidential command' do
      it 'marks issue as confidential if content contains /confidential' 
  ...
  describe '#explain' do
    ...
    describe 'tag a commit' do
      ...
      describe 'with a tag name and message' do
        ...
        it 'includes the tag name and message' 
