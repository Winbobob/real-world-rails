  ...
  context 'project specific LFS settings' do
    ...
    context 'with LFS disabled globally' do
      ...
      describe 'LFS disabled in project' do
        ...
        it 'responds with a 501 message on upload' 


        it 'responds with a 501 message on download' 
    ...
    context 'with LFS enabled globally' do
      ...
      describe 'LFS disabled in project' do
        ...
        it 'responds with a 403 message on upload' 


        it 'responds with a 403 message on download' 
      ...
      describe 'LFS enabled in project' do
        ...
        it 'responds with a 200 message on upload' 


        it 'responds with a 200 message on download' 
    ...
    context 'and request comes from gitlab-workhorse' do
      ...
      context 'with required headers' do
        shared_examples 'responds with a file' do
          ...
          it 'responds with the file location' 
          ...
          context 'and does have project access' do
            ...
            context 'when LFS uses object storage' do
              context 'when proxy download is enabled' do
                ...
                it 'responds with the workhorse send-url' 
  ...
  describe 'when handling lfs batch request' do
    ...
    describe 'download' do
      ...
      shared_examples 'an authorized requests' do
        ...
        context 'when downloading a lfs object that does not exist' do
          ...
          it 'with an 404 for specific object' 
        ...
        context 'when downloading one new and one existing lfs object' do
          ...
          it 'responds with upload hypermedia link for the new object' 
      ...
      context 'when using Deploy Tokens' do
        ...
        context 'when Deploy Token is not related to the project' do
          ...
          it 'responds with access forbidden' 
      ...
      context 'when user is not authenticated' do
        describe 'is accessing public project' do
          ...
          it 'responds with status 200 and href to download' 
        ...
        describe 'is accessing non-public project' do
          ...
          it 'responds with authorization required' 
    ...
    describe 'upload' do
      ...
      shared_examples 'pushes new LFS objects' do
        ...
        it 'responds with upload hypermedia link' 
      ...
      describe 'when request is authenticated' do
        describe 'when user has project push access' do
          ...
          context 'when pushing an lfs object that already exists' do
            ...
            it 'responds with links the object to the project' 
        ...
        context 'when build is authorized' do
          ...
          context 'build has an user' do
            ...
            context 'tries to push to own project' do
              ...
              it 'responds with 403 (not 404 because project is public)' 
  ...
  describe 'when pushing a lfs object' do
    ...
    shared_examples 'unauthorized' do
      ...
      context 'and request is sent with a malformed headers' do
        ...
        it 'does not recognize it as a valid lfs command' 
        ...
        describe 'when user has push access to the project' do
          ...
          context 'and request is sent by gitlab-workhorse to authorize the request' do
            shared_examples 'a valid response' do
              ...
              it 'uses the gitlab-workhorse content type' 

            end

            shared_examples 'a local file' do
              it_behaves_like 'a valid response' do
                it 'responds with status 200, location of lfs store and object details' 
            ...
            context 'when using remote storage' do
              context 'when direct upload is enabled' do
                ...
                it_behaves_like 'a valid response' do
                  it 'responds with status 200, location of lfs remote store and object details' 
          ...
          context 'and request is sent by gitlab-workhorse to finalize the upload' do
            ...
            it 'lfs object is linked to the project' 
          ...
          context 'and workhorse requests upload finalize for a new lfs object' do
            ...
            context 'with object storage disabled' do
              it "doesn't attempt to migrate file to object storage" 
            ...
            context 'with object storage enabled' do
              context 'and direct upload enabled' do
                ...
                context 'with valid remote_id' do
                  ...
                  it 'schedules migration of file to object storage' 
          ...
          context 'invalid tempfiles' do
            ...
            it 'rejects slashes in the tempfile name (path traversal)' 
      ...
      context 'when build is authorized' do
        ...
        context 'build has an user' do
          ...
          context 'tries to push to own project' do
            ...
            it 'responds with 403 (not 404 because the build user can read the project)' 
          ...
          context 'tries to push to other project' do
            ...
            it 'responds with 404 (do not leak non-public project existence)' 
    ...
    describe 'to a forked project' do
      ...
      describe 'when user is authenticated' do
        ...
        describe 'when user has push access to the project' do
          ...
          context 'and request is sent by gitlab-workhorse to authorize the request' do
            ...
            it 'with location of lfs store and object details' 
          ...
          context 'and request is sent by gitlab-workhorse to finalize the upload' do
            ...
            it 'lfs object is linked to the source project' 
      ...
      describe 'and second project not related to fork or a source project' do
        ...
        context 'when pushing the same lfs object to the second project' do
          ...
          it 'links the lfs object to the project' 
