...
describe ConversationsController, type: :request do
  ...
  context "conversations" do
    ...
    context "create" do
      ...
      it "should not break trying to pull cached conversations for re-use" 
      ...
      describe "context is an account for admins validation" do
        ...
        # context
        it "should use account context if messages are coming from an admin through a course" 


        it "should still use course context if messages are NOT coming from an admin through a course " 
      ...
      context "cross-shard creation" do
        ...
        it "should create the conversation on the context's shard" 
