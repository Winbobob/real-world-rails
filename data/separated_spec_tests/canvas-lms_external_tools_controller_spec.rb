...
describe ExternalToolsController do
  ...
  describe "POST 'create'" do
    ...
    it 'uses custom parsing for form data' 
  ...
  describe "PUT 'update'" do
    ...
    it "should not update tool if user lacks update_manually" 


    it "should update tool if user is granted update_manually" 
  ...
  describe "POST 'create_tool_with_verification'" do
    context "form post", type: :request do
      ...
      it 'creates tool when provided all required params' 


      it 'gives error if app_center_id is not provided' 


      it 'ignores non-required params' 


      it 'uses the config xml provided by the app center' 
