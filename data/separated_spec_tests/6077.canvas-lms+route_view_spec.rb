...
describe RouteView do
  ...
  describe '#query_args' do
    ...
    it 'argument views it returns respond with false to deprecated?' 


    it 'deprecated argument views it returns respond with true to deprecated?' 
  ...
  describe '#response_fields' do
    ...
    it 'returns response fields' 


    it 'returns deprecated response fields' 
