module RSpec
  module Mocks
    RSpec.describe "argument matchers matching" do
      ...
      describe "kind_of" do
        it "accepts fixnum as kind_of(Numeric)" 


        it "accepts float as kind_of(Numeric)" 
        ...
        it "matches arguments that have defined `kind_of?` to return true" 


        it "handles a class thats overridden ===" 

      end

      describe "instance_of" do
        it "accepts float as instance_of(Float)" 


        it "does NOT accept float as instance_of(Numeric)" 


        it "does NOT accept integer as instance_of(Numeric)" 
      ...
      describe "anything" do
        it "accepts string as anything" 


        it "doesn't accept no arguments" 
      ...
      describe "duck_type" do
        it "matches duck type with one method" 


        it "matches duck type with two methods" 
      ...
      describe "any_args" do
        ...
        context "as the last of three args" do
          ...
          it "matches a call of two args when it matches the first two explicit args" 


          it "matches a call of three args when it matches the first two explicit args" 


          it "matches a call of four args when it matches the first two explicit args" 
        ...
        context "as the first of three args" do
          ...
          it "matches a call of two args when it matches the last two explicit args" 


          it "matches a call of three args when it matches the last two explicit args" 


          it "matches a call of four args when it matches the last two explicit args" 
        ...
        context "as the middle of three args" do
          ...
          it "matches a call of two args when it matches the first and last args" 


          it "matches a call of three args when it matches the first and last args" 


          it "matches a call of four args when it matches the first and last args" 
      ...
      describe "hash_including" do
        it "matches hash with hash_including same hash" 
      ...
      describe "hash_excluding" do
        it "matches hash with hash_excluding same hash" 
      ...
      describe "array_including" do
        it "matches array with array_including same array" 
      ...
      context "handling arbitary matchers" do
        it "matches any arbitrary object using #===" 
      ...
      context "handling objects with a wrong definition of `==` that raises errors for other types" do
        ...
        it 'matches against an equal instance of the same type' 
        ...
        it 'can match multiple instances of the type against multiple equal instances of the type' 

      end

      context "handling non-matcher arguments" do
        it "matches string against regexp" 


        it "matches regexp against regexp" 
        ...
        it "matches against a hash submitted and received by value" 


        it "matches against a hash submitted by reference and received by value" 


        it "matches against a hash submitted by value and received by reference" 
        ...
        it "matches a class against itself" 
        ...
        it "matches a class against an instance of itself" 
