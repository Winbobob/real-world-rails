...
describe RestClient::Request do
  ...
  describe "ssl verification" do
    it "is successful with the correct ca_file" 


    it "is successful with the correct ca_path" 
    ...
    it "is successful using the default system cert store" 


    it "executes the verify_callback" 
  ...
  describe "timeouts" do
    it "raises OpenTimeout when it hits an open timeout" 


    it "raises ReadTimeout when it hits a read timeout via :read_timeout" 
