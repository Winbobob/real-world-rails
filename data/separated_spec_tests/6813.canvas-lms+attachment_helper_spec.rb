...
describe AttachmentHelper do
  ...
  it "includes anonymous_instructor_annotations in canvadoc url" 


  it "includes enrollment_type in canvadoc url when annotations are enabled" 


  it "includes submission id in canvadoc url" 
