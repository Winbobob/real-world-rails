...
module Lti
  describe MessageAuthenticator do
    ...
    it 'creates a message from the signed_params' 
    ...
    describe "#valid?" do
      ...
      it "returns the same value if called multiple times" 
      ...
      it 'rejects a message older than the NONCE_EXPIRATION' 


      it "doesn't store the nonce if the signature is invalid" 
