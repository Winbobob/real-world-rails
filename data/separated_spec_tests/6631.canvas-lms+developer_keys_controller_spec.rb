...
describe DeveloperKeysController do
  ...
  context "Site admin" do
    ...
    describe "GET 'index'" do
      ...
      context 'with a session' do
        ...
        it 'includes valid LTI scopes in js env' 


        it 'includes all valid LTI placements in js env' 
    ...
    describe "PUT 'update'" do
      ...
      describe 'scopes' do
        ...
        it 'allows setting scopes for site admin keys' 
        ...
        it 'sets the scopes to empty if the scopes parameter is an empty string' 
  ...
  context "Account admin (not site admin)" do
    ...
    describe '#index' do
      ...
      it 'responds with not found if the account is a sub account' 
