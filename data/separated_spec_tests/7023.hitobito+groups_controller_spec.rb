...
describe GroupsController do
  ...
  describe 'authentication' do
    ...
    it 'renders template when signed in' 
  ...
  describe 'authenticated' do
    ...
    describe '#destroy' do
      it 'leader cannot destroy his group' 


      it 'leader can destroy group' 
    ...
    describe '#reactivate' do
      ...
      it 'reactivates group and redirects' 
