...
describe Dogs::GalleryController, type: :controller do
  describe 'GET #index' do
    ...
    it 'Only adoptable, adoption pending or coming soon dogs should be displayed in order by tracking id' 


    it 'with autocomplete parameter set all dogs are returned' 
