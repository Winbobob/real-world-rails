...
describe API::Jobs do
  ...
  describe 'GET /projects/:id/jobs' do
    ...
    context 'authorized user' do
      ...
      context 'without artifacts and trace' do
        it 'returns no artifacts nor trace data' 
    ...
    context 'unauthorized user' do
      ...
      it 'does not return project jobs' 
  ...
  describe 'GET /projects/:id/pipelines/:pipeline_id/jobs' do
    ...
    context 'authorized user' do
      ...
      context 'jobs in different pipelines' do
        ...
        it 'excludes jobs from other pipelines' 
  ...
  describe 'GET /projects/:id/jobs/:job_id' do
    ...
    context 'unauthorized user' do
      ...
      it 'does not return specific job data' 
    ...
    context 'when job has artifacts' do
      ...
      context 'when user is anonymous' do
        ...
        context 'when project is public' do
          it 'allows to access artifacts' 

        end

        context 'when project is public with builds access disabled' do
          it 'rejects access to artifacts' 

        end

        context 'when project is private' do
          it 'rejects access and hides existence of artifacts' 

        end
      end

      context 'when user is authorized' do
        it 'returns a specific artifact file for a valid path' 

      end
    end

    context 'when job does not have artifacts' do
      it 'does not return job artifact file' 
  ...
  describe 'GET /projects/:id/jobs/:job_id/artifacts' do
    shared_examples 'downloads artifact' do
      ...
      it 'returns specific job artifacts' 
      ...
      context 'job with artifacts' do
        context 'when artifacts are stored locally' do
          ...
          context 'unauthorized user' do
            ...
            it 'does not return specific job artifacts' 
        ...
        context 'when artifacts are stored remotely' do
          ...
          context 'when proxy download is disabled' do
            it 'returns location redirect' 

          end

          context 'authorized user' do
            it 'returns the file remote URL' 
        ...
        it 'does not return job artifacts if not uploaded' 
  ...
  describe 'GET /projects/:id/artifacts/:ref_name/download?job=name' do
    ...
    context 'when not logged in' do
      ...
      it 'does not find a resource in a private project' 
  ...
  describe 'GET /projects/:id/jobs/:job_id/trace' do
    ...
    context 'unauthorized user' do
      ...
      it 'does not return specific job trace' 
  ...
  describe 'POST /projects/:id/jobs/:job_id/cancel' do
    ...
    context 'authorized user' do
      context 'user with :update_build persmission' do
        it 'cancels running or pending job' 
  ...
  describe 'POST /projects/:id/jobs/:job_id/play' do
    ...
    context 'on an playable job' do
      ...
      context 'when user is not authorized to trigger a manual action' do
        context 'when user does not have access to the project' do
          ...
          it 'does not trigger a manual action' 
    ...
    context 'on a non-playable job' do
      it 'returns a status code 400, Bad Request' 
