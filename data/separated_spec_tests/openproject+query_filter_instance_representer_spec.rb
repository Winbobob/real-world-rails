...
describe ::API::V3::Queries::Filters::QueryFilterInstanceRepresenter do
  ...
  describe 'generation' do
    ...
    describe '_links' do
      ...
      it "has a 'values' collection" 


      it "renders templated values as part of the 'values' collection" 

    end

    it 'has _type StatusQueryFilter' 
    ...
    context 'with a non ar object filter' do
      ...
      describe '_links' do
        it 'has no values link' 

      end

      it "has a 'values' array property" 
