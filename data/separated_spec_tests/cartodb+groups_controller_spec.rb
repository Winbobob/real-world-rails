...
describe Carto::Api::GroupsController do
  ...
  shared_examples_for 'Groups editor management' do
    ...
    it 'fails to #add_users if wrong password_confirmation' 


    it '#remove_users triggers group exclusion' 


    it 'fails #remove_users if wrong password_confirmation' 
    ...
    it 'cannot destroy group if wrong password_confirmation' 
