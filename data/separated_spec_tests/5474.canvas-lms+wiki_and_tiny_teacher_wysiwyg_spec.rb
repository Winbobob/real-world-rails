...
describe "Wiki pages and Tiny WYSIWYG editor features" do
  ...
  context "WYSIWYG generic as a teacher" do
    ...
    it "should switch views and handle html code" 
    ...
    it "should indent and remove indentation for embedded images" 


    it "should indent and remove indentation for text" 
    ...
    ["right", "center", "left"].each do |setting|
      it "should align images to the #{setting}" 
    ...
    it "should be able to add links to new wiki pages with special characters in title" 


    it "should change paragraph type to preformatted" 
    ...
    it "should not scroll to the top of the page after using an equation button" 
    ...
    it "should add an equation to the rce by using the equation editor in advanced view" 
    ...
    it "should display record video dialog" 
