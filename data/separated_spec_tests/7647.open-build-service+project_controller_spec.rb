...
RSpec.describe Webui::ProjectController, vcr: true do
  ...
  describe 'CSRF protection' do
    ...
    it 'will protect forms without authenticity token' 
  ...
  describe 'GET #new' do
    ...
    context 'for projects that never existed before' do
      ...
      it 'does not show a restoration hint' 
    ...
    context 'for deleted projects' do
      ...
      it 'shows a hint for restoring the deleted project' 
  ...
  describe 'POST #restore' do
    ...
    it 'forbids project creation on invalid permissions' 


    it 'restores a project' 


    it 'shows an error if project was never deleted' 
  ...
  describe 'GET #delete_dialog' do
    it 'assigns only linking_projects' 
  ...
  describe 'POST #remove_path_from_target' do
    ...
    it 'without a repository param' 


    it 'with a repository param but without a path param' 
  ...
  describe 'GET #toggle_watch' do
    ...
    it 'with a project already whatched' 


    it 'with a project not whatched' 


    it 'redirects to back if a referer is there' 


    it 'redirects to project#show' 
  ...
  describe 'POST #remove_maintained_project' do
    ...
    context 'with maintained kind' do
      ...
      it '#remove_maintained_project raise excepction with invalid maintained project' 
  ...
  describe 'POST #new_incident_request' do
    ...
    it 'without an existent project will raise an exception' 
  ...
  describe 'POST #save_prjconf' do
    ...
    context 'with a non existing project' do
      ...
      it 'raise a RecordNotFound Exception' 
