...
describe GradebookImporter do
  ...
  it "parses assignments correctly with existing custom columns" 


  it "parses CSVs with the SIS Login ID column" 


  it "parses CSVs with semicolons" 


  it "parses CSVs with commas" 
  ...
  context "custom gradebook columns" do
    ...
    it "includes non read only custom columns" 


    it "excludes read only custom columns" 


    it "expects custom column datum from non read only columns" 


    it "does not capture custom columns that are not included in the import" 


    it "does not attempt to change the values of custom columns that are not included in the import" 


    it "captures new values even if custom columns are in different positions" 
    ...
    context "with a deleted custom column" do
      ...
      it "omits deleted custom columns when they are included in the import" 


      it "ignores deleted custom columns when they are not included in the import" 


      it "supplies the expected new values for non-deleted columns" 


      it "supplies the expected current values for non-deleted columns" 
  ...
  context "moderated assignments" do
    ...
    it "allows importing grades of assignments when user is final grader" 


    it "does not allow importing grades of assignments when user is not final grader" 
  ...
  context "with grading periods" do
    ...
    context "uploading submissions for existing assignments" do
      context "assignments without overrides" do
        ...
        it "marks excused submission as 'EX' even if 'ex' is not capitalized" 
  ...
  describe "#translate_pass_fail" do
    ...
    it "translates positive score in gradebook_importer_assignments grade to complete" 


    it "translates positive grade in gradebook_importer_assignments original_grade to complete" 


    it "translates 0 grade in gradebook_importer_assignments grade to incomplete" 


    it "translates 0 grade in gradebook_importer_assignments original_grade to incomplete" 


    it "doesn't change empty string grade in gradebook_importer_assignments grade" 


    it "doesn't change empty string grade in gradebook_importer_assignments original_grade" 
