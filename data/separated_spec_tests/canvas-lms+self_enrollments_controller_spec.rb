...
describe SelfEnrollmentsController do
  describe "GET 'new'" do
    ...
    it "redirects to login if auth_discovery_url is present and authentication_provider isn't specified" 


    it "renders directly if auth_discovery_url is present and canvas authentication_provider is specified" 
