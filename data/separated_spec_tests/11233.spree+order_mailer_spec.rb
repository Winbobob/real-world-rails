...
describe Spree::OrderMailer, type: :mailer do
  ...
  it "doesn't aggressively escape double quotes in confirmation body" 


  it 'confirm_email accepts an order id as an alternative to an Order object' 


  it 'cancel_email accepts an order id as an alternative to an Order object' 
