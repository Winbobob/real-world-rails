...
describe "assignment_submitted_late.email.html" do
  ...
  it "html body includes the student name" 


  it "html body does not include the student name if assignment is anonymous and muted" 


  it "html body includes the student name if assignment is anonymous and unmuted" 
