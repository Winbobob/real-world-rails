...
module Aws
  describe ProcessCredentials do
    ...
    it 'will throw an error and expose the stderr output when the credential process has a nonzero exit status' 


    it 'will throw an error when the credential process cant be found' 
