...
RSpec.describe RuboCop::Cop::Style::SafeNavigation, :config do
  ...
  context 'target_ruby_version >= 2.3', :ruby23 do
    it 'allows calls to methods not safeguarded by respond_to' 


    it 'allows calls using safe navigation' 


    it 'allows calls on nil' 


    it 'allows an object check before hash access' 


    it 'allows an object check before a negated predicate' 


    it 'allows an object check before a nil check on a short chain' 


    it 'allows an object check before a method chain longer than 2 methods' 


    it 'allows an object check before a long chain with a block' 


    it 'allows an object check before a nil check on a long chain' 


    it 'allows an object check before a blank check' 


    it 'allows an object check before a negated predicate method chain' 
    ...
    shared_examples 'all variable types' do |variable|
      ...
      context 'object check before method call' do
        ...
        it 'allows a nil object check followed by a method call' 


        it 'allows a nil object check followed by a method call with params' 


        it 'allows a nil object check followed by a method call with a block' 
        ...
        it 'allows a non object check followed by a method call' 


        it 'allows a non object check followed by a method call with params' 


        it 'allows a non object check followed by a method call with a block' 
    ...
    context 'respond_to?' do
      it 'allows method calls safeguarded by a respond_to check' 
    ...
    context 'auto-correct' do
      shared_examples 'all variable types' do |variable|
        context 'modifier if' do
          it 'corrects a method call safeguarded with a check for the object' 
        ...
        context 'if expression' do
          it 'corrects a single method call inside of a check for the object' 
  ...
  context 'target_ruby_version < 2.3', :ruby22 do
    it 'allows a method call safeguarded by a check for the variable' 
