...
describe 'API v3 User resource', type: :request, content_type: :json do
  ...
  describe '#index' do
    ...
    context 'admin user' do
      ...
      it 'contains the user in the response' 


      it 'contains the current user in the response' 


      it 'has the users index path for link self href' 
      ...
      context 'on filtering for name' do
        ...
        it 'contains the filtered user in the response' 


        it 'contains no more users' 
      ...
      context 'on sorting' do
        ...
        it 'contains the first user as the first element' 


        it 'contains the first user as the second element' 
  ...
  describe '#get' do
    context 'logged in user' do
      ...
      it 'should respond with correct body' 
