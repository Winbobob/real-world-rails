...
describe Gitlab::Kubernetes::Helm::InitCommand do
  ...
  describe '#config_map_resource' do
    ...
    it 'returns a KubeClient resource with config map content for the application' 
  ...
  describe '#pod_resource' do
    ...
    context 'rbac is enabled' do
      ...
      it 'generates a pod that uses the tiller serviceAccountName' 
    ...
    context 'rbac is not enabled' do
      ...
      it 'generates a pod that uses the default serviceAccountName' 
  ...
  describe '#service_account_resource' do
    ...
    context 'rbac is enabled' do
      ...
      it 'generates a Kubeclient resource for the tiller ServiceAccount' 
  ...
  describe '#cluster_role_binding_resource' do
    ...
    context 'rbac is enabled' do
      ...
      it 'generates a Kubeclient resource for the ClusterRoleBinding for tiller' 
