...
describe "submissions" do
  ...
  context 'as a student' do
    ...
    it "should not allow a user to submit a file-submission assignment with an empty file", priority: "1" 
    ...
    it "should show not graded anonymously" 


    it "should show graded anonymously" 
    ...
    describe "using lti tool for submission" do
      ...
      it "should load submission lti tool on clicking tab" 


      it "should load submission lti tool on kb-nav to tab" 
