...
describe "context modules" do
  ...
  context 'adds existing items to modules' do
    ...
    it 'shows due date on a quiz in a module', priority: "2" 
    ...
    it 'shows the todo date on an ungraded discussion in a module ', priority: "1" 
  ...
  context 'edit inline items on module page' do
    ...
    it 'editing external URL module item inline w/ load in new tab should use the right title' 
  ...
  describe "files" do
    ...
    it "should not remove the file link in a module when file is overwritten" 
  ...
  context "logged out", priority: "2" do
    ...
    it "loads page with differentiated assignments" 
