...
describe "Outcomes API", type: :request do
  ...
  context "account outcomes" do
    ...
    describe "update" do
      ...
      context "calculation options" do
        ...
        it "should set a default calculation_method of 'decaying_average' if the record is being re-saved (previously created)" 
  ...
  context "course outcomes" do
    ...
    describe "alignments_for_student" do
      ...
      it "should return aligned assignments for a student" 


      it "should allow teacher to return aligned assignments for a student" 


      it "should allow observer to return aligned assignments for a student" 


      it "should not return outcomes aligned to quizzes in other courses" 


      it "should not return assignments that a student does not have visibility for" 


      it "requires a student_id to be present" 
