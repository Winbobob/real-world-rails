...
describe MethodView do
  ...
  describe '#deprecated?' do
    it 'returns true when there is a deprecated method tag' 


    it 'returns false when there is not a deprecated method tag' 

  end

  describe '#deprecation_description' do
    it 'returns an empty string when there is not a deprecated method tag' 


    it 'returns the deprecation description when there is a deprecated method tag' 

  end

  describe '#raw_arguments' do
    it 'excludes tags that are not arguments' 


    it 'includes argument tags' 


    it 'includes deprecated argument tags' 

  end

  describe '#raw_response_fields' do
    it 'excludes tags that are not response fields' 


    it 'includes response_field tags' 


    it 'includes deprecated response_field tags' 
