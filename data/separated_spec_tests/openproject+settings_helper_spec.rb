...
describe SettingsHelper, type: :helper do
  ...
  describe '#setting_multiselect' do
    ...
    it 'should have checkboxes wrapped in checkbox-container' 
  ...
  describe '#settings_matrix' do
    ...
    it 'has three table rows' 


    it 'has cells with text labels' 


    it 'has cells with styled checkboxes' 


    it 'has the correct fields checked' 
