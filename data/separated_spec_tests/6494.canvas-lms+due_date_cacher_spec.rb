...
describe DueDateCacher do
  ...
  describe ".recompute" do
    ...
    it "initializes a DueDateCacher with the value of executing_user if it is passed as an argument" 


    it "initializes a DueDateCacher with the user set by with_executing_user if executing_user is not passed" 


    it "initializes a DueDateCacher with a nil executing_user if no user has been specified at all" 
  ...
  describe ".recompute_course" do
    ...
    it "initializes a DueDateCacher with the value of executing_user if it is passed in as an argument" 


    it "initializes a DueDateCacher with the user set by with_executing_user if executing_user is not passed" 


    it "initializes a DueDateCacher with a nil executing_user if no user has been specified" 
  ...
  describe ".recompute_users_for_course" do
    ...
    it "initializes a DueDateCacher with the value of executing_user if set" 
  ...
  describe ".with_executing_user" do
    ...
    it "raises an error if no argument is given" 
  ...
  describe ".current_executing_user" do
    ...
    it "returns the user set by with_executing_user" 


    it "returns nil if no user has been set" 


    it "returns the user in the closest scope when multiple calls are nested" 


    it "does not consider users who are no longer in scope" 
  ...
  describe "#recompute" do
    ...
    describe "moderated grading" do
      it 'creates moderated selections for students' 
  ...
  describe "AnonymousOrModerationEvent logging" do
    ...
    context "when an executing user is supplied" do
      context "when the due date changes on an auditable assignment" do
        ...
        it "creates an AnonymousOrModerationEvent for each updated submission" 


        it "includes the old due date in the payload" 


        it "includes the new due date in the payload" 
      ...
      context "when a due date is added to an auditable assignment" do
        ...
        it "includes nil as the old due date in the payload" 
      ...
      context "when a due date is removed from an auditable assignment" do
        ...
        it "includes nil as the new due date in the payload" 

      end

      it "does not create AnonymousOrModerationEvents for non-auditable assignments" 

    end

    it "does not create AnonymousOrModerationEvents when no executing user is supplied" 
