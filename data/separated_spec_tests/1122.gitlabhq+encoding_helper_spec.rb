...
describe Gitlab::EncodingHelper do
  ...
  describe '#encode!' do
    ...
    context 'with corrupted diff' do
      ...
      it 'does not corrupt data but remove invalid characters' 
  ...
  describe '#encode_utf8' do
    ...
    it 'returns empty string on conversion errors' 
    ...
    context 'with strings that can be forcefully encoded into utf8' do
      ...
      it "doesn't use CharlockHolmes if the encoding can be forced into utf_8" 
  ...
  describe 'encode_binary' do
    [
      ...
      it "encodes #{input.inspect} to #{result.inspect}" 

    end
  end

  describe '#binary_stringio' do
    it 'does not mutate the original string encoding' 
