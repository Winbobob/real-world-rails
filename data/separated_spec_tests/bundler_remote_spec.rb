...
RSpec.describe Bundler::Source::Rubygems::Remote do
  ...
  context "when the original URI has no credentials" do
    describe "#uri" do
      ...
      it "applies configured credentials" 
    ...
    describe "#anonymized_uri" do
      ...
      it "does not apply given credentials" 
    ...
    describe "#cache_slug" do
      ...
      it "only applies the given user" 
  ...
  context "when the original URI has a username and password" do
    describe "#uri" do
      ...
      it "does not apply configured credentials" 

    end

    describe "#anonymized_uri" do
      it "returns the URI without username and password" 
