...
module Lti
  describe CapabilitiesHelper do
    ...
    describe '#supported_capabilities' do
      it 'returns all supported capabilities asociated with launch params' 

    end

    describe '#filter_capabilities' do
      it 'removes invalid capabilities' 


      it 'does not remove valid capabilities' 
    ...
    describe '#capability_params_hash' do
      ...
      it 'does not include a name (key) for invalid capabilities' 
      ...
      context 'in a course' do
        ...
        it 'does include a valid name (key) for valid capabilities' 


        it 'does include a value for each valid capability' 
