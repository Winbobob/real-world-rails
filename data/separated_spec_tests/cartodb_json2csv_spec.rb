...
describe Json2Csv do
  ...
  describe '#run' do
    it 'converts a JSON file to CSV' 
  ...
  describe '#csv_header_from' do
    it 'generates a CSV header from parsed JSON data' 

  end #csv_header_from

  describe '#csv_rows_from' do
    it 'generates CSV rows from parsed JSON data' 

  end

  describe '#transform' do
    it 'generates a row from a parse JSON record' 

  end #transform

  describe '#complex?' do
    it 'returns true if parse JSON data has nested arrays' 

  end

  describe '#converted_filepath' do
    it 'returns the .csv filepath for a .json filepath' 

  end #converted_filepath

  describe '#parse' do
    it 'returns parsed data from a JSON file' 
