...
RSpec.describe Webui::UserController do
  ...
  describe 'POST #save' do
    ...
    context "when admin is updating another user's profile" do
      ...
      it { is_expected.to redirect_to user_show_path(user) }
      it "updates the user's roles" 

      it 'does not remove non global roles' 
  ...
  describe 'PATCH #update' do
    ...
    context 'called by an admin user' do
      ...
      it 'updates the state of a user' 


      it 'marks users to be ignored from LDAP authentication' 


      it 'updates deleted users' 


      it 'handles validation errors' 


      it 'applies the Admin role properly' 
  ...
  describe 'DELETE #delete' do
    context 'called by an admin user' do
      ...
      it "changes the state to 'deleted'" 
    ...
    context 'called by a user that is not admin' do
      ...
      it "does not changes the state to 'deleted'" 
  ...
  describe 'POST #change_password' do
    ...
    it 'shows an error message when in LDAP mode' 
  ...
  describe 'GET #tokens' do
    ...
    it 'returns user token as array of hash' 
