    ...
    context 'when searching for a note' do
      ...
      describe '#result' do
        ...
        describe '#view' do
          ...
          it 'highlights last note' 


          it 'links to work package with anchor to highlighted note' 
    ...
    describe '#scan_work_package_reference' do
      ...
      context 'with work package reference' do
        ...
        describe 'captures' do
          ...
          it 'block gets called' 


          it 'id inside of block is work package id' 
