...
describe RolesController, type: :controller do
  ...
  describe_action :get, :new do
    context '.html', format: :html do
      it 'does not raise exception if no type is given' 


      it 'chooses default role' 
  ...
  describe_action :get, :edit, id: true do
    it 'shows current role type rather than default' 
  ...
  context 'using js' do
    ...
    it 'new role for existing person returns new role' 


    it 'creation of role without type returns error' 
