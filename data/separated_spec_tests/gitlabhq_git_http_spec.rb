...
describe 'Git HTTP requests' do
  ...
  shared_examples 'pulls require Basic HTTP Authentication' do
    context "when no credentials are provided" do
      it "responds to downloads with status 401 Unauthorized (no project existence information leak)" 

    end

    context "when only username is provided" do
      it "responds to downloads with status 401 Unauthorized" 
    ...
    context "when username and password are provided" do
      ...
      context "when authentication succeeds" do
        it "does not respond to downloads with status 401 Unauthorized" 
  ...
  shared_examples 'pushes require Basic HTTP Authentication' do
    context "when no credentials are provided" do
      it "responds to uploads with status 401 Unauthorized (no project existence information leak)" 

    end

    context "when only username is provided" do
      it "responds to uploads with status 401 Unauthorized" 
    ...
    context "when username and password are provided" do
      ...
      context "when authentication succeeds" do
        it "does not respond to uploads with status 401 Unauthorized" 
    ...
    context "when the project doesn't exist" do
      context "when namespace doesn't exist" do
        ...
        context 'when authenticated' do
          it 'rejects downloads and uploads with 404 Not Found' 
      ...
      context 'when namespace exists' do
        ...
        context 'when authenticated' do
          it 'creates a new project under the existing namespace' 


          it 'rejects push with 422 Unprocessable Entity when project is invalid' 
    ...
    context "when requesting the Wiki" do
      ...
      context "when the project is public" do
        ...
        context 'when unauthenticated' do
          ...
          it "responds to pulls with the wiki's repo" 
        ...
        context 'when authenticated' do
          ...
          context 'and not on the team' do
            ...
            it 'rejects pushes with 403 Forbidden' 
        ...
        context 'when authenticated' do
          context 'and as a developer on the team' do
            ...
            context 'but the repo is disabled' do
              ...
              it 'pushes are allowed' 

            end
          end

          context 'and not on the team' do
            it 'rejects clones with 404 Not Found' 


            it 'rejects pushes with 404 Not Found' 
    ...
    context "when the project exists" do
      ...
      context "when the project is public" do
        ...
        context 'and the user requests a redirected path' do
          ...
          it 'downloads get status 200 for redirects' 
      ...
      context "when the project is private" do
          ...
          context "when authentication succeeds" do
            ...
            context "when the user has access to the project" do
              ...
              context "when the user is blocked" do
                it "rejects pulls with 401 Unauthorized" 


                it "rejects pulls with 401 Unauthorized for unknown projects (no project existence information leak)" 

              end

              context "when the user isn't blocked" do
                it "resets the IP in Rack Attack on download" 


                it "resets the IP in Rack Attack on upload" 
              ...
              context 'when user has 2FA enabled' do
                ...
                context 'when username and password are provided' do
                  it 'rejects pulls with personal access token error message' 


                  it 'rejects the push attempt with personal access token error message' 
              ...
              context 'when internal auth is disabled' do
                ...
                it 'rejects pushes with personal access token error message' 
                ...
                context 'when LDAP is configured' do
                  ...
                  it 'does not display the personal access token error message' 
              ...
              context "when blank password attempts follow a valid login" do
                ...
                it "repeated attempts followed by successful attempt" 
              ...
              context 'and the user requests a redirected path' do
                ...
                it 'downloads get status 200' 


                it 'uploads get status 404 with "project was moved" message' 

              end
            end

            context "when the user doesn't have access to the project" do
              it "pulls get status 404" 


              it "uploads get status 404" 
        ...
        context "when a gitlab ci token is provided" do
          ...
          context 'when build created by system is authenticated' do
            ...
            it "rejects pulls for other project with 404 Not Found" 
          ...
          context 'and build created by' do
            ...
            shared_examples 'can download code only' do
              ...
              context 'when the repo does not exist' do
                ...
                it 'rejects pulls with 404 Not Found' 
            ...
            context 'administrator' do
              ...
              it 'downloads from other project get status 403' 
            ...
            context 'regular user' do
              ...
              it 'downloads from other project get status 404' 
      ...
      context "when the project path doesn't end in .git" do
        ...
        context "GET info/refs" do
          ...
          context "when no params are added" do
            ...
            it "redirects to the .git suffix version" 
