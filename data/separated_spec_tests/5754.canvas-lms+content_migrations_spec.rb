...
describe "content migrations", :non_parallel do
  ...
  context "common cartridge importing" do
    ...
    it "should show each form" 


    it "should submit, queue and list migrations" 
  ...
  context "course copy" do
    ...
    it "should set pre-populate date adjustment settings" 
  ...
  context "importing LTI content" do
    ...
    it "should show LTI tools with migration_selection in the select control" 


    it "should show LTI view when LTI tool selected" 


    it "should launch LTI tool on browse and get content link" 


    it "should have content selection option" 

  end

  it "should be able to selectively import common cartridge submodules" 
