...
describe JoinedGroupsFinder do
  describe '#execute' do
    ...
    context 'without a user' do
      ...
      it 'only shows public groups from profile owner' 
    ...
    context "with a user" do
      ...
      context "when the profile visitor is in the private group" do
        ...
        it 'only shows groups where both users are authorized to see' 
      ...
      context 'external users' do
        ...
        context 'if not a member' do
          it "does not show internal groups" 
        ...
        context "if authorized" do
          ...
          it "shows internal groups if authorized" 
