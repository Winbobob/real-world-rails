...
describe 'Gradebook performance' do
  ...
  context '200,000 submissions' do
    it 'gradezilla loads in less than 25 seconds' 


    it 'speedgrader loads in less than 100 seconds' 
  ...
  context '100,000 submissions 2000x50' do
    ...
    it 'speedgrader loads in less than 45 seconds' 
  ...
  context '100,000 submissions 1000x100' do
    ...
    it 'speedgrader loads in less than 19 seconds' 

  end

  context '10,000 submissions' do
    it 'gradezilla loads in less than 18 seconds' 


    it 'speedgrader loads in less than 10 seconds' 
