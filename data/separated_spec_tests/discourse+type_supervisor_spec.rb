...
describe SiteSettings::TypeSupervisor do
  ...
  describe '#types' do
    context "verify enum sequence" do
      ...
      it "'category' should be at 16th position" 

      it "'uploaded_image_list' should be at 17th position" 
  ...
  context 'with different data types' do
    ...
    describe '.to_rb_value' do
      ...
      it 'should not modify the types of settings' 
