...
describe "Landing page", type: :request do
  ...
  context "when not released" do
    it "index routes to homepage" 


    it "search path redirects to homepage" 


    it "preview routes to landing page preview" 


    it "renders correct preview" 
  ...
  context "when released" do
    ...
    it "index routes to landing page" 


    it "search path routes to search" 


    it "/:locale routes to landing page" 


    it "/:person routes to person" 


    it "/:person routes to person when username has locale as substring" 


    it "/:locale/s routes to search" 


    it "shows correct landing page version" 
    ...
    describe "caching" do
      ...
      it "subsequent requests are served from cache" 


      it "request with correct etag returns 'not modified'" 


      it "request with incorrect etag returns 200" 


      it "request with correct Last-Modified returns 'not modified'" 


      it "request with past Last-Modified returns 200" 


      it "includes max-age header in the response for public marketplaces" 
      ...
      describe "end user analytics" do
        ...
        describe "when end user analytics disabled" do
          ...
          it "does not contain GTM when disabled" 
      ...
      describe "private marketplaces" do
        ...
        it "does not includes max-age header in the response for private marketplaces" 
