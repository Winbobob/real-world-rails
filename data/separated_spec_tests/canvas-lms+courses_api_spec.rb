...
describe CoursesController, type: :request do
  ...
  it "should include tabs (and precalculate stuff in theory) if requested" 
  ...
  describe "users" do
    ...
    describe "search users" do
      ...
      context "avatar_url" do
        ...
        it "includes avatar_url if requested" 


        it "omits fallbacks if requested" 
    ...
    describe "/users" do
      ...
      it 'does not include the sis_user_id when not an admin' 


      it 'includes the sis_user_id as admin' 
