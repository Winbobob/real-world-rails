...
describe "better_file_browsing" do
  ...
  context "As a teacher" do
    ...
    context "from toolbar menu" do
      ...
      it "should disable the file preview button when a folder is selected" 
  ...
  context "Move dialog" do
    ...
    context "Search Results" do
      ...
      it "should move a file to a destination if contexts are different" 


      it "should move a file to a destination if the contexts are the same" 
  ...
  context "File Preview" do
    ...
    it "should switch files in preview when clicking the arrows" 
  ...
  context "Directory Header" do
    ...
    it "url-encodes sort header links" 
