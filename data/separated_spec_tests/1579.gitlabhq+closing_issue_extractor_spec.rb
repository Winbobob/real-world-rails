...
describe Gitlab::ClosingIssueExtractor do
  ...
  describe "#closed_by_message" do
    ...
    context 'with multiple references' do
      ...
      it 'allows non-comma-separated issue numbers in single line message' 


      it 'allows mixed comma-separated and non-comma-separated issue numbers in single line message' 
