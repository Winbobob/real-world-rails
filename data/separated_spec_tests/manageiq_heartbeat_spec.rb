...
shared_examples_for "heartbeat file checker" do |heartbeat_file = nil|
  ...
  it "returns false when the heartbeat file does not exist" 


  it "returns true with a newly created heartbeat file with no content" 


  it "returns false with a stale heartbeat file with no content" 


  it "returns true with a heartbeat file with content within the timeout" 
