  ...
  describe '#run!' do
    ...
    context 'ignorable cases' do
      ...
      context 'when the file is already in hashed storage' do
        ...
        it 'does not move even an orphan file' 

      end

      it 'does not move any non-project (FileUploader) uploads' 


      it 'does not move any uploads in tmp (which would interfere with ongoing upload activity)' 
