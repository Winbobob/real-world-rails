...
describe SupportHelpers::Tii do
  describe "Error2305Fixer" do
    ...
    describe '#new' do
      it 'finds all broken assignments' 


      it 'finds more broken submissions with an older after_time' 

    end

    describe '#fix' do
      it 'creates an AssignmentFixer for each broken assignment' 
  ...
  describe "AssignmentFixer" do
    context ':course_fix' do
      ...
      describe '#new' do
        it 'finds all broken submissions' 
      ...
      describe '#fix' do
        it 'creates course and assignment and resubmits the broken submissions' 
    ...
    context ':resubmit_fix' do
      ...
      describe '#fix' do
        it 'resubmits the broken submissions' 
    ...
    context ':assignment_fix' do
      ...
      describe '#fix' do
        it 'creates the assignment and resubmits the broken submissions' 
    ...
    context ':assignment_exists_fix' do
      ...
      describe '#fix' do
        it 'updates the assignment and resubmits the broken submissions' 
    ...
    context ':md5_fix' do
      ...
      describe '#fix' do
        it 'saves the assignment and resubmits the broken submissions' 
    ...
    context ':no_fix' do
      ...
      describe '#new' do
        it 'finds no broken submissions' 
