...
describe TrackerApi do
  describe "last_ten_velocities" do
    ...
    it "should be the sum of the estimates of the stories from the prior 10 iterations in reverse order" 


    it "should not include the sum of the estimate for the current iteration" 
