...
RSpec.describe RuboCop::Cop::Style::MethodCallWithArgsParentheses, :config do
  ...
  it 'auto-corrects calls where arg is method call' 


  it 'auto-corrects calls where multiple args are method calls' 


  it 'auto-corrects calls where the argument node is a constant' 


  it 'auto-corrects calls where the argument node is a number' 
