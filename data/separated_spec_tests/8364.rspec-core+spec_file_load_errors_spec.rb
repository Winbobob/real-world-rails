...
RSpec.describe 'Spec file load errors' do
  ...
  it 'nicely handles load-time errors from --require files' 


  it 'prints a single error when it happens on --require files' 


  it 'nicely handles load-time errors in user spec files' 
        it 'will not run this example' 
    ...
    write_file_formatted "2_spec.rb", "
      RSpec.describe 'No Error' do
        it 'will not run this example, either' 
