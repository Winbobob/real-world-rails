...
describe Gitlab::Database::MigrationHelpers do
  ...
  describe '#disable_statement_timeout' do
    context 'using PostgreSQL' do
      it 'disables statement timeouts to current transaction only' 
      ...
      context 'with real environment', :postgresql, :delete do
        ...
        it 'defines statement to 0 only for current transaction' 

      end

      context 'when passing a blocks' do
        it 'disables statement timeouts on session level and executes the block' 
        ...
        context 'with real environment', :postgresql, :delete do
          ...
          it 'defines statement to 0 for any code run inside the block' 
  ...
  describe '#rename_column_using_background_migration' do
    ...
    it 'renames a column using a background migration' 
