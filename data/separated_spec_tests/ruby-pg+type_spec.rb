	...
	describe PG::SimpleCoder do
		describe '#decode' do
			...
			context 'timestamps' do
				it 'decodes timestamps without timezone as local time' 

				it 'decodes timestamps with UTC time and returns UTC timezone' 

				it 'decodes timestamps with UTC time and returns local timezone' 
		...
		describe '#encode' do
			...
			context 'timestamps' do
				it 'encodes timestamps without timezone' 

				it 'encodes timestamps with UTC timezone' 

				it 'encodes timestamps with hour timezone' 
			...
			describe '#decode' do
				context 'one dimensional arrays' do
					...
					context 'strings' do
						...
						it 'ignores spaces after array' 


						describe "with malformed syntax are deprecated" do
							it 'accepts broken array dimensions' 


							it 'accepts malformed arrays' 
						...
						describe "with malformed syntax are raised with pg-2.0+" do
							...
							it 'complains about malformed array' 
	...
	describe PG::CopyCoder do
		...
		describe PG::TextDecoder::CopyRow do
			context "with default typemap" do
				...
				describe '#decode' do
					it "should decode COPY text format to array of strings" 
