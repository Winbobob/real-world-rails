...
module Capistrano
  describe Plugin do
    ...
    it "defines tasks when constructed" 


    it "registers hooks when constructed" 


    it "skips registering hooks if load_hooks: false" 


    it "doesn't call set_defaults immediately" 


    it "calls set_defaults during load:defaults" 


    it "is able to load tasks from a .rake file" 


    it "exposes the SSHKit backend to subclasses" 
