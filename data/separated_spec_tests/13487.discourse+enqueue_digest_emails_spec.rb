...
describe Jobs::EnqueueDigestEmails do
  ...
  describe '#target_users' do
    ...
    context 'disabled digests' do
      ...
      it "doesn't return users with email disabled" 
    ...
    context 'staged users' do
      ...
      it "doesn't return staged users" 
    ...
    context 'recently emailed' do
      ...
      it "doesn't return users who have been emailed recently" 
    ...
    context "suspended user" do
      ...
      it "doesn't return users who are suspended" 
    ...
    context 'visited the site a year ago' do
      ...
      it "doesn't return the user who have not visited the site for more than 365 days" 
    ...
    context 'too many bounces' do
      ...
      it "doesn't return users with too many bounces" 
  ...
  describe '#execute' do
    ...
    context "digest emails are enabled" do
      ...
      it "enqueues the digest email job" 
    ...
    context "digest emails are disabled" do
      ...
      it "does not enqueue the digest email job" 
