...
shared_examples_for "on unrestricted works", :pending do
    ...
    #has been added
    it "should be creatable on a work" 


    it "should be creatable on a work's chapter" 


    it "should be readable on a work" 


    it "should be readable on a work's chapter" 


    it "should be directly readable on a work" 


    it "should be directly readable on a chapter" 


    it "should be directly readable on a work's chapter" 
...
describe "Comments", type: :request do
  ...
  context "on restricted works" do
    ...
    it "should not be creatable by guests on a work" 

    it "should not be creatable by guests on a work's chapter" 

    it "should not be readable by guests on a work" 

    it "should not be readable by guests on a work's chapter" 

    it "should not be directly readable by guests on a work" 

    it "should not be directly readable by guests on a work's chapter" 
  ...
  context "on works which have anonymous commenting disabled" do
    ...
    it "should not be able to be replied to by guests on a work" 


    it "should not be able to be replied to by guests on a work's chapter" 
