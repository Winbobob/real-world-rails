...
describe "Api::V1::ModerationGrader" do
  ...
  describe "#moderation_graders_json" do
    ...
    context "when the user can view other grader identities" do
      ...
      it "returns all provisional moderation graders for the assignment" 


      it "excludes the final grader" 


      it "includes user_id on graders" 


      it "includes ids on graders" 


      it "includes grader_name on graders" 
    ...
    context "when the user cannot view other grader identities" do
      ...
      it "includes anonymous_id on graders" 


      it "includes ids on graders" 


      it "excludes grader_name from graders" 
