...
RSpec.describe NotifyService, type: :service do
  ...
  it 'does not notify when sender is blocked' 


  it 'does not notify when sender is muted with hide_notifications' 


  it 'does notify when sender is muted without hide_notifications' 


  it 'does not notify when sender\'s domain is blocked' 


  it 'does still notify when sender\'s domain is blocked but sender is followed' 


  it 'does not notify when sender is silenced and not followed' 


  it 'does not notify when recipient is suspended' 
  ...
  describe 'reblogs' do
    ...
    it 'shows reblogs by default' 


    it 'shows reblogs when explicitly enabled' 


    it 'hides reblogs when disabled' 
  ...
  context do
    ...
    it 'does not notify when conversation is muted' 


    it 'does not notify when it is a reply to a blocked user' 
  ...
  context do
    ...
    it 'does not notify when recipient is the sender' 
