...
Capybara::SpecHelper.spec Capybara::Window, requires: [:windows] do
  ...
  describe '#exists?' do
    ...
    it 'should become false after window was closed' 

  end

  describe '#closed?' do
    it 'should become true after window was closed' 
  ...
  describe '#current?' do
    ...
    it 'should become true after switching to window' 


    it 'should return false if window is closed' 
  ...
  describe '#close' do
    ...
    it 'should switch to original window if invoked not for current window' 


    it 'should make subsequent invocations of other methods raise no_such_window_error if invoked for current window' 
  ...
  describe '#fullscreen' do
    ...
    it 'should be able to fullscreen the window' 
