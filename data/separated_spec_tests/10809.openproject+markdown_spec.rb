...
describe OpenProject::TextFormatting,
  ...
  describe '.format_text' do
    ...
    context 'Issue links' do
      ...
      describe 'quickinfo' do
        ...
        context 'no dates' do
          ...
          it 'prints no quickinfo with dates' 
        ...
        context 'due date' do
          ...
          it 'prints quickinfo with start date' 
        ...
        context 'both date' do
          ...
          it 'prints quickinfo with dates' 
      ...
      context 'Cyclic Description Links' do
        ...
        it "doesn't replace description links with a cycle" 
      ...
      context 'Description links' do
        ...
        it 'replaces the macro with the issue description' 
    ...
    describe 'options' do
      describe '#format' do
        it 'uses format of Settings, if nothing is specified' 


        it 'allows plain format of options, if specified' 
