...
describe Rack::Mount do
  ...
  it "should generate from routes with Addressable::Template" 


  it "should generate from routes with Addressable::Template using defaults" 


  it "should recognize routes with Addressable::Template" 
  ...
  it "should recognize routes with derived Regexp" 
