...
describe DiscussionTopicsController do
  ...
  describe "GET 'index'" do
    ...
    context "graded group discussion" do
      ...
      it "should assign the create permission if the term is concluded and course is open" 


      it "should not assign the create permission if the term and course are concluded" 
  ...
  describe "GET 'show'" do
    ...
    it "shows speedgrader when user can view all grades but not manage grades" 


    it "shows speedgrader when user can manage grades but not view all grades" 


    it "does not show speedgrader when user can neither view all grades nor manage grades" 


    it "shows speedgrader when course concluded and user can read as admin" 
    ...
    it "should mark as read when topic is in the future as teacher" 
