...
describe "Diff::LCS.patch" do
  ...
  shared_examples "patch sequences correctly" do
    it "correctly patches left-to-right (patch autodiscovery)" 


    it "correctly patches left-to-right (explicit patch)" 


    it "correctly patches right-to-left (unpatch autodiscovery)" 


    it "correctly patches right-to-left (explicit unpatch)" 

  end

  describe "using a Diff::LCS.diff patchset" do
    describe "an empty patchset returns the source" do
      it "works on a string (hello)" 


      it "works on an array %W(h e l l o)" 
  ...
  describe "fix bug 891: patchsets do not contain the last equal part" do
    ...
    describe "using Diff::LCS.diff with default diff callbacks" do
      ...
      it "autodiscovers s1 to s2 patches" 


      it "autodiscovers s2 to s1 patches" 


      it "autodiscovers s2 to s1 the left-to-right patches" 
