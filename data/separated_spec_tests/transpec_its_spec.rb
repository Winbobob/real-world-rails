    ...
    describe Its, rspec: 2 do
      ...
      describe '#convert_to_describe_subject_it!' do
        ...
        context 'with expression `its(:size) { ... }`' do
          ...
          it "converts to `describe '#size' do subject { super().size }; it { ... } end` form" 


          it "adds record `its(:attr) { }` -> `describe '#attr' do subject { super().attr }; it { } end`" 
          ...
          context 'and there are consecutive blanks between the #its and the block' do
            ...
            it 'removes the redundant blanks' 
          ...
          context 'and there is no blank line before #its' do
            context 'and the indentation level of the previous line is same as the target line' do
              ...
              it 'inserts a blank line before #its' 
            ...
            context 'and the indentation level of the previous line is lower than the target line' do
              ...
              it 'does not insert blank line before #its' 
        ...
        context "with expression `its('size.odd?') { ... }`" do
          ...
          it 'converts to nested #describe' 
        ...
        context 'with expression `its([:foo]) { ... }`' do
          ...
          it "converts to `describe '[:foo]' do subject { super()[:foo] }; it { ... } end` form" 


          it "adds record `its([:key]) { }` -> `describe '[:key]' do subject { super()[:key] }; it { } end`" 
        ...
        context 'with expression `its([3, 2]) { ... }`' do
          ...
          it "converts to `describe '[3, 2]' do subject { super()[3, 2] }; it { ... } end` form" 
        ...
        context 'with expression `its(attribute) { ... }`' do
          ...
          it 'converts to `describe attribute do subject { super().send(attribute) }; it { ... } end` form' 
        ...
        context 'with expression `its([1, length]) { ... }`' do
          ...
          it 'converts to `describe [1, length] do subject { super()[1, length] }; it { ... } end` form' 
