...
describe UserInvitation do
  describe '.placeholder_name' do
    it 'given an email it uses the local part as first and the domain as the last name' 


    it 'trims names if they are too long (> 30 characters)' 
  ...
  describe '.reinvite_user' do
    ...
    it 'notifies listeners of the re-invite' 
